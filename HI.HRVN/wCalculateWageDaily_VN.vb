Imports System.Data
Public Class wCalculateWageDaily_VN
    Sub New()
    ...
    Private Sub ocmcalculate_Click(sender As System.Object, e As System.EventArgs) Handles ocmcalculate.Click
        If FNHSysEmpTypeId.Text <> "" And FNHSysEmpTypeId.Properties.Tag.ToString <> "" Then
            If HI.UL.ULDate.CheckDate(Me.FTStartDate.Text) <> "" And HI.UL.ULDate.CheckDate(Me.FTEndDate.Text) <> "" Then
                ...
                _Qry &= vbCrLf & " , P.FTPreNameNameTH + ' ' +  M.FTEmpNameTH + '  ' +  M.FTEmpSurnameTH AS FTEmpName,M.FNHSysEmpTypeId"
                ...
                For Each R As DataRow In _Dt.Rows
                    ...
                    HI.HRVN.Calculate.CalculateWageDaily_VN(HI.ST.UserInfo.UserName, R!FNHSysEmpID.ToString, Me.FNHSysEmpTypeId.Properties.Tag.ToString, HI.UL.ULDate.ConvertEnDB(FTStartDate.Text), HI.UL.ULDate.ConvertEnDB(FTEndDate.Text))
