...
Public Class wEmployeeOwnerLeave
...
#Region "MAIN PROC"
    ...
    Private Sub ProcessSave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ocmsave.Click
        ...
        If Me.VerrifyData("Save") Then
            ...
            If _Msg <> "" Then
                _State = HI.MG.ShowMsg.mConfirmProcessDefaultNo("พบมีการบันทึกเวลาของพนักงานแล้ว กรุณาทำการตรวจสอบ !!!", 1144090001, FNHSysEmpId_None.Text & vbCrLf & vbCrLf & _Msg & vbCrLf & vbCrLf & "")
            Else
            ...
            If (_State) Then
                ...
                If Me.SaveData() Then
                    ...
                    If HI.MG.ShowMsg.mConfirmProcess("คุณต้องการส่งอนุมัตืการลาใช่หรือไม่ ?", 2207300002, FNHSysEmpId_None.Text) Then
                        ''If HI.MG.ShowMsg.mConfirmProcessDefaultNo(MG.ShowMsg.ProcessType.mSend, "", Me.Text) = True Then
                        If Me.SendApprove() Then
