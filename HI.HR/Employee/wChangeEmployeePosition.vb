Public Class wChangeEmployeePosition
...
#Region "Procedure"
    ...
    Private Sub LoadHistory(ByVal Key As String)
        Try
            ...
            _Qry &= vbCrLf & "  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_MASTER) & "].dbo.THRMPromotionReason AS PM WITH (NOLOCK) ON M.FNHSysPmtReasoneId = PM.FNHSysPmtReasoneId"
    ...
    Private Function VerrifyData(Optional ByVal _SaveData As Boolean = False) As Boolean
        ...
        If FNHSysEmpID.Text <> "" And FNHSysEmpID.Properties.Tag.ToString <> "" Then
            If FNHSysEmpTypeIdTo.Text <> "" And FNHSysEmpTypeIdTo.Properties.Tag.ToString <> "" Then
    ...
    Private Function SaveData() As Boolean
        ...
        Try
            ...
            _Qry &= vbCrLf & ", FNHSysEmpTypeIdTo=" & Val(FNHSysEmpTypeIdTo.Properties.Tag.ToString) & " "
            ...
            If HI.Conn.SQLConn.ExecuteTran(_Qry, HI.Conn.SQLConn.Cmd, HI.Conn.SQLConn.Tran) <= 0 Then
                ...
                _Qry &= vbCrLf & ", " & Val(FNHSysEmpTypeIdTo.Properties.Tag.ToString) & " "
...
#Region "General"
    ...
    Private Sub ogv_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ogv.DoubleClick
        With ogv
            ...
            FNHSysEmpTypeIdTo.Text = "" & .GetRowCellValue(.FocusedRowHandle, "FTEmpTypeCode2").ToString
