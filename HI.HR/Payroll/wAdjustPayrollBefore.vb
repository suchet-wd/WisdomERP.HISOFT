Public Class wAdjustPayrollBefore
...
#Region "Procedure"
    ...
    Private Function DeleteData(ByVal oSpls As HI.TL.SplashScreen) As Boolean
        Try
            ...
            HI.HRCAL.Calculate.CalculateWeekEnd(HI.ST.UserInfo.UserName, Me.FNHSysEmpID.Properties.Tag.ToString, Me.FNHSysEmpTypeId.Properties.Tag.ToString, HI.UL.ULDate.ConvertEnDB(Me.FTStartDate.Text), HI.UL.ULDate.ConvertEnDB(Me.FTEndDate.Text), Me.FTPayYear.Text, Me.FTPayTerm.Text, Me.FDPayDate.Text, "0", _CalType, False, _ReturnVacation)
    ...
    Private Function SaveData(ByVal oSpls As HI.TL.SplashScreen) As Boolean
        Try
            ...
            oSpls.UpdateInformation("Calculate Weekend...")
            HI.HRCAL.Calculate.CalculateWeekEnd(HI.ST.UserInfo.UserName, Me.FNHSysEmpID.Properties.Tag.ToString, Me.FNHSysEmpTypeId.Properties.Tag.ToString, HI.UL.ULDate.ConvertEnDB(Me.FTStartDate.Text), HI.UL.ULDate.ConvertEnDB(Me.FTEndDate.Text), Me.FTPayYear.Text, Me.FTPayTerm.Text, Me.FDPayDate.Text, "0", _CalType, False, _ReturnVacation, _FTStaDeductAbsent, _FTStaCalPayRoll, _FNStateSalaryType, _FNWorkDayInWeek, _FNWorkDayInMonth)
