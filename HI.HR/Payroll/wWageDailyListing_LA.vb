...
Public Class wWageDailyListing_LA
...
#Region "Initial Grid"
    Private Sub InitGrid()
        ...
        Dim sFieldSum As String = "FNNetProAmt|FNNetAmt|FNNetPayAmt|FNQAAmt|FNProOT|FNProNormal|FNAmtOT|FNAmtNormal|FNNetPay|FNNetIncen|FNAmt|FNNetPerDay|FNIncen|FNIncenOT|FNIncenNormal|FNProOther"
        Dim sFieldGrpCount As String = "FTDateTrans"
        Dim sFieldGrpSum As String = "FNNetProAmt|FNNetAmt|FNNetPayAmt|FNQAAmt|FNProOT|FNProNormal|FNAmtOT|FNAmtNormal|FNNetPay|FNNetIncen|FNAmt|FNNetPerDay|FNIncen|FNIncenOT|FNIncenNormal|FNProOther"
...
#Region "Procedure"
    ...
    Private Sub LoadData()
        ...
        _Qry &= vbCrLf & "  , case when (ISNULL(Prod.FNProNormal,0)-  ISNULL(Prod.FNAmtNormal,0))>0 THEN ISNULL(Prod.FNProNormal,0)-  ISNULL(Prod.FNAmtNormal,0) ELSE  0  END As FNIncenNormal  "
        _Qry &= vbCrLf & "   , case when (ISNULL(Prod.FNProOT,0)-  ISNULL(Prod.FNAmtOT,0))>0 THEN ISNULL(Prod.FNProOT,0)-  ISNULL(Prod.FNAmtOT,0) ELSE  0 END As FNIncenOT "


        _Qry &= vbCrLf & "  , case when (ISNULL(Prod.FNProNormal,0)-  ISNULL(Prod.FNAmtNormal,0))>0 THEN ISNULL(Prod.FNProNormal,0)-  ISNULL(Prod.FNAmtNormal,0) ELSE  0  END   "
        _Qry &= vbCrLf & "   + case when (ISNULL(Prod.FNProOT,0)-  ISNULL(Prod.FNAmtOT,0))>0 THEN ISNULL(Prod.FNProOT,0)-  ISNULL(Prod.FNAmtOT,0) ELSE  0 END As FNIncen "
        ...
        _Qry &= vbCrLf & "  , case when (ISNULL(Prod.FNProNormal,0)-  ISNULL(Prod.FNAmtNormal,0))>0 THEN ISNULL(Prod.FNProNormal,0)-  ISNULL(Prod.FNAmtNormal,0) ELSE  0  END   "
        _Qry &= vbCrLf & "   + case when (ISNULL(Prod.FNProOT,0)-  ISNULL(Prod.FNAmtOT,0))>0 THEN ISNULL(Prod.FNProOT,0)-  ISNULL(Prod.FNAmtOT,0) ELSE  0 END As FNNetIncen "
