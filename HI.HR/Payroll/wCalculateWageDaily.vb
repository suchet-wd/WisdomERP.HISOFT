Public Class wCalculateWageDaily
    Sub New()
        ...
        If FNHSysEmpTypeId.Text <> "" And FNHSysEmpTypeId.Properties.Tag.ToString <> "" Then
            If HI.UL.ULDate.CheckDate(Me.FTStartDate.Text) <> "" And HI.UL.ULDate.CheckDate(Me.FTEndDate.Text) <> "" Then
                ...
                For Each R As DataRow In _Dt.Rows
                    ...
                    HI.HRCAL.Calculate.CalculateWageDaily(HI.ST.UserInfo.UserName, R!FNHSysEmpID.ToString, Me.FNHSysEmpTypeId.Properties.Tag.ToString, HI.UL.ULDate.ConvertEnDB(FTStartDate.Text), HI.UL.ULDate.ConvertEnDB(FTEndDate.Text))
