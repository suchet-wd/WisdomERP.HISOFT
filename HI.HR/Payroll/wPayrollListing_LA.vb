...
Public Class wPayrollListing_LA
    Sub New()
...
#Region "Procedure"
    Private Sub LoadDataInfo()
        ...
        _Qry &= vbCrLf & " , ISNULL([051],0) [051] "


        _Qry &= vbCrLf & " , ISNULL([053],0) [053] "
        _Qry &= vbCrLf & " , ISNULL([054],0) [054] "
        _Qry &= vbCrLf & " , ISNULL([055],0) [055] "
        _Qry &= vbCrLf & " , ISNULL([056],0) [056] "
        _Qry &= vbCrLf & " , ISNULL([057],0) [057] "
        _Qry &= vbCrLf & " , ISNULL([058],0) [058] "
        _Qry &= vbCrLf & " , ISNULL([059],0) [059] "
        _Qry &= vbCrLf & " , ISNULL([060],0) [060] "
        _Qry &= vbCrLf & " , ISNULL([061],0) [061] "
