...
Public Class wPayrollListing_AccountGroup
    Sub New()
...
#Region "Initial Grid"
    Private Sub InitGrid()
        ...
        Dim sFieldCustomSum As String = "FCNetBaht|OTBaht|F001|F009|F011|F017|F018|FStaleWage|FAdd|FNTotalIncome|FDeduct|FStudentLoan|FNSocial|FNSocialCmp|FNTax|FNNetpay|N_Count|F008|F053|F054|F055|F056|F057|F058|F059|F061|F062|F063|F064"
...
#Region "Procedure"
    Private Sub LoadDataInfo()
        ...
        _Qry = "Exec [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_HR) & "].dbo.SP_GetPayroll_ByTerm '" & FTPayTerm.Text & "','" & FTPayYear.Text & "','" & Val(HI.ST.SysInfo.CmpID) & "' , '" & Lang & "'"
