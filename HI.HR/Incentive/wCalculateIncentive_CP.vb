...
Public Class wCalculateIncentive_CP
            ...
            For Each R As DataRow In _dt.Select("FTSelect='1'", "FTUnitSectCode")
                ...
                For Each Rt As DataRow In _dtemptime.Rows
                    ...
                    If _TotalTimeHR >= 480 Then
                        _FNAmtNormal = _Salary
                    Else
                        _FNAmtNormal = Double.Parse(Format((_Salary / 480) * (_TotalTimeHR + _Latenomalcp), "0.00"))
                    End If
    ...
    Private Sub LoadDataInfo()
        Try
            ...
            Do While _SDate <= _EDate
                ...
                _Qry = "Exec [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_HR) & "].dbo.[SP_CALCULATE_STATIC_INCENTIVE_EFF_BYCMP]  '" & _SDate & "','" & _SDate & "','" & HI.UL.ULF.rpQuoted(Me.FNHSysUnitSectId.Text) & "','" & HI.UL.ULF.rpQuoted(Me.FNHSysUnitSectIdTo.Text) & "' , " & Val(Me.FNHSysCmpId.Properties.Tag.ToString)
                ...
                If .Select("FTSelect='1'").Length > 0 Then
                    ...
                    For i As Integer = 0 To results.Count - 1
                        ...
                        With New HI.RP.Report
                            ...
                            .ReportName = "RptIncentiveEff.rpt"
