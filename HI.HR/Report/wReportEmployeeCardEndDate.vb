...
Public Class wReportEmployeeCardEndDate
    ...
    Private Sub ocmpreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ocmpreview.Click
        ...
        '*****วันหมดอายุบัตร****
        If Me.FDDateIdNoEnd.Text <> "" Then
            _Formular &= IIf(_Formular.Trim <> "", " AND ", "")
            _Formular &= " {THRMEmployee.FDDateIdNoEnd} >='" & HI.UL.ULDate.ConvertEnDB(Me.FDDateIdNoEnd.Text) & "' "
        End If
        If Me.FDDateIdNoEndTo.Text <> "" Then
            _Formular &= IIf(_Formular.Trim <> "", " AND ", "")
            _Formular &= " {THRMEmployee.FDDateIdNoEnd} <='" & HI.UL.ULDate.ConvertEnDB(Me.FDDateIdNoEndTo.Text) & "' "
        End If
