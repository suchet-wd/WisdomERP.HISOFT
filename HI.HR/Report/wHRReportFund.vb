...
Public Class wHRReportFund
    ...
    Private Sub ocmpreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ocmpreview.Click
        ...
        Select Case FNReportname.SelectedIndex
            Case 1
                ...
                'Dim _Dt As DataTable = HI.HRCAL.Social.CreateTextFileSSO("", "", Me.FTPayYear.Text, Microsoft.VisualBasic.Right("0000" & HI.TL.CboList.GetListValue(FNMonth.Properties.Tag.ToString, FNMonth.SelectedIndex), 2), Me.FTSendSSODate.Text)
                ' Dim _Dt As DataTable = New DataTable()
                Dim _MsgShow As String = ""
                Dim _Dt As DataTable = HI.EXPORTBANK.ExporForTanachartFund.ExportDataFile(_year, Microsoft.VisualBasic.Right("0000" & HI.TL.CboList.GetListValue(FNMonth.Properties.Tag.ToString, FNMonth.SelectedIndex), 2), _MsgShow)
    ...
    Private Sub wReportFund_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
