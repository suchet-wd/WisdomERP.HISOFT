...
Public Class wHRReportPayRollMonthToMonthAllType
    ...
    Private Sub ocmpreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ocmpreview.Click
        ...
        _Formular &= " {THRMCfgPayDT.FTPayYear}='" & HI.UL.ULF.rpQuoted(Me.FTPayYear.Text) & "' "

        _Formular &= IIf(_Formular.Trim <> "", " AND ", "")
        _Formular &= " {THRMCfgPayDT.FNMonth} >=" & (FNMonth.SelectedIndex + 1) & " "

        _Formular &= IIf(_Formular.Trim <> "", " AND ", "")
        _Formular &= " {THRMCfgPayDT.FNMonth} <=" & (FNMonthTo.SelectedIndex + 1) & " "
    ...
    Private Sub wReportHRByPayRollByMonthToMonth_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        Try
