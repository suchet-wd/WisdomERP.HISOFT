...
Public Class wHRReportWorkOutSite
    ...
    Private Sub ocmpreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ocmpreview.Click
        ...
        If Me.SFTDateTrans.Text <> "" Then
            ...
            _Formular &= "  ( ( {THRTEmpployeeWorkOutSite.FTStartDate}>='" & HI.UL.ULDate.ConvertEnDB(Me.SFTDateTrans.Text) & "'  AND {THRTEmpployeeWorkOutSite.FTEndDate}>='" & HI.UL.ULDate.ConvertEnDB(Me.SFTDateTrans.Text) & "' ) "
               

            _Formular &= IIf(_Formular.Trim <> "", " AND  ", "")

            _Formular &= "  ( {THRTEmpployeeWorkOutSite.FTStartDate}<='" & HI.UL.ULDate.ConvertEnDB(Me.EFTDateTrans.Text) & "'  AND {THRTEmpployeeWorkOutSite.FTEndDate}>='" & HI.UL.ULDate.ConvertEnDB(Me.EFTDateTrans.Text) & "' ) ) "
        End If
    ...
    Private Sub wReportHRWorkOffSite_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        Try
