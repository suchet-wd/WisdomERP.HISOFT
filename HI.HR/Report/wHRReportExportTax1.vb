...
Public Class wHRReportExportTax1
    ...
    Private Sub ocmpreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ocmpreview.Click
        ...
        Select Case FNReportname.SelectedIndex
            Case 1
                Dim _Dt As DataTable = HI.HRCAL.Social.Export(HRCAL.Social.TaxType.ภงด1, "", Me.FNHSysEmpTypeId.Properties.Tag.ToString, Me.FTPayYear.Text, Microsoft.VisualBasic.Right("0000" & HI.TL.CboList.GetListValue(FNMonth.Properties.Tag.ToString, FNMonth.SelectedIndex), 2), _ExFormular)
