...
#Region "Procedure"
    Private Sub LoadDataInfo()
        ...
        _Qry &= vbCrLf & "SUM([064]) AS '064',FTStateHRSent,FTUserHRSent,FTTimeHRSent,FTStateEmployeeAccept,"
        ...
        _Qry &= vbCrLf & " ,(Right('00' + Convert(varchar(30),Convert(numeric(18,0),Floor(SUM(FNTotalWKNMin) / (SUM(FCHour) * 60)))),2)"
        _Qry &= vbCrLf & "  +':'+  Right('00' + Convert(varchar(30),Convert(numeric(18,0),Floor((SUM(FNTotalWKNMin) % (SUM(FCHour) * 60)) / 60.00))),2)"
        _Qry &= vbCrLf & "  +':'+  Right('00' + Convert(varchar(30),Convert(numeric(18,0),((SUM(FNTotalWKNMin) % (SUM(FCHour) * 60)) % 60.00))),2))  AS FNWorkingDay"
        ...
        _Qry &= vbCrLf & "ISNULL([064],0) [064], ISNULL(FTStateHRSent,'0') as 'FTStateHRSent',"
        ...
        _Qry &= vbCrLf & " [011] ,[051] , [053], [054], [055], [056], [057], [058], [059], [060], [061], [062], [063], [064] "
        ...
        _Qry &= vbCrLf & " [051] , [053], [054], [055], [056], [057], [058], [059], [060], [061], [062], [063], [064]) "
        ...
        _Qry &= vbCrLf & " where FTPayYear = '" & HI.UL.ULF.rpQuoted(FTPayYear.Text) & "' "
        ...
        _Qry &= vbCrLf & "FTDateEmployeeAccept,FTTimeEmployeeAccept,FTStateHRAccept,FTUseHRAccept,FTDateHRAccept,FTTimeHRAccept,FNSocialCmp"
        With Me.ogc
