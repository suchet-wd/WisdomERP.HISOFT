Public Class wConfigTaxRate_KM
    ...
    Private Sub LoadTaxRate()
        ...
        _Qry &= vbCrLf & ",ISNULL(FNAllowance,0) AS FNAllowance,FTRemark"
    ...
    Private Sub ocmsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ocmsave.Click
        ...
        _Qry &= vbCrLf & ",FNAllowance=" & CDbl(FNAllowance.Value)
        ...
        If HI.Conn.SQLConn.ExecuteNonQuery(_Qry, Conn.DB.DataBaseName.DB_HR) = False Then
            ...
            _Qry &= vbCrLf & ", FTInsUser, FDInsDate, FTInsTime,FNAllowance)  "
            ...
            _Qry &= vbCrLf & "," & CDbl(FNAllowance.Value) & ""
