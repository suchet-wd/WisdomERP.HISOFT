...
Public Class wConfigPayRollTerm
    ...
    Private objForm As wAddEditConfigPayRoll
    ...
    Private _CopyForm As wCopyPayrollTerm
    ...
    Sub New()
        ...
        objForm = New wAddEditConfigPayRoll(FormName, Me.Text, Me.FormObjID, HI.ST.SysInfo.PathFileDLL, "", Me)
        ...
        _CopyForm = New wCopyPayrollTerm
        HI.TL.HandlerControl.AddHandlerObj(_CopyForm)
        Try
            Call oSysLang.LoadObjectLanguage(HI.ST.SysInfo.ModuleName, _CopyForm.Name.ToString.Trim, _CopyForm)
        Catch ex As Exception
        Finally
        End Try
        _ProcNew = False
    ...
    Public Sub LoadData()
        ...
        _StrQuery = _StrQuery & "  WHERE  FNHSysEmpTypeId= " & Val(FNHSysEmpTypeId.Properties.Tag.ToString) & "  "
        _StrQuery = _StrQuery & "  AND  FTPayYear= '" & FNYear.Text & "'  "
    ...
    Private Sub Proc_AddNew(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ocmaddnew.Click
        ...
        With objForm
            ...
            For I As Integer = 0 To ._KeyFiled.ToArray.Count - 1
                ...
                If ._KeyFiled(I).FiledName.ToString = "FNHSysEmpTypeId" Then
                    ._KeyFiled(I).FiledValue = FNHSysEmpTypeId.Text
                ElseIf ._KeyFiled(I).FiledName.ToString = "FTPayYear" Then
                    ._KeyFiled(I).FiledValue = FNYear.Text
                Else
...
#End Region
    ...
    Private Sub FNHSysEmpTypeId_EditValueChanged(sender As System.Object, e As System.EventArgs) Handles FNHSysEmpTypeId.EditValueChanged
    ...
    Private Sub FNYear_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles FNYear.SelectedIndexChanged
        Call Preform()
    End Sub
    ...
    Private Sub ocmcopy_Click(sender As System.Object, e As System.EventArgs) Handles ocmcopy.Click
        If Me.FNHSysEmpTypeId.Text <> "" Then
            If Me.FNYear.Text <> "" Then
                With _CopyForm
                    HI.ST.Lang.SP_SETxLanguage(_CopyForm)
                    .FNYear.SelectedIndex = FNYear.SelectedIndex
                    .FNYearTo.SelectedIndex = FNYear.SelectedIndex
                    .FNHSysEmpTypeIdTo.Text = Me.FNHSysEmpTypeId.Text
                    .FNHSysEmpTypeId.Text = Me.FNHSysEmpTypeId.Text
                    .ShowDialog()
                End With
            End If
        End If
