...
Public Class wTrainTopic
    ...
    Private objForm As wAddEditTrainTopic
    ...
    Sub New()
        ...
        objForm = New wAddEditTrainTopic(FormName, Me.Text, Me.FormObjID, HI.ST.SysInfo.PathFileDLL, "", Me)
