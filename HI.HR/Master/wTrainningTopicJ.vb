...
Public Class wTrainningTopicJ
    ...
    Private objForm As wAddEditTrainningJ
    ...
    Sub New()
        ...
        objForm = New wAddEditTrainningJ(FormName, Me.Text, Me.FormObjID, HI.ST.SysInfo.PathFileDLL, "", Me)
...
#End Region
    ...
    Private Sub FNYear_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Me.Preform()
    End Sub
End Class