...
Public Class wTrainningTopic
    ...
    Private _SysKeyFiled As New List(Of HI.TL.PKFiled)()
    ...
    Private objForm As wAddEditTrainning
    ...
    Sub New()
        ...
        Me.AssemblyPath = HI.ST.SysInfo.PathFileDLL
        Me.ogbdetail.Text = ""
        ...
        objForm = New wAddEditTrainning(SysFormName, Me.Text, Me.SysFormObjID, HI.ST.SysInfo.PathFileDLL, "", Me)
    ...
    Private Sub Proc_Edit(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ocmedit.Click
        With ogvdetail
            ...
            With objForm
                ...
                For I As Integer = 0 To ._SysKeyFiled.ToArray.Count - 1
                    Dim _KeyName As String = ._SysKeyFiled(I).FiledName.ToString
                    ...
                    ._SysKeyFiled(I).FiledValue = _KeyValue
                Next
...
#Region "Proc"
    ...
    Private Sub InitialiObject()
        ...
        _Qry = "SELECT FNGrpObjID,FNSysFormObjID,FTBaseName + '.' + FTPrefix + '.' + FTTableName AS FTTableName,FTSortField  "
        ...
        If _dt.Rows.Count > 0 Then
            ...
            If _dt.Rows.Count > 0 Then
                ...
                With Me.ogvdetail
                    ...
                    For Each Row As DataRow In _dt.Select("FTType='G' AND FTBaseName + '.' + FTPrefix + '.' + FTTableName='" & Me.SysTableName & "'", "FNSeq")
            ...
            Select Case e.KeyCode
                ...
                Case Keys.Delete
                    ...
                    If HI.MG.ShowMsg.mConfirmProcess(HI.MG.ShowMsg.ProcessType.mDelete, .GetRowCellValue(.FocusedRowHandle, Me.RequireField).ToString.Trim) = True Then
                        ...
                        Dim _Qry As String = " Delete From " & Me.SysTableName & "  " & "  WHERE  " & Me.MainKey & "='" & _Key.ToString & "' "
