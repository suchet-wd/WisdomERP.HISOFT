...
Public Class wHoliday
    ...
    Private objForm As wAddEditHoliday
    ...
    Sub New()
        ...
        objForm = New wAddEditHoliday(FormName, Me.Text, Me.FormObjID, HI.ST.SysInfo.PathFileDLL, "", Me)
    ...
    Private _FormName As String = "wHoliday"
    ...
    Public Sub LoadData()
        ...
        _Str = Me.Query & "  WHERE  LEFT(FDHolidayDate,4)='" & FNYear.Text & "'  AND  (FNHSysCmpId=" & HI.ST.SysInfo.CmpID & " OR ISNULL(FNHSysCmpId,0)=0)"


        _Str &= " Order By   Convert(varchar(10),Convert(Datetime,FDHolidayDate ),111)  "
...
#End Region
    ...
    Private Sub FNYear_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles FNYear.SelectedIndexChanged
        Me.Preform()
    End Sub
End Class