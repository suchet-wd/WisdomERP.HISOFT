...
Public Class wInComeDeduct
    ...
    Private objForm As wAddEditFinMaster
    ...
    Private _SortFieldData As String
    ...
    Sub New()
        ...
        objForm = New wAddEditFinMaster(FormName, Me.Text, Me.FormObjID, HI.ST.SysInfo.PathFileDLL, "", Me)
    ...
    Public Sub LoadData()
        ...
        If FNFinType.SelectedIndex < 0 Then FNFinType.SelectedIndex = 0
        Dim _Str As String = ""

        _Str = Me.Query
        _Str &= vbCrLf & " WHERE FTFinType='" & HI.TL.CboList.GetListValue(FNFinType.Properties.Tag, FNFinType.SelectedIndex) & "'"

        If _SortFieldData <> "" Then
            _Str &= vbCrLf & "  ORDER BY " & _SortFieldData
        End If
...
#Region "MAIN PROC"
    ...
    Private Sub Proc_Delete(ByVal sender As System.Object, ByVal e As System.EventArgs)
        'With ogvdetail
    ...
    Private Sub Proc_AddNew(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub Proc_Edit(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ocmedit.Click
        With ogvdetail
            ...
            With objForm
                ...
                .ocmaddnew.Enabled = False ' Me.ocmaddnew.Enabled
                .ocmedit.Visible = True
                .ocmedit.Enabled = Me.ocmedit.Enabled
                .ocmdelete.Visible = False 'Me.ocmdelete.Visible
                .ocmdelete.Enabled = False 'Me.ocmdelete.Enabled
    ...
    Private Sub Form_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            If Me.TableName <> "" Then
                ...
                Finally
                End Try
                Call HI.ST.Lang.SP_SETxLanguage(objForm)
