...
Public Class HRConditionGroup

#Region "EmployeeTypeGroup"
    Private m_DbDtEmployeeTypeGroup As New DataTable
    ReadOnly Property DbDtEmployeeTypeGroup As DataTable
        Get
            Return m_DbDtEmployeeType
        End Get
    End Property

    Property ShowmEmployeeTypeGroup As Boolean
        Get
            Return otpemptypeGroup.PageVisible
        End Get
        Set(value As Boolean)
            otpemptypeGroup.PageVisible = value
        End Set
    End Property
#End Region
...
#Region "EmployeeType"
    ...
    'Private Sub FNEmpTypeCon_SelectedIndexChanged(sender As System.Object, e As System.EventArgs)
    ...
    'Private Sub FNHSysEmpType_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    '    Try
