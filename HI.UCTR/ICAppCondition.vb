...
#End Region
    ...
    Public Function GetCriteria(MasterWHAlias As String, MasterSuplAlias As String, MasterInvenMatAlias As String, MasterInvenMatColorAlias As String, MasterInvenMatSizeAlias As String) As String
        Dim _Criteria As String = ""
        Dim tText As String = ""
        '*********Ware House*********
        If (Me.otpWhNo.PageVisible) And MasterWHAlias <> "" Then
            Select Case Me.FNWHCon.SelectedIndex
                Case 1
                    If Me.FNHSysWHId.Text <> "" Then
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  " & MasterWHAlias & ".FTWHCode >='" & HI.UL.ULF.rpQuoted(Me.FNHSysWHId.Text) & "' "
                    End If

                    If Me.FNHSysWHIdTo.Text <> "" Then
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  " & MasterWHAlias & ".FTWHCode <='" & HI.UL.ULF.rpQuoted(Me.FNHSysWHIdTo.Text) & "' "
                    End If
                ...
                Case 2
                    ...
                    If tText.Trim <> "" Then
                        ...
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  " & MasterWHAlias & ".FTWHCode IN('" & tText.Replace("|", "','") & "') "
                    End If
            End Select
        ...
        '********Supl*********
        If (Me.otpSupl.PageVisible) And MasterSuplAlias <> "" Then
            Select Case Me.FNSuplCon.SelectedIndex
                Case 1
                    If Me.FNHSysSuplId.Text <> "" Then
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  " & MasterSuplAlias & ".FTSuplCode >='" & HI.UL.ULF.rpQuoted(Me.FNHSysSuplId.Text) & "' "
                    End If

                    If Me.FNHSysSuplIdTo.Text <> "" Then
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  " & MasterSuplAlias & ".FTSuplCode <='" & HI.UL.ULF.rpQuoted(Me.FNHSysSuplIdTo.Text) & "' "
                    End If
                Case 2
                    tText = ""
                    ...
                    If tText.Trim <> "" Then
                        tText = Microsoft.VisualBasic.Left(Trim(tText), Len(Trim(tText)) - 1)
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  " & MasterSuplAlias & ".FTSuplCode IN('" & tText.Replace("|", "','") & "') "
                    End If
            End Select
        End If

        '*******Item********
        If (Me.otpItemCode.PageVisible) And MasterInvenMatAlias <> "" Then
            Select Case Me.FNItemCon.SelectedIndex
                Case 1
                    If Me.FNHSysRawMatId.Text <> "" Then
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  " & MasterInvenMatAlias & ".FTRawMatCode >='" & HI.UL.ULF.rpQuoted(Me.FNHSysRawMatId.Text) & "' "
                    End If

                    If Me.FNHSysRawMatIdTo.Text <> "" Then
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  " & MasterInvenMatAlias & ".FTRawMatCode <='" & HI.UL.ULF.rpQuoted(Me.FNHSysRawMatIdTo.Text) & "' "
                    End If
                ...
                Case 2
                    ...
                    If tText.Trim <> "" Then
                        tText = Microsoft.VisualBasic.Left(Trim(tText), Len(Trim(tText)) - 1)
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  " & MasterInvenMatAlias & ".FTRawMatCode IN('" & tText.Replace("|", "','") & "') "
                    End If
        ...
        '******Color*********
        If (Me.otpColorCode.PageVisible) And MasterInvenMatColorAlias <> "" Then
            Select Case Me.FNColorCon.SelectedIndex
                Case 1
                    If Me.FNHSysRawMatColorId.Text <> "" Then
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  " & MasterInvenMatColorAlias & ".FTRawMatColorCode >='" & HI.UL.ULF.rpQuoted(Me.FNHSysRawMatColorId.Text) & "' "
                    End If

                    If Me.FNHSysRawMatColorIdTo.Text <> "" Then
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  " & MasterInvenMatColorAlias & ".FTRawMatColorCode <='" & HI.UL.ULF.rpQuoted(Me.FNHSysRawMatColorIdTo.Text) & "' "
                    End If
                Case 2
                    tText = ""
                    ...
                    If tText.Trim <> "" Then
                        tText = Microsoft.VisualBasic.Left(Trim(tText), Len(Trim(tText)) - 1)
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  " & MasterInvenMatColorAlias & ".FTRawMatColorCode IN('" & tText.Replace("|", "','") & "') "
                    End If
            End Select
        End If

        '******Size***********
        If (Me.otpSizeCode.PageVisible) And MasterInvenMatSizeAlias <> "" Then
            Select Case Me.FNSizeCon.SelectedIndex
                Case 1

                    If Me.FNHSysRawMatSizeId.Text <> "" Then
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  " & MasterInvenMatSizeAlias & ".FTRawMatSizeCode >='" & HI.UL.ULF.rpQuoted(Me.FNHSysRawMatSizeId.Text) & "' "
                    End If

                    If Me.FNHSysRawMatSizeIdTo.Text <> "" Then
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  " & MasterInvenMatSizeAlias & ".FTRawMatSizeCode <='" & HI.UL.ULF.rpQuoted(Me.FNHSysRawMatSizeIdTo.Text) & "' "
                    End If
                ...
                Case 2
                    ...
                    If tText.Trim <> "" Then
                        tText = Microsoft.VisualBasic.Left(Trim(tText), Len(Trim(tText)) - 1)
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  " & MasterInvenMatSizeAlias & ".FTRawMatSizeCode IN('" & tText.Replace("|", "','") & "') "
                    End If
