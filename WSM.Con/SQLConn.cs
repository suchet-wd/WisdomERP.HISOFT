...
namespace WSM.Conn
{
    public class SQLConn
    {
        ...
        private void SqlBeginTransaction()
        {
            if (Cnn == null) { Cnn = new System.Data.SqlClient.SqlConnection(); }
        ...
        private void DisposeSqlConnection(System.Data.SqlClient.SqlConnection _cnn)
        {
            if ((_cnn != null))
            {
                if (_cnn.State == ConnectionState.Open)
        ...
        private bool ExecuteOnly(string QryStr, WSM.Conn.DB.DataBaseName DbName)
        {
        ...
        private bool ExecuteNonQuery(string QryStr, WSM.Conn.DB.DataBaseName DbName)
        {
            try
            {
                int Complete = 0;
