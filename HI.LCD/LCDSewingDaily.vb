...
Public Class LCDSewingDaily
        ...
        Try
            ...
            Else
                ...
                Try
                    ...
                    _Cmd = " exec USP_GETDATASEWING_DASH '" & HI.UL.ULF.rpQuoted(HI.ST.UserInfo.UserLogInComputer) & "'," & Val(HI.ST.SysInfo.CmpID)
    ...
    Private Sub LCDCuttingDaily_SizeChanged(sender As Object, e As EventArgs) Handles Me.SizeChanged
        Try
            ...
            With Me.GridView1
                .Columns.ColumnByFieldName("FTOrderNo").Width = ((wWith * 10) / 100)
                .Columns.ColumnByFieldName("FTStyleCode").Width = ((wWith * 25) / 100)
                .Columns.ColumnByFieldName("FDShipDate").Width = ((wWith * 10) / 100)
                .Columns.ColumnByFieldName("FNGrandQuantity").Width = ((wWith * 9) / 100)
                .Columns.ColumnByFieldName("FNWIPQuantity").Width = ((wWith * 9) / 100)
                .Columns.ColumnByFieldName("FNWIPPer").Width = ((wWith * 6) / 100)
                .Columns.ColumnByFieldName("FNTarget").Width = ((wWith * 9) / 100)
                .Columns.ColumnByFieldName("FNFinishQuantity").Width = ((wWith * 9) / 100)
                .Columns.ColumnByFieldName("FNDailyPer").Width = ((wWith * 6) / 100)
                .Columns.ColumnByFieldName("FNTotalFinishQuantity").Width = ((wWith * 9) / 100)
                '.Columns.ColumnByFieldName("FNPer").Width = ((wWith * 12) / 100)
                .Columns.ColumnByFieldName("FTBlank").Width = 20
    ...
    Private Sub GridView1_RowStyle(sender As Object, e As RowStyleEventArgs) Handles GridView1.RowStyle
        Try
            Try
                If Val(GridView1.GetRowCellValue(e.RowHandle, "FNWIPQuantity").ToString) <= 0 Then
                ...
                Else
                    ...
                    Dim pTotalDay As Integer = Val(GridView1.GetRowCellValue(e.RowHandle, "FNTotalDay").ToString)
