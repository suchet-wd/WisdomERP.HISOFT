...
Public Class LCDDisplayIncentiveMD2_Back_20160505
...
#End Region
    ...
    Private Sub LCDDisplay_SizeChanged(sender As Object, e As EventArgs) Handles Me.SizeChanged
        ...
        Me.olbqa1.Font = FFontLineH
        Me.olbqa2.Font = FFontLineH
        '----S Font LV
    ...
    Private Sub olbqa1_TextChanged(sender As Object, e As EventArgs) Handles olbqa1.TextChanged
        Try
            ...
            Select Case True
                Case (Val(olbqa1.Text) > Val(olbtime1.Text))
    ...
    Private Sub olbqa2_TextChanged(sender As Object, e As EventArgs) Handles olbqa2.TextChanged
        Try
            ...
            Select Case True
                Case (Val(olbqa2.Text) > Val(olbtime2.Text))
                    Me.olbqa2.BackColor = Color.Red
                Case Else
                    Me.olbqa2.BackColor = Color.FromArgb(0, 192, 0)
            End Select
