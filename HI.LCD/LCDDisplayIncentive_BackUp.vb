...
Public Class LCDDisplayIncentive_BackUp
...
#End Region
    ...
    Private Sub LCDDisplay_SizeChanged(sender As Object, e As EventArgs) Handles Me.SizeChanged
        ...
        olbslv31.Width = _PH1W
        olbslv32.Width = _PH2W
        olbslv33.Width = _PH3W
        olbslv34.Width = _PH4W
        ...
        olbelv31.Width = _PH1W
        olbelv32.Width = _PH2W
        olbelv33.Width = _PH3W
        olbelv34.Width = _PH4W
        ...
        olbslv31.Font = FFontLV
        olbslv32.Font = FFontLV
        olbslv33.Font = FFontLV
        olbslv34.Font = FFontLV
        ...
        olbelv31.Font = FFontLV
        olbelv32.Font = FFontLV
        olbelv33.Font = FFontLV
        olbelv34.Font = FFontLV
            ...
            If IsNumeric(olbsscan1.Text.Trim) Then
                ...
                If _CurrentTime <> "" And _CurrentTime >= "08:00" Then
                    ...
                    If _Total <= 0 Then
                        ...
                        olbsscan2.Text = _TotalScan.ToString()

                    Else

                        olbsscan2.Text = Format((_TotalScan / _Total), "0.00")
            ...
            If IsNumeric(olbescan1.Text.Trim) Then
                ...
                If _CurrentTime <> "" And _CurrentTime >= "08:00" Then
                    ...
                    If _Total <= 0 Then
                        ...
                        olbescan2.Text = _TotalScan.ToString()

                    Else

                        olbescan2.Text = Format((_TotalScan / _Total), "0.00")
