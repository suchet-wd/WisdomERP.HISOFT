...
Public Class LCDDisplayIncentiveOneScreen
...
#End Region
    ...
    Private Sub LCDDisplay_SizeChanged(sender As Object, e As EventArgs) Handles Me.SizeChanged
        ...
        _PH2W = _LineHeaderWidth * 0.19655442443226309
        _PH3W = _LineHeaderWidth * 0.1918559122944401
        ...
        Else
            Try
                ...
                If _TotalTarget > 0 Then
                    ...
                    If StateActualDate = False And TransactionDateBefore <> "" Then
                        _Cmd = "EXEC  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "]..SP_DATA_LCD_DETAIL '" & HI.UL.ULF.rpQuoted(HI.ST.UserInfo.UserName) & "'," & Integer.Parse(Val(Me.SysLine1)) & ",'" & TransactionDateBefore & "' "
                    Else
                    ...
                    If _dttime.Rows.Count > 0 Then
                        ...
                        _Qry &= vbCrLf & "   WHERE S.FNHSysUnitSectId =" & Integer.Parse(Val(Me.SysLine1)) & "   AND    O.FTBarcodeNo Is NULL "
                        _Qry &= vbCrLf & "    UNION "
                        ...
                        _Qry &= vbCrLf & "   WHERE FNHSysUnitSectId =" & Integer.Parse(Val(Me.SysLine1)) & "    And ISNULL(FNStateSewPack, 0)  In (0, 1)   "

                        If StateActualDate = False And TransactionDateBefore <> "" Then
                            _Qry &= vbCrLf & "   AND FDDate ='" & Me.TransactionDateBefore & "'"
                        Else
                            _Qry &= vbCrLf & "   AND FDDate ='" & Me.TransactionDate & "'"
                        End If
                        ...
                        If StateActualDate = False And TransactionDateBefore <> "" Then
                            _Qry &= vbCrLf & "   And FDScanDate ='" & Me.TransactionDateBefore & "'"
                        Else
                        ...
                        For Each R As DataRow In _oDt.Rows
                            ...
                            olbdefect1.Text = Format(Val(R!FNTotalDefect), "0")
                            olbdefect2.Text = Format(Val(R!FNQAActualQty), "0")
