...
Public Class LCDV2
    ...
    Public Sub New(Optional DataUnitSectId As Integer = 0, Optional DataLineNo As String = "", Optional DataFormularId As Integer = 0)
        ...
        LineId = DataUnitSectId
        LineNo = DataLineNo
        FormularId = DataFormularId
...
#Region "Procedure "
    ...
    Private Sub SwipShowData()
        ...
        olbslv14.Visible = Not olbslv14.Visible
        olbslv24.Visible = Not olbslv24.Visible
        olbslvt4.Visible = Not olbslvt4.Visible
    ...
    Public Sub SetSize()
        ...
        olbstarget2Eff.Width = olbprodper.Width
