...
Public Class LCDV1
    ...
    Public Sub New(UnitSectId As Integer, LineNo As String, FormularId As Integer)
        ...
        If LineNo <> "" Then
            ...
            _Qry &= vbCrLf & "	WHERE Emp.FNHSysUnitSectId =" & Integer.Parse(Val(UnitSectId)) & ""
            ...
            _Qry &= vbCrLf & " Where (B.FNHSysUnitSectId =" & Integer.Parse(Val(UnitSectId)) & ") "
