...
Public Class LCDDisplayIncentiveMD2
...
#End Region
    ...
    Private Sub LCDDisplay_SizeChanged(sender As Object, e As EventArgs) Handles Me.SizeChanged
        ...
        Dim _FontLineHQA As Integer = _P1 * 0.29 ' 30 '90
        ...
        Else
            Try
                ...
                For Each R As DataRow In _dttimeplan.Rows
                    ...
                    _FNMoneyPackage = Double.Parse(Val(R!FNMoneyPackage.ToString))
                    _FNPercentPackage = Double.Parse(Val(R!FNPercentPackage.ToString))
                ...
                If _TotalTarget > 0 Then
                    ...
                    '_Cmd = " Create Table #Tmpbb3 ([FTSubOrderNo] varchar(30) NULL ,[FTBarcodeBundleNo] varchar(30) NULL )  Create Index [Idx_Tmpbb3] ON #Tmpbb3([FTSubOrderNo] ,[FTBarcodeBundleNo]) "
                    '_Cmd &= vbCrLf & "INSERT INTO #Tmpbb3 (FTSubOrderNo,FTBarcodeBundleNo)"
                    ...
                    '_Cmd &= vbCrLf & "   Left OUTER JOIN  #Tmpbb3  "
                    ...
                    If _dttime.Rows.Count > 0 Then
                        ...
                        If _FNQuantityPackage > 0 Then

                            olbslvt1.Text = "" 'Format(_FNMoneyPackage / _FNQuantityPackage, "0.00")
                            olbslvt2.Text = Format(_FNQuantityPackage, "#,0")

                            If _TotalProd < _FNQuantityPackage Then
                                olbslvt3.Text = Format(_FNQuantityPackage - _TotalProd, "0") '"-"
                            Else
                                olbslvt3.Text = "0"
                            End If

                            olbslvt4.Text = Format(_FNMoneyPackage, "0.00") '"-"
        ...
        Else
            Try
                ...
                If _TotalTarget > 0 Then
                    ...
                    '_Cmd = " Create Table #Tmpbb4 ([FTSubOrderNo] varchar(30) NULL ,[FTBarcodeBundleNo] varchar(30) NULL )  Create Index [Idx_Tmpbb4] ON #Tmpbb4([FTSubOrderNo] ,[FTBarcodeBundleNo]) "
                    '_Cmd &= vbCrLf & "INSERT INTO #Tmpbb4 (FTSubOrderNo,FTBarcodeBundleNo)"
                    '_Cmd &= vbCrLf & "   Select MAX(A.FTSubOrderNo) As FTSubOrderNo, BCD.FTBarcodeBundleNo"
                    ...
                    '_Cmd &= vbCrLf & "   Left OUTER JOIN  #Tmpbb4 "
                    ...
                    If _dttime.Rows.Count > 0 Then
                        ...
                        _Qry &= vbCrLf & "	, O.FNHSysUnitSectId, O.FTBarcodeNo, O.FDDate, O.FTTime, O.FNQuantity"
                        _Qry &= vbCrLf & "FROM    [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODBarcodeScanOutline AS O WITH(NOLOCK)  LEFT OUTER JOIN"
                        _Qry &= vbCrLf & "   [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTBundle AS B WITH(NOLOCK)  ON O.FTBarcodeNo = B.FTBarcodeBundleNo   WHERE FNHSysUnitSectId =" & Integer.Parse(Val(Me.SysLine2)) & "   AND FDDate ='" & Me.TransactionDate & "'   and ISNULL(FNStateSewPack,0)  IN (0,1)  ) AS A  "
                        ...
                        If _FNQuantityPackage > 0 Then
                            ...
                            olbelvt1.Text = "" 'Format(_FNMoneyPackage / _FNQuantityPackage, "0.00")
                            olbelvt2.Text = Format(_FNQuantityPackage, "#,0")

                            If _TotalProd < _FNQuantityPackage Then
                                olbelvt3.Text = Format(_FNQuantityPackage - _TotalProd, "0") '"-"
                            Else
                                olbelvt3.Text = "0"
                            End If

                            olbelvt4.Text = Format(_FNMoneyPackage, "0.00") '"-"
    ...
    Private Sub olbsscan1_TextChanged(sender As Object, e As EventArgs) Handles olbsscan1.TextChanged, olbslvt2.TextChanged
        Try
            If IsNumeric(olbsscan1.Text.Trim) Then
                ...
                If _CurrentTime <> "" And _CurrentTime >= "08:00" Then
                    ...
                    If _Total <= 0 Or _TotalScan <= 0 Then

                        olbsprodspeed1.Text = "" '_TotalScan.ToString()
                        olbsprodspeed2.Text = ""
                        olbqa1.Text = ""
                    ...
                    Else
                        ...
                        Dim _TargetQty As Double = 0

                        Try
                            _TargetQty = Double.Parse(olbslvt2.Text)
                        Catch ex As Exception
                        End Try

                        Dim _TotalActTime As Integer = (_T1 + _T2 + _T3) + (((_TargetQty - _TotalScan) * Val(olbsprodspeed1.Text)) / 60) '((Val(olbstarget1.Text) * Val(olbsprodspeed1.Text)) / 60)
                        olbqa1.Text = Format((_TotalActTime \ 60), "00") & ":" & Format((_TotalActTime - ((_TotalActTime \ 60) * 60)), "00")
    ...
    Private Sub olbescan1_TextChanged(sender As Object, e As EventArgs) Handles olbescan1.TextChanged, olbelvt2.TextChanged
        Try
            If IsNumeric(olbescan1.Text.Trim) Then
                ...
                If _CurrentTime <> "" And _CurrentTime >= "08:00" Then
                    ...
                    Else
                        ...
                        Try
                            _TargetQty = Double.Parse(olbelvt2.Text)
                        Catch ex As Exception
                        End Try

                        Dim _TotalActTime As Integer = (_T1 + _T2 + _T3) + (((_TargetQty - _TotalScan) * Val(olbeprodspeed1.Text)) / 60)


                        '((Val(olbetarget1.Text) * Val(olbeprodspeed1.Text)) / 60)
                        olbqa2.Text = Format((_TotalActTime \ 60), "00") & ":" & Format((_TotalActTime - ((_TotalActTime \ 60) * 60)), "00")
