...
Public Class wQATrimCard_Track
...
#Region "Procedure"
    Private Sub LoadData()
        ...
        Try
            ...
            _Qry &= vbCrLf & " where FTStateApp ='1'"
...
#End Region
    ...
    Public Function testnew() As Boolean
        Try
            Dim _new As String = ""
            HI.MG.ShowMsg.mInfo("Test", 2007301701, Me.Text)
            Return True
        Catch ex As Exception
            Return False
        End Try
    ...
    Private Function SaveData(_ImgName As String, OperInfo As String, OperId As Integer, _Seq As Integer) As Boolean
        Try
            Dim _Cmd As String = ""
            ...
            For Each R As DataRow In _oDt.Select("FTSelect ='1'")
                ...
                If HI.Conn.SQLConn.ExecuteNonQuery(_Cmd, Conn.DB.DataBaseName.DB_PROD) = False Then
                    ...
                    _Cmd &= vbCrLf & "FNHSysStyleId, FNHSysSeasonId, FNHSysCountryId, FNOperId, FNSeq, FTOrderNo, FTSubOrderNo, FTOperInfo, FTImagePath,FTRemark)"
    ...
    Private Sub PSize5_EditValueChanged(sender As Object, e As EventArgs)
        Try
    ...
    Private Sub PLicesed5_EditValueChanged(sender As Object, e As EventArgs)
        Try
    ...
    Private Sub PCare5_EditValueChanged(sender As Object, e As EventArgs)
        Try
    ...
    Private Sub PNFC5_EditValueChanged(sender As Object, e As EventArgs)
        Try
    ...
    Private Sub PID5_EditValueChanged(sender As Object, e As EventArgs)
        Try
    ...
    Private Sub PCham5_EditValueChanged(sender As Object, e As EventArgs)
        Try
    ...
    Private Sub PJOCKTAG5_EditValueChanged(sender As Object, e As EventArgs)
        Try
    ...
    Private Sub PSLabel9_EditValueChanged(sender As Object, e As EventArgs)
        Try
    ...
    Private Sub psticker5_EditValueChanged(sender As Object, e As EventArgs)
        Try
    ...
    Private Sub pbag5_EditValueChanged(sender As Object, e As EventArgs)
        Try
            ' Me.pbagvideo.URL = Me.pbag5.Text
        Catch ex As Exception
        End Try
    End Sub
    Private Sub pelite5_EditValueChanged(sender As Object, e As EventArgs)
        Try
