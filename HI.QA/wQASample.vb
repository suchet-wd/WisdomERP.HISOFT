    ...
    Private Sub ObjClick(sender As Object, e As MouseEventArgs)
        ...
        Try
            ...
            If e.Button = System.Windows.Forms.MouseButtons.Left Then
                ...
                _Qry &= vbCrLf & "Where FTStyleCode='" & Microsoft.VisualBasic.Left(Me.FNHSysStyleId.Text, 6) & "'"
                ...
                For Each R As DataRow In _oDt.Rows
                    ...
                    Me.FTImage.Image = _ResizeImage(HI.UL.ULImage.LoadImage(_Path & "\Images\POINTMODEL\" & Microsoft.VisualBasic.Left(Me.FNHSysStyleId.Text, 6).ToString() & "\" & R!FTPicName.ToString))
