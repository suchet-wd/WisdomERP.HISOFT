...
Public Class wDailyQualityAssuranceDefect
...
#Region "Procedure"
    Private Sub LoadData()
        ...
        Try
            _Qry = "EXEC [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.SP_GETDATA_QADAILY_DEFECT " & Integer.Parse(Val(Me.FNHSysCmpId.Properties.Tag.ToString())) & ",'" & HI.UL.ULDate.ConvertEnDB(Me.FTSDate.Text) & "','" & HI.UL.ULDate.ConvertEnDB(Me.FTEDate.Text) & "'"
