...
Public Class wReportQADetail
    ...
    Private Sub LoadDetail()
        Try
            ...
            _Cmd &= vbCrLf & "                     TPRODTQA_SubDetail AS C ON A.FNHSysStyleId = C.FNHSysStyleId AND A.FNHSysUnitSectId = C.FNHSysUnitSectId AND A.FTOrderNo = C.FTOrderNo AND A.FDQADate = C.FDQADate"
            ...
            _Cmd &= vbCrLf & "FROM         TPRODTQA_SubDetail AS A INNER JOIN"
            ...
            _Cmd &= vbCrLf & "FROM         TPRODTQA AS A  WITH(NOLOCK) LEFT OUTER JOIN"
            _Cmd &= vbCrLf & "                      TPRODTQA_Detail AS B  WITH(NOLOCK) ON A.FNHSysStyleId = B.FNHSysStyleId AND A.FNHSysUnitSectId = B.FNHSysUnitSectId AND A.FDQADate = B.FDQADate AND A.FTOrderNo = B.FTOrderNo AND "
            _Cmd &= vbCrLf & "                 A.FNHourNo = B.FNHourNo LEFT OUTER JOIN"
            _Cmd &= vbCrLf & "                    TPRODTQA_SubDetail AS C  WITH(NOLOCK) ON A.FNHSysStyleId = C.FNHSysStyleId AND A.FNHSysUnitSectId = C.FNHSysUnitSectId AND A.FTOrderNo = C.FTOrderNo AND A.FDQADate = C.FDQADate"
            ...
            _Cmd &= vbCrLf & "					,(Select Count(*) AS Qty FROM         TPRODTQA_Detail"
            ...
            _Cmd &= vbCrLf & "                     , (Select count(*) AS Qty From TPRODTQA_SubDetail"
            ...
            _Cmd &= vbCrLf & "        FROM TPRODTQA   WITH(NOLOCK) "
            _Cmd &= vbCrLf & "         where FDQADate = A.FDQADate And FNHSysUnitSectId = A.FNHSysUnitSectId"
            _Cmd &= vbCrLf & "                   and FTOrderNo = A.FTOrderNo"
