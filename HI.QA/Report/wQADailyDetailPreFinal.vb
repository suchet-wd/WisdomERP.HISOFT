...
Public Class wQADailyDetailPreFinal
...
#End Region
    ...
    Private Sub LoadDataDetailDefect(_FNHSysUnitSectId As Integer, SDate As String, EDate As String)
        Try
            ...
            _Cmd &= vbCrLf & " ,isnull( (Select count(*) as t  From [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTQAPreFinal_Detail WITH(NOLOCK)  "
            ...
            _Cmd &= vbCrLf & " FROM  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTQAPreFinal AS A WITH (NOLOCK) LEFT OUTER JOIN"
