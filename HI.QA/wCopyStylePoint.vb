    ...
    Private Function CopyPoint() As Boolean
        Try
            ...
            For Each R As DataRow In m_DbDtStyleCode.Rows
                ...
                _Cmd = "Delete From [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTStylePoint  WHERE FTStyleCode ='" & Microsoft.VisualBasic.Left(R!FTStyleCode.ToString, 6) & "'"
                HI.Conn.SQLConn.Execute_Tran(_Cmd, HI.Conn.SQLConn.Cmd, HI.Conn.SQLConn.Tran)



                _Cmd = " INSERT INTO [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTStylePoint (FTInsUser, FDInsDate, FTInsTime, FNHSysStyleId, FTPointName, FTPicType, FNSeq, FNPointX, FNPointY, FNPicHeight, FNPicWidth, FTPicName,FTRemark,FTStyleCode) "
                ...
                _Cmd &= vbCrLf & "From [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTStylePoint WITH(NOLOCK) "
