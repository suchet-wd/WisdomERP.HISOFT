...
Public Class wDynamicMasterAddEditDynamic
    ...
    Private objForm As HI.TL.wAddEditDynamic
    ...
    Sub New(ByVal SysFormName As String, ByVal Title As String, ByVal AssemblyPath As String, ByVal tImage As String)
        ...
        objForm = New HI.TL.wAddEditDynamic(SysFormName, Title, Me.FormObjID, AssemblyPath, tImage, Me)
