...
Public Class wBomGarment
    ...
    Private Sub LoadSetPart()
        ...
        _Qry &= vbCrLf & " WHERE  (FTListName = N'FNOrderSetType')"
...
#Region "MAIN PROC"
    ...
    Private Sub LoadStyleDetail(ByVal FNHSysStyleId As String, _FNHSysSeasonId As Integer)
        ...
        _Str &= vbCrLf & ", T2.FTOrderNo AS FTOrderID, T2.FTSubOrderNo AS FTSubOrderID ,ISNULL(T2.FNOrderSetType,0) AS FNOrderSetType"
    ...
    Private Function SaveData() As Boolean
        ...
        Try
            ...
            Try
                ...
                _Str = "UPDATE [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_MERCHAN) & "].[dbo].[TMERTStyle] SET " & vbCrLf &
        ...
        Try
            ...
            For Each r As DataRow In dt.Rows
                ...
                For Each c As DataColumn In dt.Columns
                    ...
                    'If dt.Columns.IndexOf(c) > 16 And (Microsoft.VisualBasic.Left(c.ColumnName.ToString, "FTRawMatSizeCode".Length)).ToUpper <> "FTRawMatSizeCode".ToUpper Then
                    '    'If dt.Columns.IndexOf(c) Mod 2 = 0 Then
            ...
            If dtmatnew.Rows.Count > 0 Then
                ...
                With dtmatnew
                    ...
                    For Each Idx As Object In grp
                        ...
                        For Each R As DataRow In dtmatnew.Select("FNMerMatSeqNew=" & xMatSeq & "", "FNMerMatSeq")
