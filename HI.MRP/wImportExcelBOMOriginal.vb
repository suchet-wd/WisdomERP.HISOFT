...
Public Class wImportExcelBOMOriginal
                            ...
                            If dtstyledevimport.Rows.Count > 0 Then
                                ...
                                Try
                                    ...
                                    For Each R As DataRow In dtstyledevimport.Rows
                                        ...
                                        cmdstring = "  EXEC  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_FHS) & "].dbo.USP_IMPORTBOMEXCEL '" & HI.UL.ULF.rpQuoted(HI.ST.UserInfo.UserName) & "'," & DevID & ",'" & HI.UL.ULF.rpQuoted(R!STYLE_NBR.ToString) & "','" & HI.UL.ULF.rpQuoted(R!FTSeason.ToString) & "','" & HI.UL.ULF.rpQuoted(R!SEASON_CD.ToString) & "','" & HI.UL.ULF.rpQuoted(R!SEASON_YR.ToString) & "'," & Version & ",'" & HI.UL.ULF.rpQuoted(R!FTStatus.ToString) & "'," & Val(FNHSysCustId.Properties.Tag.ToString) & " "
                                        HI.Conn.SQLConn.ExecuteOnly(cmdstring, Conn.DB.DataBaseName.DB_FHS)

                                    Next

                                    cmdstring = "  EXEC  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_FHS) & "].dbo.USP_MOVE_IMPORTBOMEXCEL '" & HI.UL.ULF.rpQuoted(HI.ST.UserInfo.UserName) & "'"
                                    HI.Conn.SQLConn.ExecuteOnly(cmdstring, Conn.DB.DataBaseName.DB_FHS)
