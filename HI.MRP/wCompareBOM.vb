...
Public Class wCompareBOM
    ...
    Private Sub ocmok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ocmok.Click
        ...
        '_Str = "SELECT TOP 1 FNHSysStyleId FROM [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_MERCHAN) & "].dbo.TMERTStyle WITH(NOLOCK) WHERE FTStyleCode ='" & HI.UL.ULF.rpQuoted(FNHSysStyleId2.Text) & "' "
    ...
    'Private Sub FNHSysStyleId2_EditValueChanged(sender As System.Object, e As System.EventArgs)
