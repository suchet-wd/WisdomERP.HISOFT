...
Friend Class Start
    ...
    Shared Sub Main()
        ...
        Else
            ...
            Dim _LCDDisplay As New HI.LCD.LCDWarehouseDash
            'HI.ST.SysInfo.ModuleName = "Production System"
            'HI.ST.SysInfo.ModuleID = "55.6921"
            'HI.ST.SysInfo.MenuName = "MnuLCDDashboardWh"
