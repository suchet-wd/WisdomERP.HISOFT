...
Public Class wQAFinalLeaderApproved
            ...
            Else
                Select Case tCmdName.ToString.ToUpper
                    Case "FuncExit".ToUpper
                        ClsService.StateQAFLineLeaderShow = False
                        Me.Close()
                End Select
            End If
        Catch ex As Exception
...
#End Region
    ...
    Public Shared Function LoadDatainfoApprove() As DataTable
        Try
            ...
            _Cmd = "EXEC [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_PROD) & "].dbo.SP_GET_QAF_LEADER_APP_NIKE_AUDIT '" & HI.UL.ULF.rpQuoted(HI.ST.UserInfo.UserName) & "','" & HI.UL.ULF.rpQuoted(_LangDisPlay) & "'"
        ...
        Try
            Select Case Me.otbmain.SelectedTabPage.Name
                Case otpappqafinal.Name
                    ...
                    Try
                        Call _ClsService.Update_QAFLeaderApprove(ogvqafinal, "1")
                    Catch ex As Exception
                    End Try
                    _Spls.Close()
            End Select
        ...
        Try
            ...
            Select Case Me.otbmain.SelectedTabPage.Name
                Case otpappqafinal.Name
                    ...
                    Try
                        Call _ClsService.Update_QAFLeaderReject(ogvqafinal, "1", wShowReject.Data_Reason)
                    Catch ex As Exception
                    End Try
                    _Spls.Close()
            End Select
