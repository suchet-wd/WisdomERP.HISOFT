...
Public Class wDirectorApprovedAsset
            ...
            Else
                Select Case tCmdName.ToString.ToUpper
                    Case "FuncExit".ToUpper
                        ClsService.StateAssetDirectorShow = False
                        Me.Close()
                End Select
            End If
        Catch ex As Exception
...
#End Region
    ...
    Private Sub ValidateApp()
        ...
        If FindComputerName(Environment.MachineName.ToString()) Then
            ...
            If _CountApp > 0 Then
                ...
                If Not (DTPurchaseAssetNoDirector Is Nothing) Then


                    ogSupervisorApproved.DataSource = DTPurchaseAssetNoDirector
    ...
    Private Sub ogvDirectorApproved_DoubleClick(sender As Object, e As EventArgs) Handles ogvSupervisorApproved.DoubleClick
        With Me.ogvSupervisorApproved
            ...
            Dim _App As String = HI.Conn.SQLConn.GetField("Select P.FTPurchaseNo  from [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_FIXED) & "].dbo.TFIXEDTPurchase As P where P.FTPurchaseNo = '" & _PurchaseNo & "'", Conn.DB.DataBaseName.DB_SYSTEM, "")
            ...
            If _App <> "" Then
                ...
                End With
            Else
                Dim _WformPo As New wPurchaserServiceAsset
    ...
    Private Sub ogApprovedMail_Paint(sender As Object, e As PaintEventArgs) Handles ogApprovedMail.Paint
