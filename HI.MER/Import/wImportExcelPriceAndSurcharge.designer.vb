...
Partial Class wImportExcelPriceAndSurcharge
    ...
    Private Sub InitializeComponent()
        ...
        Me.oColFNFOB = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.oColFNFOBSizeup = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.oColFNSurcharge = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.oColFNSurchargeSizeup = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.oColFTPOItem.VisibleIndex = 11
        '
        'oColFNHSysMerTeamId
        '
        ...
        Me.oColFTColorwayCode.VisibleIndex = 9
        '
        'oColFTColorwayDesc
        '
        ...
        Me.oColFTColorwayDesc.VisibleIndex = 10
        '
        ...
        'oColFNFOB
        '
        Me.oColFNFOB.Caption = "FOB"
        Me.oColFNFOB.DisplayFormat.FormatString = "{0:n2}"
        Me.oColFNFOB.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.oColFNFOB.FieldName = "FNFOB"
        Me.oColFNFOB.Name = "oColFNFOB"
        Me.oColFNFOB.OptionsColumn.AllowEdit = False
        Me.oColFNFOB.OptionsColumn.ReadOnly = True
        Me.oColFNFOB.Visible = True
        Me.oColFNFOB.VisibleIndex = 12
        '
        'oColFNFOBSizeup
        '
        Me.oColFNFOBSizeup.Caption = "FOB Size Up"
        Me.oColFNFOBSizeup.DisplayFormat.FormatString = "{0:n2}"
        Me.oColFNFOBSizeup.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.oColFNFOBSizeup.FieldName = "FNFOBSizeup"
        Me.oColFNFOBSizeup.Name = "oColFNFOBSizeup"
        Me.oColFNFOBSizeup.OptionsColumn.AllowEdit = False
        Me.oColFNFOBSizeup.OptionsColumn.ReadOnly = True
        Me.oColFNFOBSizeup.Visible = True
        Me.oColFNFOBSizeup.VisibleIndex = 13
        '
        'oColFNSurcharge
        '
        Me.oColFNSurcharge.Caption = "Surcharge"
        Me.oColFNSurcharge.DisplayFormat.FormatString = "{0:n2}"
        Me.oColFNSurcharge.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.oColFNSurcharge.FieldName = "FNSurcharge"
        Me.oColFNSurcharge.Name = "oColFNSurcharge"
        Me.oColFNSurcharge.OptionsColumn.AllowEdit = False
        Me.oColFNSurcharge.OptionsColumn.ReadOnly = True
        Me.oColFNSurcharge.Visible = True
        Me.oColFNSurcharge.VisibleIndex = 15
        '
        'oColFNSurchargeSizeup
        '
        Me.oColFNSurchargeSizeup.Caption = "Surcharge Size Up"
        Me.oColFNSurchargeSizeup.DisplayFormat.FormatString = "{0:n2}"
        Me.oColFNSurchargeSizeup.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.oColFNSurchargeSizeup.FieldName = "FNSurchargeSizeup"
        Me.oColFNSurchargeSizeup.Name = "oColFNSurchargeSizeup"
        Me.oColFNSurchargeSizeup.OptionsColumn.AllowEdit = False
        Me.oColFNSurchargeSizeup.OptionsColumn.ReadOnly = True
        Me.oColFNSurchargeSizeup.Visible = True
        Me.oColFNSurchargeSizeup.VisibleIndex = 14
        '
        'oColFTShipModeDesc
        '
        ...
        Me.oColFTShipModeDesc.VisibleIndex = 7
        '
        'oColFNHSysUnitId
        '
        ...
        Me.oColFTUnitDesc.VisibleIndex = 8
        '
        'XtraTabPage2
        '
        ...
        Me.Name = "wImportExcelPriceAndSurcharge"
        Me.Text = "Import Price And Surcharge"
    ...
    Friend WithEvents oColFNFOB As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents oColFNFOBSizeup As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents oColFNSurcharge As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents oColFNSurchargeSizeup As DevExpress.XtraGrid.Columns.GridColumn
End Class
