...
#Region "MAIN PROC"
    ...
    Private Sub LoadOrderListingInfoToDirector(ByVal _FNHSysCmpId As String, ByVal _FTPORef As String, ByVal _FNHSysStyleId As String, ByVal _FNHSysCustId As String, ByVal _FNHSysBuyId As String, ByVal _FNHSysSeasonId As String)
        ...
        Try
            ...
            sqlCmd.CommandText = "[" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_MERCHAN) & "].[dbo].[SP_ORDER_LISTING_CMPO_TRACKING]"
...
#End Region
    ...
    Private Sub ocmpreview_Click(sender As Object, e As EventArgs) Handles ocmpreview.Click
        ...
        Try
            ...
            Dim _FTPORef As String = ""

            _FTOrderNo = "" & Me.ogvdirector.GetFocusedRowCellValue("FTOrderNo")
            _FTPORef = "" & Me.ogvdirector.GetFocusedRowCellValue("FTPORef")

            With New HI.RP.Report
                .FormTitle = Me.Text
                .ReportFolderName = "Merchandise Report\"
                .ReportName = "FactoryPO.rpt"
                .Formular = "{V_OrderSub_BreakDown_ShipDestination.FTOrderNo}='" & HI.UL.ULF.rpQuoted(_FTOrderNo) & "' AND {V_OrderSub_BreakDown_ShipDestination.FTPORef}='" & HI.UL.ULF.rpQuoted(_FTPORef) & "' "
                .Preview()
            End With
        Catch ex As Exception
