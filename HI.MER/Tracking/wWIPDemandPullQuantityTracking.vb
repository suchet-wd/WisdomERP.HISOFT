...
Public Class wWIPDemandPullQuantityTracking
...
#Region "MAIN PROC"
    ...
    Private Sub LoadOrderListingInfo(ByVal _FNHSysCmpId As String, ByVal _FTPORef As String, ByVal _FNHSysStyleId As String, ByVal _FNHSysCustId As String, ByVal _FNHSysBuyId As String, ByVal _FNHSysSeasonId As String)
        ...
        Try
            ...
            Qry = "exec [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MERCHAN) & "]..[SP_WIP_DATA_DEMAND_PULLTRACKINGINFO] " & Val(_FNHSysCmpId.ToString) & " "
        ...
        Try
            ...
            With Me.ogvdata
                ...
                Select Case e.Column.FieldName
                    ...
                    Case "FTStyleCode", "FTColorway", "FTSizeBreakDown"
                    ...
                    Case "FTSizeBreakDown"
                        ...
                        If ("" & .GetRowCellValue(e.RowHandle1, "FTOrderNo").ToString = "" & .GetRowCellValue(e.RowHandle2, "FTOrderNo").ToString) And ("" & .GetRowCellValue(e.RowHandle1, "FTColorway").ToString = "" & .GetRowCellValue(e.RowHandle2, "FTColorway").ToString) And "" & .GetRowCellValue(e.RowHandle1, e.Column.FieldName).ToString = "" & .GetRowCellValue(e.RowHandle2, e.Column.FieldName).ToString Then
                    ...
                    Case Else
                        ...
                        If ("" & .GetRowCellValue(e.RowHandle1, "FTOrderNo").ToString = "" & .GetRowCellValue(e.RowHandle2, "FTOrderNo").ToString) And ("" & .GetRowCellValue(e.RowHandle1, "FTColorway").ToString = "" & .GetRowCellValue(e.RowHandle2, "FTColorway").ToString) And ("" & .GetRowCellValue(e.RowHandle1, "FTSizeBreakDown").ToString = "" & .GetRowCellValue(e.RowHandle2, "FTSizeBreakDown").ToString) And "" & .GetRowCellValue(e.RowHandle1, e.Column.FieldName).ToString = "" & .GetRowCellValue(e.RowHandle2, e.Column.FieldName).ToString Then
