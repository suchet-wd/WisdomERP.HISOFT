...
Public Class wCopySewing
    ...
    Private Sub ocmok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ocmok.Click
        ...
        _Str = "SELECT TOP 1 FNHSysStyleId FROM [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_MERCHAN) & "].dbo.TMERTStyle_Sewing WITH(NOLOCK) WHERE FNHSysStyleId ='" & _style & "' "
    ...
    Private Sub wCopySewing_Load(sender As Object, e As EventArgs) Handles MyBase.Load
