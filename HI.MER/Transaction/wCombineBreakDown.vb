...
Public Class wCombineBreakDown
    ...
    Private Function CreateNewOrderNo() As Boolean
        ...
        Try
            ...
            With _CombinePopub
                ...
                .FTSubPORef.Text = ""
                .FNHSysShipToAccountId.Text = ""
                .FNHSysShipToAccountId.Properties.Tag = "0"
                ...
                If (.State) Then
                    If Me.FNCombineType.SelectedIndex = 1 Then
                        ...
                        _Qry &= " , FTStateCombine ,FTOrderNoBombineRef,FNHSysCmpIdTo)"
                        ...
                        _Qry &= vbCrLf & " ,ISNULL(( select top 1 Cmp.FNHSysCmpPOId from [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MASTER) & "].dbo.TCNMCmp AS Cmp With(NOLOCK) WHERE Cmp.FNHSysCmpId =" & Integer.Parse("0" & .FNHSysCmpId.Properties.Tag) & "  ),0) "
                    ...
                    _Qry = "INSERT INTO [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MERCHAN) & "].dbo.TMERTOrderSub "
                        ...
                        _Qry &= " ,[FTCustRef],[FTPORef], FTStateCombine ,FTOrderNoBombineRef,FNHSysPlantId,FNHSysBuyGrpId,FNOrderSetType,FNHSysShipToAccountId)"
                        _Qry &= vbCrLf & " Select  N'" & HI.UL.ULF.rpQuoted(HI.ST.UserInfo.UserName) & "'"
                        _Qry &= vbCrLf & "," & HI.UL.ULDate.FormatDateDB & ""
                        _Qry &= vbCrLf & "," & HI.UL.ULDate.FormatTimeDB
                    ...
                    _Qry &= vbCrLf & "," & Integer.Parse("0" & .FNHSysShipToAccountId.Properties.Tag.ToString())
                ...
                For Each Col As DataColumn In _oDtSum.Columns
                    Select Case Col.ColumnName.ToString.ToUpper
                        ...
                        Case Else
                            ...
                            If Integer.Parse("0" & R.Item(Col.ColumnName.ToString)) > 0 Then
