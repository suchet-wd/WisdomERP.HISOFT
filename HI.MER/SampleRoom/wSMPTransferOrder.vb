...
Public Class wSMPTransferOrder
    ...
    Private _AddItemPopup As wSMPTransferOrderItem
    ...
    Sub New()
        ...
        _AddItemPopup = New wSMPTransferOrderItem
...
#Region "Procedure"
    ...
    Public Sub LoadDataInfo(Key As Object)
        ...
        FDTransferDate.Properties.Buttons(0).Visible = False
        FDTransferDate.Properties.ReadOnly = True
    ...
    Private Sub LoadRcvDetail(PoKey As String)
        ...
        _Str &= vbCrLf & " FROM             [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_SAMPLE) & "].dbo.TSMPTransfer_Detail AS D WITH (NOLOCK)  "
        ...
        _Str &= vbCrLf & " WHERE        (D.FTTransferNo = N'" & HI.UL.ULF.rpQuoted(PoKey) & "')"
    ...
    Private Function VerrifyData() As Boolean
        ...
        If FTSMPOrderNo.Text = FTSMPOrderNoTo.Text Then
            Return False
        End If
    ...
    Private Function SaveData() As Boolean
        ...
        If (_StateNew) Then
            ...
            If Me.FDTransferDate.Properties.ReadOnly = False Then
                _Key = HI.TL.Document.GetDocumentNo(Me.SysDBName, Me.SysTableName, "", False, _CmpH, HI.UL.ULDate.ConvertEnDB(Me.FDTransferDate.Text)).ToString
            Else
    ...
    Private Function DeleteData() As Boolean
        Try
            ...
            Dim _Str As String
            _Str = "Delete From  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_SAMPLE) & "].dbo.TSMPTransfer WHERE FTTransferNo='" & HI.UL.ULF.rpQuoted(Me.FTTransferNo.Text) & "'"
            If HI.Conn.SQLConn.Execute_Tran(_Str, HI.Conn.SQLConn.Cmd, HI.Conn.SQLConn.Tran) <= 0 Then
                HI.Conn.SQLConn.Tran.Rollback()
                HI.Conn.SQLConn.DisposeSqlTransaction(HI.Conn.SQLConn.Tran)
                HI.Conn.SQLConn.DisposeSqlConnection(HI.Conn.SQLConn.Cmd)
            ...
            _Str = "Delete From  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_SAMPLE) & "].dbo.TSMPTransfer_Detail WHERE FTTransferNo='" & HI.UL.ULF.rpQuoted(Me.FTTransferNo.Text) & "'"
            ...
            HI.Auditor.CreateLog.CreateLogDelete(HI.ST.SysInfo.MenuName, Me.Name, "Delete From  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_SAMPLE) & "].dbo.TSMPTransfer WHERE FTTransferNo='" & HI.UL.ULF.rpQuoted(Me.FTTransferNo.Text) & "'")
            Return True
        Catch ex As Exception
            HI.Conn.SQLConn.Tran.Rollback()
            HI.Conn.SQLConn.DisposeSqlTransaction(HI.Conn.SQLConn.Tran)
...
#Region "MAIN PROC"
    ...
    Private Function CheckOwner() As Boolean
        If (HI.ST.UserInfo.UserName.ToUpper = FTTransferBy.Text.ToUpper) Or (HI.ST.SysInfo.Admin) Then
            Return True
        Else
            ...
            _Qry &= vbCrLf & "   WHERE  FTUserName = '" & HI.UL.ULF.rpQuoted(FTTransferBy.Text) & "' "
    ...
    Private Function CheckDocRef() As Boolean
        ...
        _Str = "Select TOP 1 FTDocReferNo FROM  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_SAMPLE) & "].dbo.TSMPIssue_Detail As R WITH(NOLOCK) WHERE FTDocReferNo='" & HI.UL.ULF.rpQuoted(FTTransferNo.Text) & "'  "

        If HI.Conn.SQLConn.GetField(_Str, Conn.DB.DataBaseName.DB_SAMPLE, "") <> "" Then

            HI.MG.ShowMsg.mProcessError(1603157331, "พบข้อมูลการจ่าย แล้ว ไม่สามารถทำการลบหรือแก้ไขรายการได้ !!!", Me.Text, System.Windows.Forms.MessageBoxIcon.Information)


            _Pass = False
        Else
            _Str = "Select TOP 1 FTDocReferNo FROM  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_SAMPLE) & "].dbo.TSMPTransfer_Detail As R WITH(NOLOCK) WHERE FTDocReferNo='" & HI.UL.ULF.rpQuoted(FTTransferNo.Text) & "'  "

            If HI.Conn.SQLConn.GetField(_Str, Conn.DB.DataBaseName.DB_SAMPLE, "") <> "" Then

                HI.MG.ShowMsg.mProcessError(1403157331, "พบข้อมูลการFvo แล้ว ไม่สามารถทำการลบหรือแก้ไขรายการได้ !!!", Me.Text, System.Windows.Forms.MessageBoxIcon.Information)
    ...
    Private Sub Proc_Delete(sender As System.Object, e As System.EventArgs) Handles ocmdelete.Click
        ...
        If (CheckDocRef() = False) Then Exit Sub
        If HI.MG.ShowMsg.mConfirmProcessDefaultNo(MG.ShowMsg.ProcessType.mDelete, Me.FTTransferNo.Text, Me.Text) = False Then
            Exit Sub
        End If
    ...
    Private Sub Proc_Preview(sender As System.Object, e As System.EventArgs) Handles ocmpreview.Click
        If Me.FTTransferNo.Text <> "" Then
            With New HI.RP.Report
                .FormTitle = Me.Text
                .ReportFolderName = "Inventrory\"
                .ReportName = "SMPTransferOrderSlip.rpt"
                .Formular = "{TSMPTransfer.FTTransferNo}='" & HI.UL.ULF.rpQuoted(FTTransferNo.Text) & "' "
                .Preview()
            End With


        Else
            HI.MG.ShowMsg.mInvalidData(MG.ShowMsg.InvalidType.SelectData, Me.Text, Me.FTTransferNo_lbl.Text)
            FTTransferNo.Focus()
        End If
    End Sub
...
#End Region
    ...
    Private Sub ogvdetail_RowCountChanged(sender As System.Object, e As System.EventArgs) Handles ogvdetail.RowCountChanged
        ...
        Try
            ...
            Me.FTSMPOrderNo.Properties.ReadOnly = (dt.Rows.Count > 0)
            FTSMPOrderNo.Properties.Buttons.Item(0).Enabled = Not (dt.Rows.Count > 0)


            Me.FNHSysWHId.Properties.ReadOnly = (dt.Rows.Count > 0)
            FNHSysWHId.Properties.Buttons.Item(0).Enabled = Not (dt.Rows.Count > 0)

            Me.FTSMPOrderNoTo.Properties.ReadOnly = (dt.Rows.Count > 0)
            FTSMPOrderNoTo.Properties.Buttons.Item(0).Enabled = Not (dt.Rows.Count > 0)
    ...
    Private Sub FTReceiveNo_EditValueChanged(sender As System.Object, e As System.EventArgs) Handles FTTransferNo.EditValueChanged
    End Sub
    ...
    Private Sub ocmadd_Click(sender As System.Object, e As System.EventArgs) Handles ocmadd.Click
        If CheckOwner() = False Then Exit Sub
        If (CheckDocRef() = False) Then Exit Sub
        If FTTransferNo.Properties.Tag.ToString = "" Then
            If Me.VerrifyData() Then
                If Me.SaveData Then
                Else
                    Exit Sub
        ...
        Else
            ...
            If Me.FTTransferNo.Text = "" Or Me.FTTransferNo.Properties.Tag.ToString = "" Then
                Exit Sub
            Else

                If FTSMPOrderNo.Properties.ReadOnly = False Then
        ...
        _Str = " EXEC  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_SAMPLE) & "].dbo.SP_GET_ONHAND_FOR_ISSUE " & Val(FNHSysWHId.Properties.Tag.ToString()) & ",'" & HI.UL.ULF.rpQuoted(FTSMPOrderNo.Text) & "','" & HI.UL.ULF.rpQuoted(FTTransferNo.Text) & "' "
        ...
        With _AddItemPopup
            ...
            If .ProcessProc Then
                ...
                If _dt.Select(" FNIssueQuantity > 0 ").Length > 0 Then
                    If Me.VerrifyData() Then
                        If Me.SaveData Then
                        Else
                            Exit Sub
                    ...
                    Try
                        ...
                        _Str = " DELETE  FROM  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_SAMPLE) & "].dbo.TSMPTransfer_Detail "
                        _Str &= vbCrLf & " WHERE   FTTransferNo ='" & HI.UL.ULF.rpQuoted(Me.FTTransferNo.Text) & "' "

                        HI.Conn.SQLConn.Execute_Tran(_Str, HI.Conn.SQLConn.Cmd, HI.Conn.SQLConn.Tran)

                        Dim FNDataSeq As Integer = 0

                        For Each R As DataRow In _dt.Select("FNIssueQuantity > 0")

                            _Spls.UpdateInformation("Issue Detail....   Please Wait    ")

                            FNDataSeq = FNDataSeq + 1

                            _Str = " INSERT INTO  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_SAMPLE) & "].dbo.TSMPTransfer_Detail ( FTInsUser, FDInsDate, FTInsTime, FTTransferNo, FNSeq, FTMatCode,FTMatColorCode,FTMatSizeCode, FTDescription, FNQuantity, FNPrice, FNAmount, FTPurchaseNoRef, FTDocReferNo,FNHSysUnitId) "
                            _Str &= vbCrLf & " SELECT '" & HI.UL.ULF.rpQuoted(HI.ST.UserInfo.UserName) & "' "
                            _Str &= vbCrLf & "," & HI.UL.ULDate.FormatDateDB & " "
                            _Str &= vbCrLf & "," & HI.UL.ULDate.FormatTimeDB & " "
                            _Str &= vbCrLf & ",'" & HI.UL.ULF.rpQuoted(Me.FTTransferNo.Text) & "' "
                            _Str &= vbCrLf & "," & FNDataSeq & " "
                            ...
                            _Str &= vbCrLf & "," & Val(R!FNIssueQuantity.ToString) & " "
                            _Str &= vbCrLf & "," & Val(R!FNPrice.ToString) & " "
                            _Str &= vbCrLf & "," & CDbl(Format(Val(R!FNIssueQuantity.ToString) * Val(R!FNPrice.ToString), HI.ST.Config.AmtFormat)) & " "
                            _Str &= vbCrLf & ",'" & HI.UL.ULF.rpQuoted(R!FTPurchaseNo.ToString) & "' "
                            _Str &= vbCrLf & ",'" & HI.UL.ULF.rpQuoted(R!FTReceiveNo.ToString) & "' "
                    ...
                    Me.LoadRcvDetail(Me.FTTransferNo.Text)
    ...
    Private Sub ocmremove_Click(sender As System.Object, e As System.EventArgs) Handles ocmremove.Click
        With ogvdetail
            ...
            Try
                ...
                _Str = " Delete From [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_SAMPLE) & "].dbo.TSMPTransfer_Detail   WHERE FTTransferNo='" & HI.UL.ULF.rpQuoted(Me.FTTransferNo.Text) & "' AND  FNSeq=" & Val(_MatID) & " "
                If HI.Conn.SQLConn.Execute_Tran(_Str, HI.Conn.SQLConn.Cmd, HI.Conn.SQLConn.Tran) <= 0 Then
                    HI.Conn.SQLConn.Tran.Rollback()
                    HI.Conn.SQLConn.DisposeSqlTransaction(HI.Conn.SQLConn.Tran)
                    HI.Conn.SQLConn.DisposeSqlConnection(HI.Conn.SQLConn.Cmd)
                ...
                HI.Auditor.CreateLog.CreateLogDelete(HI.ST.SysInfo.MenuName, Me.Name, " Delete From [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_SAMPLE) & "].dbo.TSMPTransfer_Detail   WHERE FTTransferNo='" & HI.UL.ULF.rpQuoted(Me.FTTransferNo.Text) & "' AND  FNSeq=" & Val(_MatID) & " ")
    ...
    Private Sub ocmrefresh_Click(sender As Object, e As EventArgs) Handles ocmrefresh.Click
        Call LoadDataInfo(Me.FTTransferNo.Text)
    End Sub
    ...
    Private Sub FDReceiveDate_EditValueChanged(sender As Object, e As EventArgs) Handles FDTransferDate.EditValueChanged

    End Sub

    Private Sub FDReceiveDate_EditValueChanging(sender As Object, e As DevExpress.XtraEditors.Controls.ChangingEventArgs) Handles FDTransferDate.EditValueChanging
        Try
            If FDTransferDate.Properties.ReadOnly = False Then
