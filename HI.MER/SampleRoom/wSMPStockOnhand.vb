...
#Region "Procedure"
    ...
    Private Sub LoadData()
        ...
        _Qry = " EXEC [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_SAMPLE) & "].dbo.SP_GET_STOCK_ONHAND " & Val(Me.FNHSysWHId.Properties.Tag.ToString) & ",'" & HI.UL.ULF.rpQuoted(Me.FTSMPOrderNo.Text) & "','" & HI.UL.ULF.rpQuoted(Me.FTSMPOrderNoTo.Text) & "' "
