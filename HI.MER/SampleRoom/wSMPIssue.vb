...
Public Class wSMPIssue
    ...
    Private _AddItemPopup As wSMPIssueItem
    ...
    Sub New()
        ...
        _AddItemPopup = New wSMPIssueItem
...
#Region "Procedure"
    ...
    Public Sub LoadDataInfo(Key As Object)
        ...
        FDIssueDate.Properties.Buttons(0).Visible = False
        FDIssueDate.Properties.ReadOnly = True
    ...
    Private Sub LoadRcvDetail(PoKey As String)
        ...
        _Str &= vbCrLf & " FROM             [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_SAMPLE) & "].dbo.TSMPIssue_Detail AS D WITH (NOLOCK)  "
        ...
        _Str &= vbCrLf & " WHERE        (D.FTIssueNo = N'" & HI.UL.ULF.rpQuoted(PoKey) & "')"
    ...
    Private Function SaveData() As Boolean
        ...
        If (_StateNew) Then
            ...
            If Me.FDIssueDate.Properties.ReadOnly = False Then
                _Key = HI.TL.Document.GetDocumentNo(Me.SysDBName, Me.SysTableName, "", False, _CmpH, HI.UL.ULDate.ConvertEnDB(Me.FDIssueDate.Text)).ToString
            Else
    ...
    Private Function DeleteData() As Boolean
        Try
            ...
            Dim _Str As String
            _Str = "Delete From  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_SAMPLE) & "].dbo.TSMPIssue WHERE FTIssueNo='" & HI.UL.ULF.rpQuoted(Me.FTIssueNo.Text) & "'"
            If HI.Conn.SQLConn.Execute_Tran(_Str, HI.Conn.SQLConn.Cmd, HI.Conn.SQLConn.Tran) <= 0 Then
                HI.Conn.SQLConn.Tran.Rollback()
                HI.Conn.SQLConn.DisposeSqlTransaction(HI.Conn.SQLConn.Tran)
                HI.Conn.SQLConn.DisposeSqlConnection(HI.Conn.SQLConn.Cmd)
            ...
            _Str = "Delete From  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_SAMPLE) & "].dbo.TSMPIssue_Detail WHERE FTIssueNo='" & HI.UL.ULF.rpQuoted(Me.FTIssueNo.Text) & "'"
            ...
            HI.Auditor.CreateLog.CreateLogDelete(HI.ST.SysInfo.MenuName, Me.Name, "Delete From  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_SAMPLE) & "].dbo.TSMPIssue WHERE FTIssueNo='" & HI.UL.ULF.rpQuoted(Me.FTIssueNo.Text) & "'")
            Return True
        Catch ex As Exception
            HI.Conn.SQLConn.Tran.Rollback()
            HI.Conn.SQLConn.DisposeSqlTransaction(HI.Conn.SQLConn.Tran)
...
#Region "MAIN PROC"
    ...
    Private Function CheckDocRef() As Boolean
        ...
        _Str = "Select TOP 1 FTIssueRefNo FROM  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_SAMPLE) & "].dbo.TSMPReturn_Detail As R WITH(NOLOCK) WHERE FTIssueRefNo='" & HI.UL.ULF.rpQuoted(FTIssueNo.Text) & "'  "
    ...
    Private Sub Proc_Preview(sender As System.Object, e As System.EventArgs) Handles ocmpreview.Click
        If Me.FTIssueNo.Text <> "" Then
            With New HI.RP.Report
                ...
                .Formular = "{TSMPIssue.FTIssueNo}='" & HI.UL.ULF.rpQuoted(FTIssueNo.Text) & "' "
                .Preview()
            End With
...
#End Region
    ...
    Private Sub FTReceiveNo_EditValueChanged(sender As System.Object, e As System.EventArgs) Handles FTIssueNo.EditValueChanged
    End Sub
    ...
    Private Sub ocmadd_Click(sender As System.Object, e As System.EventArgs) Handles ocmadd.Click
        ...
        If FTIssueNo.Properties.Tag.ToString = "" Then
            ...
            End If
        Else
            If Me.FTIssueNo.Text = "" Or Me.FTIssueNo.Properties.Tag.ToString = "" Then
                Exit Sub
            Else
        ...
        _Str = " EXEC  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_SAMPLE) & "].dbo.SP_GET_ONHAND_FOR_ISSUE " & Val(FNHSysWHId.Properties.Tag.ToString()) & ",'" & HI.UL.ULF.rpQuoted(FTSMPOrderNo.Text) & "','" & HI.UL.ULF.rpQuoted(FTIssueNo.Text) & "' "
            ...
            If .ProcessProc Then
                ...
                If _dt.Select(" FNIssueQuantity > 0 ").Length > 0 Then
                    ...
                    Try
                        ...
                        _Str = " DELETE  FROM  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_SAMPLE) & "].dbo.TSMPIssue_Detail "
                        _Str &= vbCrLf & " WHERE   FTIssueNo ='" & HI.UL.ULF.rpQuoted(Me.FTIssueNo.Text) & "' "
                        ...
                        For Each R As DataRow In _dt.Select("FNIssueQuantity > 0")
                            ...
                            _Str = " INSERT INTO  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_SAMPLE) & "].dbo.TSMPIssue_Detail ( FTInsUser, FDInsDate, FTInsTime, FTIssueNo, FNSeq, FTMatCode, FTMatColorCode,FTMatSizeCode,FTDescription, FNQuantity, FNPrice, FNAmount, FTPurchaseNoRef, FTDocReferNo,FNHSysUnitId) "
                            _Str &= vbCrLf & " SELECT '" & HI.UL.ULF.rpQuoted(HI.ST.UserInfo.UserName) & "' "
                            _Str &= vbCrLf & "," & HI.UL.ULDate.FormatDateDB & " "
                            _Str &= vbCrLf & "," & HI.UL.ULDate.FormatTimeDB & " "
                            _Str &= vbCrLf & ",'" & HI.UL.ULF.rpQuoted(Me.FTIssueNo.Text) & "' "
                    ...
                    Me.LoadRcvDetail(Me.FTIssueNo.Text)
    ...
    Private Sub ocmremove_Click(sender As System.Object, e As System.EventArgs) Handles ocmremove.Click
        With ogvdetail
            ...
            Try
                ...
                _Str = " Delete From [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_SAMPLE) & "].dbo.TSMPIssue_Detail   WHERE FTIssueNo='" & HI.UL.ULF.rpQuoted(Me.FTIssueNo.Text) & "' AND  FNSeq=" & Val(_MatID) & " "
                If HI.Conn.SQLConn.Execute_Tran(_Str, HI.Conn.SQLConn.Cmd, HI.Conn.SQLConn.Tran) <= 0 Then
                    HI.Conn.SQLConn.Tran.Rollback()
                    HI.Conn.SQLConn.DisposeSqlTransaction(HI.Conn.SQLConn.Tran)
                    HI.Conn.SQLConn.DisposeSqlConnection(HI.Conn.SQLConn.Cmd)
                ...
                HI.Auditor.CreateLog.CreateLogDelete(HI.ST.SysInfo.MenuName, Me.Name, " Delete From [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_SAMPLE) & "].dbo.TSMPIssue_Detail   WHERE FTIssueNo='" & HI.UL.ULF.rpQuoted(Me.FTIssueNo.Text) & "' AND  FNSeq=" & Val(_MatID) & " ")
    ...
    Private Sub ocmrefresh_Click(sender As Object, e As EventArgs) Handles ocmrefresh.Click
        Call LoadDataInfo(Me.FTIssueNo.Text)
    End Sub


    Private Sub FDReceiveDate_EditValueChanging(sender As Object, e As DevExpress.XtraEditors.Controls.ChangingEventArgs) Handles FDIssueDate.EditValueChanging
        Try
            If FDIssueDate.Properties.ReadOnly = False Then
