...
#Region "Procedure "
    ...
    Private Sub GetEmployeeActualFromHR()
        ...
        _Qry &= vbCrLf & "	  AND Emp.FNHSysEmpTypeId IN(SELECT FNHSysEmpTypeId FROM [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MASTER) & "].dbo.THRMEmpType AS ET WITH (NOLOCK) WHERE FTEmpTypeCode ='S'  )"
            ...
            Try
                ...
                If _TotalTarget > 0 Then
                    ...
                    If _dttime.Rows.Count > 0 Then
                        ...
                        _Qry &= vbCrLf & "   WHERE O.FNHSysUnitSectId =" & Integer.Parse(Val(LineId)) & ""
    ...
    Public Sub SetData(Optional StateSwipDate As Boolean = False)
        ...
        Try
            ...
            If LineNo <> "" Then
                ...
                olbsline.Text = "L." & Microsoft.VisualBasic.Right(LineNo, 2)
...
#Region "Procedure "
            ...
            Try
                ...
                If _TotalTarget > 0 Then
                    ...
                    If _dttime.Rows.Count > 0 Then
                        ...
                        _Qry &= vbCrLf & "   WHERE O.FNHSysUnitSectId =" & Integer.Parse(Val(L2LineId)) & ""
    ...
    Private Sub olbslvt4_Click(sender As Object, e As EventArgs) Handles olbslvt4.Click
