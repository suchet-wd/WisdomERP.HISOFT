...
Public Class WHLocation
    ...
    Private objForm As WHLocationAddEdit
    Private _wGenerateWH As wGenWHLocation
    ...
    Sub New()
        ...
        objForm = New WHLocationAddEdit(SysFormName, Me.Text, Me.FormObjID, AssemblyPath, "", Me)
        ...
        _wGenerateWH = New wGenWHLocation
...
#End Region
    ...
    Private Sub ocmpreview_Click(sender As Object, e As EventArgs) Handles ocmpreview.Click
        Try
            ...
            Dim _FM As String = "" : Dim _FT As String = ""
            _FM = "{TCNMWarehouseLocationFG.FTWHLocCode} <>  ''  "
            With ogvdetail

                For i As Integer = 1 To .RowCount
                    'If .IsRowVisible(i) = DevExpress.XtraGrid.Views.Grid.RowVisibleState.Visible Then
                    If Not (_FT = "") Then _FT &= " OR "
                    _FT &= " {TCNMWarehouseLocationFG.FTWHLocCode} ='" & .GetRowCellValue(i, "FTWHLocCode") & "' "
                    'End If
                Next
            End With
            If Not (_FT = "") Then
            ...
            With New HI.RP.Report
                ...
                .ReportName = "WarehouseLocationFGSlip.rpt"
                .Formular = _FM
                .Preview()
            End With
