...
Public Class wFGStockOnhand_CVN
...
#Region "Processing"
    ...
    Private Sub LoadData1()
        ...
        Try
            ...
            _Cmd = "Exec   [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_FG) & "].dbo.USP_GETSTOCKONHAND_FG '" & HI.UL.ULF.rpQuoted(Me.FNHSysWHIdFG.Text) & "','" & HI.UL.ULF.rpQuoted(Me.FNHSysWHIdFGTo.Text) & "','" & HI.UL.ULF.rpQuoted(Me.FTOrderNo.Text) & "','" & HI.UL.ULF.rpQuoted(Me.FTOrderNoTo.Text) & "'"
