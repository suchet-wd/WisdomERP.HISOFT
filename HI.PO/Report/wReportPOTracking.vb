...
Public Class wReportPOTracking
    ...
    Private Sub _Preview()
        Try
            ...
            If Me.FTPurchaseNo.Text <> "" Then
                ...
                _FN &= " {V_RptPOTracking.FTPurchaseNo}  >= '" & HI.UL.ULF.rpQuoted(Me.FTPurchaseNo.Text) & "'"
            End If

            If Me.FTPurchaseNoTo.Text <> "" Then
                _FN &= IIf(_FN.Trim <> "", " AND ", "")
                _FN &= " {V_RptPOTracking.FTPurchaseNo}  <= '" & HI.UL.ULF.rpQuoted(Me.FTPurchaseNoTo.Text) & "'"
            End If
            ...
            If Me.FDPODate.Text <> "" Then
                _FN &= IIf(_FN.Trim <> "", " AND ", "")
                _FN &= " {V_RptPOTracking.FDPurchaseDate}  >= '" & HI.UL.ULDate.ConvertEnDB(Me.FDPODate.Text) & "'"
            End If

            If Me.FDPODateTo.Text <> "" Then
                _FN &= IIf(_FN.Trim <> "", " AND ", "")
                _FN &= " {V_RptPOTracking.FDPurchaseDate}  <= '" & HI.UL.ULDate.ConvertEnDB(Me.FDPODateTo.Text) & "'"
            End If
            ...
            '***********Delivery Place
            If Me.FDDeliveryDate.Text <> "" Then
                _FN &= IIf(_FN.Trim <> "", " AND ", "")
                _FN &= "{V_RptPOTracking.FDDeliveryDate}  >='" & HI.UL.ULDate.ConvertEnDB(Me.FDDeliveryDate.Text) & "'"
            End If

            If Me.FDDeliveryDateTo.Text <> "" Then
                _FN &= IIf(_FN.Trim <> "", " AND ", "")
                _FN &= "{V_RptPOTracking.FDDeliveryDate} <='" & HI.UL.ULDate.ConvertEnDB(Me.FDDeliveryDateTo.Text) & "'"
            End If
            ...
            Select Case PoCondition1.FNSuplCon.SelectedIndex
                Case 1
                    If PoCondition1.FNHSysSuplId.Text <> "" Then
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  {V_RptPOTracking.FTSuplCode} >='" & HI.UL.ULF.rpQuoted(PoCondition1.FNHSysSuplId.Text) & "' "
                    End If

                    If PoCondition1.FNHSysSuplIdTo.Text <> "" Then
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  {V_RptPOTracking.FTSuplCode} <='" & HI.UL.ULF.rpQuoted(PoCondition1.FNHSysSuplIdTo.Text) & "' "
                    End If
                Case 2
                    tText = ""
                    ...
                    If tText.Trim <> "" Then
                        tText = Microsoft.VisualBasic.Left(Trim(tText), Len(Trim(tText)) - 1)
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  {V_RptPOTracking.FTSuplCode} IN['" & tText.Replace("|", "','") & "'] "
                    End If
            End Select
        End If
            ...
            Select Case PoCondition1.FNItemCon.SelectedIndex
                Case 1
                    ...
                    If PoCondition1.FNHSysRawMatId.Text <> "" Then
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  {TINVENMMaterial.FTRawMatCode} >='" & HI.UL.ULF.rpQuoted(PoCondition1.FNHSysRawMatId.Text) & "' "
                    End If

                    If PoCondition1.FNHSysRawMatIdTo.Text <> "" Then
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  {TINVENMMaterial.FTRawMatCode} <='" & HI.UL.ULF.rpQuoted(PoCondition1.FNHSysRawMatIdTo.Text) & "' "
                    End If
            ...
            Select Case PoCondition1.FNColorCon.SelectedIndex
                Case 1
                    If PoCondition1.FNHSysRawMatColorId.Text <> "" Then
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  {vwTINVENMMatColor.FTRawMatColorCode}  >='" & HI.UL.ULF.rpQuoted(PoCondition1.FNHSysRawMatColorId.Text) & "' "
                    End If

                    If PoCondition1.FNHSysRawMatColorIdTo.Text <> "" Then
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  {vwTINVENMMatColor.FTRawMatColorCode}  <='" & HI.UL.ULF.rpQuoted(PoCondition1.FNHSysRawMatColorIdTo.Text) & "' "
                    End If
                Case 2
                    tText = ""
                    ...
                    If tText.Trim <> "" Then
                        tText = Microsoft.VisualBasic.Left(Trim(tText), Len(Trim(tText)) - 1)
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  {vwTINVENMMatColor.FTRawMatColorCode}  IN['" & tText.Replace("|", "','") & "'] "
                    End If
            End Select
        End If
            ...
            Select Case PoCondition1.FNSizeCon.SelectedIndex
                Case 1
                    If PoCondition1.FNHSysRawMatSizeId.Text <> "" Then
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  {vwTINVENMMatSize.FTRawMatSizeCode}  >='" & HI.UL.ULF.rpQuoted(PoCondition1.FNHSysRawMatSizeId.Text) & "' "
                    End If

                    If PoCondition1.FNHSysRawMatSizeIdTo.Text <> "" Then
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  {vwTINVENMMatSize.FTRawMatSizeCode}  <='" & HI.UL.ULF.rpQuoted(PoCondition1.FNHSysRawMatSizeIdTo.Text) & "' "
                    End If
                Case 2
                    tText = ""
                    ...
                    If tText.Trim <> "" Then
                        tText = Microsoft.VisualBasic.Left(Trim(tText), Len(Trim(tText)) - 1)
                        _Criteria &= IIf(_Criteria.Trim <> "", " AND ", "")
                        _Criteria &= "  {vwTINVENMMatSize.FTRawMatSizeCode}  IN['" & tText.Replace("|", "','") & "'] "
                    End If
    ...
    Private Sub wReportPOTracking_Load(sender As Object, e As EventArgs) Handles Me.Load
        RemoveHandler FDDeliveryDate.GotFocus, AddressOf HI.TL.HandlerControl.DateEdit_GotFocus
        RemoveHandler FDDeliveryDateTo.GotFocus, AddressOf HI.TL.HandlerControl.DateEdit_GotFocus
