...
Public Class wPurchaseTrackingPIAddPayment
    ...
    Private Function ValidateData() As Boolean
        ...
        If Me.FTPIPayDate.Text <> "" Then
            If Me.FTVenderAccNo.Text.Trim <> "" Then
                _Pass = True
            Else
                HI.MG.ShowMsg.mInvalidData(MG.ShowMsg.InvalidType.InputData, Me.Text, FTPIPayTypeRemark_lbl.Text)
                FTPIPayTypeRemark.Focus()
            End If
        Else
            HI.MG.ShowMsg.mInvalidData(MG.ShowMsg.InvalidType.InputData, Me.Text, FTPIPayDate_lbl.Text)
            FTPIPayDate.Focus()
        End If
