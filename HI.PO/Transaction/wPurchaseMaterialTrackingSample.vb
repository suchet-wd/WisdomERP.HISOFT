...
Public Class wPurchaseMaterialTrackingSample
...
#Region "Procedure"
    ...
    Private Sub LoadData()
        ...
        Try
            ...
            _Qry &= ", @SPO = '', @EPO = '', @FNSSupl = " & Val(FNHSysSuplId.Properties.Tag.ToString) & ", @FNBuy = " & Val(FNHSysBuyId.Properties.Tag.ToString) & ", @DocType = 2" & vbCrLf
...
#End Region
    ...
    Private Sub FNListDocumentTrackPIData_SelectedIndexChanged(sender As Object, e As EventArgs) Handles FNListDocumentTrackPIData.SelectedIndexChanged
        ...
        Select Case FNListDocumentTrackPIData.SelectedIndex.ToString
            Case "0"
                ...
                FTStartDevCFMDate.Properties.MinValue = DateAndTime.DateValue(Today.AddDays(-90))
                FTStartDevCFMDate.Properties.MaxValue = Today()
                FTEndDevCFMDate.Properties.MinValue = DateAndTime.DateValue(Today.AddDays(-90))
                FTEndDevCFMDate.Properties.MaxValue = Today()

                FTStartSRConfirmDate.Properties.MinValue = DateAndTime.DateValue(Today.AddDays(-90))
                FTStartSRConfirmDate.Properties.MaxValue = Today()
                FTEndSRConfirmDate.Properties.MinValue = DateAndTime.DateValue(Today.AddDays(-90))
                FTEndSRConfirmDate.Properties.MaxValue = Today()
            ...
            Case "1"
                ...
                FTStartDevCFMDate.Properties.MinValue = DateAndTime.DateValue(Today.AddDays(-180))
                FTStartDevCFMDate.Properties.MaxValue = Today()
                FTEndDevCFMDate.Properties.MinValue = DateAndTime.DateValue(Today.AddDays(-180))
                FTEndDevCFMDate.Properties.MaxValue = Today()

                FTStartSRConfirmDate.Properties.MinValue = DateAndTime.DateValue(Today.AddDays(-180))
                FTStartSRConfirmDate.Properties.MaxValue = Today()
                FTEndSRConfirmDate.Properties.MinValue = DateAndTime.DateValue(Today.AddDays(-180))
                FTEndSRConfirmDate.Properties.MaxValue = Today()
            Case "2"
                ...
                FTStartDevCFMDate.Properties.MinValue = DateAndTime.DateValue(Today.AddDays(-365))
                FTStartDevCFMDate.Properties.MaxValue = Today()
                FTEndDevCFMDate.Properties.MinValue = DateAndTime.DateValue(Today.AddDays(-365))
                FTEndDevCFMDate.Properties.MaxValue = Today()

                FTStartSRConfirmDate.Properties.MinValue = DateAndTime.DateValue(Today.AddDays(-365))
                FTStartSRConfirmDate.Properties.MaxValue = Today()
                FTEndSRConfirmDate.Properties.MinValue = DateAndTime.DateValue(Today.AddDays(-365))
                FTEndSRConfirmDate.Properties.MaxValue = Today()
            Case "3"
                ...
                FTStartDevCFMDate.Properties.MinValue = DateAndTime.DateValue(Today.AddDays(-730))
                FTStartDevCFMDate.Properties.MaxValue = Today()
                FTEndDevCFMDate.Properties.MinValue = DateAndTime.DateValue(Today.AddDays(-730))
                FTEndDevCFMDate.Properties.MaxValue = Today()

                FTStartSRConfirmDate.Properties.MinValue = DateAndTime.DateValue(Today.AddDays(-730))
                FTStartSRConfirmDate.Properties.MaxValue = Today()
                FTEndSRConfirmDate.Properties.MinValue = DateAndTime.DateValue(Today.AddDays(-730))
                FTEndSRConfirmDate.Properties.MaxValue = Today()
        End Select
    End Sub
    ...
    Private Sub FTStartDevCFMDate_EditValueChanged(sender As Object, e As EventArgs) Handles FTStartDevCFMDate.EditValueChanged
        If FTStartDevCFMDate.Text.ToString <> "" Then
            FTEndDevCFMDate.Properties.MinValue = FTStartDevCFMDate.EditValue
        End If
    End Sub
End Class