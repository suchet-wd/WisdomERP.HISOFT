...
#Region "Procedure"
    Private Sub LoadData()
        ...
        Try
            ...
            _Qry &= vbCrLf & "  ,Convert(numeric(18,2), Sum(A.FNNetAmt) *  A.FNExchangeRate) AS FNNetAmt"
            ...
            _Qry &= vbCrLf & "  ,(B.FNPrice - B.FNDisAmt + ISNULL(B.FNSurchangePerUnit,0))  AS FNNetPrice,Sum(FNQuantity ) AS FNQuantity"
            ...
            _Qry &= vbCrLf & " GROUP BY A.FTPurchaseNo, A.FDPurchaseDate, A.FNHSysSuplId, A.FNHSysCmpId, A.FNHSysCurId, A.FNExchangeRate,B.FNHSysRawMatId,B.FNPrice,B.FNDisAmt,ISNULL(B.FNSurchangePerUnit,0)) AS A"
            ...
            _Qry &= vbCrLf & " ("
            _Qry &= vbCrLf & " SELECT    A.FTPurchaseNo,B.FNHSysRawMatId,SUM(Convert(numeric(18,2), A.FNExchangeRate* B.FNNetAmt)) AS FNNetAmt,Sum(FNQuantity) AS FNQuantity"
            ...
            _Qry &= vbCrLf & " GROUP BY A.FTPurchaseNo,B.FNHSysRawMatId"
            ...
            _Qry &= vbCrLf & "   ,Cmp.FTCmpCode,A.FNExchangeRate"
