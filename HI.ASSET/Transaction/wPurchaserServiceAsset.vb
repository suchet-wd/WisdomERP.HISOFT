...
Public Class wPurchaserServiceAsset
...
#Region "Proceducre"
    ...
    Private Sub LoadPoDetail(PoKey As String)
        Dim Qry As String = ""
        Qry = "select A.FNSeq,A.FTDescription,A.FNQuantity,A.FNPrice,A.FNAmount,A.FTNote,A.FNNetAmt,B.FTAssetCode,B.FTProductCode,M.FTAssetModelCode AS FTAssetModelName,BR.FTAssetBrandCode AS FTAssetBrandName,U.FTUnitAssetCode as FTUnitCode,U.FNHSysUnitAssetId AS FNHSysUnitId,A.FNHSysFixedAssetId"
        If ST.Lang.Language = ST.Lang.eLang.TH Then
            Qry &= vbCrLf & ",B.FTAssetNameTH AS FTAssetName"
        Else
            Qry &= vbCrLf & ",B.FTAssetNameEN AS FTAssetName"
        End If
