...
#End Region
    ...
    Private Sub ocmadd_Click(sender As System.Object, e As System.EventArgs) Handles ocmadd.Click
        ...
        If _AssetType <> 1 Then
            ...
            _Str &= vbCrLf & " LEFT OUTER JOIN  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_MASTER) & "].dbo.TCNMUnitAsset as U WITH(NOLOCK) ON P.FNHSysUnitId = U.FNHSysUnitAssetId "
