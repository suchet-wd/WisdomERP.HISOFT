            ...
            For Each R As DataRow In _oDtRef.Rows
                ...
                For Each x As DataRow In _oDt.Select("FTAssetCode='" & (R!FTAssetCode.ToString) & "'")
                    ...
                    If ST.Lang.Language = ST.Lang.eLang.TH Then
                        _Str = "select L.FNListIndex   FROM [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_SYSTEM) & "].dbo.HSysListData AS L  where L.FTNameTH ='" & x!cFNFixedAssetType.ToString & "'" 'Edit by joker 2017/06/30 from select top 1 To select max
                    Else
                        _Str = "select L.FNListIndex   FROM [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_SYSTEM) & "].dbo.HSysListData AS L  where L.FTNameEN ='" & x!cFNFixedAssetType.ToString & "'"
                    End If
                    ...
                    If _PRState = 0 Then
                        ...
                        _Cmd &= vbCrLf & ",FNNetAmt=" & _NetAmt - _FNDisAmt & ""
                    ...
                    If HI.Conn.SQLConn.Execute_Tran(_Cmd, HI.Conn.SQLConn.Cmd, HI.Conn.SQLConn.Tran) <= 0 Then
                        ...
                        If _PRState = 0 Then
                            ...
                            _Cmd &= vbCrLf & "," & _NetAmt - Double.Parse(x!FNDisAmt.ToString) & " "
    ...
    Private Sub FNHSysCurId_EditValueChanged(sender As Object, e As EventArgs) Handles FNHSysCurId.EditValueChanged
        ...
        Else
            ...
            If Not (_ProcLoad) Then
                ...
                _Qry &= vbCrLf & "   WHERE  (FDDate = " & UL.ULDate.FormatDateDB & ")"
