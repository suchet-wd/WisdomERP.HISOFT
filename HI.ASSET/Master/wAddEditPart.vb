...
#End Region
    ...
    Private Sub ocmedit_Click(sender As Object, e As EventArgs) Handles ocmedit.Click
        ...
        Try
            ...
            If Me.oTab.SelectedTabPage.Name = AssetPart.Name Then
                If VerifyData() Then
                    Qry = "UPDATE [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MASTER) & "].dbo.TASMAssetPart "
                    ...
                    Qry &= vbCrLf & ",FNHSysAssetPartGrpId='" & Me.FNHSysAssetPartGrpId.Properties.Tag & "'"
                    Qry &= vbCrLf & ",FNHSysAssetPartTyped='" & Me.FNHSysAssetPartTyped.Properties.Tag & "'"
                    Qry &= vbCrLf & ",FTAssetPartCode='" & Me.FTAssetPartCode.Text & "'"
                    Qry &= vbCrLf & ",FTProductCode='" & Me.FTProductCode.Text & "'"
                    Qry &= vbCrLf & ",FTAssetPartNameTH='" & Me.FTAssetPartNameTH.Text & "'"
                    Qry &= vbCrLf & ",FTAssetPartNameEN='" & Me.FTAssetPartNameEN.Text & "'"
                    Qry &= vbCrLf & ",FNHSysAssetBrandId='" & Me.FNHSysAssetBrandId.Properties.Tag & "'"
                    Qry &= vbCrLf & ",FNHSysSuplId='" & Me.FNHSysSuplId.Properties.Tag & "'"
                    Qry &= vbCrLf & ",FNPrice=" & Me.FNPrice.Value & ""
                    Qry &= vbCrLf & ",FNMinimumStock=" & Me.FNMinimumStock.Value & ""
                    Qry &= vbCrLf & ",FNMaximumStock=" & Me.FNMaximumStock.Value & ""
                    Qry &= vbCrLf & ",FTRemark='" & Me.FTRemark.Text & "'"
                    Qry &= vbCrLf & " ,FTStateActive='" & _State & "'"
                    Qry &= vbCrLf & " ,FTStateCritical='" & _State1 & "'"
                    Qry &= vbCrLf & ",FNHSysUnitAssetId='" & Me.FNHSysUnitAssetId.Properties.Tag & "'"
                    Qry &= vbCrLf & " ,FTSerialNo='" & FTSerialNo.Text & "'"
                    Qry &= vbCrLf & "WHERE FNHSysAssetPartId=" & Me.MainKeyID & ""
            ...
            Else
                If VerifyDataSpare() Then
                    ...
                    Qry &= vbCrLf & "WHERE FNHSysAssetPartId='" & Me.MainKeyID & "' And FNSeq = '" & Me.FNSeq.Value & "' And FNHSysAssetSparePartId = '" & Me.FNHSysAssetSparePartId.Properties.Tag & "'"""
                    If HI.Conn.SQLConn.Execute_Tran(Qry, HI.Conn.SQLConn.Cmd, HI.Conn.SQLConn.Tran) <= 0 Then
                        HI.Conn.SQLConn.Tran.Rollback()
                        HI.Conn.SQLConn.DisposeSqlTransaction(HI.Conn.SQLConn.Tran)
                        HI.Conn.SQLConn.DisposeSqlConnection(HI.Conn.SQLConn.Cmd)
        ...
        Try
            ...
            If Me.oTab.SelectedTabPage.Name = AssetPart.Name Then
                If VerifyData() Then
                    ...
                    _SystemKey = HI.TL.RunID.GetRunNoID("" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MASTER) & "..TASMAssetPart", "FNHSysAssetPartId", Conn.DB.DataBaseName.DB_MASTER)
                    ...
                    Qry = "INSERT INTO [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MASTER) & "].dbo.TASMAssetPart"
                    Qry &= vbCrLf & "(FTInsUser,FDInsDate,FTInsTime,FNHSysAssetPartId,FNHSysAssetPartGrpId,FNHSysAssetPartTyped,FTAssetPartCode,FTAssetPartNameTH,FTAssetPartNameEN,FNHSysAssetBrandId,FTProductCode,FNHSysSuplId"
                    Qry &= vbCrLf & ",FNPrice,FNMinimumStock,FNMaximumStock,FTStateCritical,FTRemark,FTStateActive,FNHSysUnitAssetId,FTSerialNo)"
                    Qry &= vbCrLf & "SELECT '" & HI.ST.UserInfo.UserName & "'," & HI.UL.ULDate.FormatDateDB & "," & HI.UL.ULDate.FormatTimeDB & ""
                    Qry &= vbCrLf & "," & Val(_SystemKey) & "," & Me.FNHSysAssetPartGrpId.Properties.Tag.ToString & "," & Me.FNHSysAssetPartTyped.Properties.Tag & ",'" & Me.FTAssetPartCode.Text & "','" & Me.FTAssetPartNameTH.Text & "','" & Me.FTAssetPartNameEN.Text & "'"
                    Qry &= vbCrLf & "," & Me.FNHSysAssetBrandId.Properties.Tag & ",'" & Me.FTProductCode.Text & "'," & Me.FNHSysSuplId.Properties.Tag & ""
                    Qry &= vbCrLf & "," & Me.FNPrice.Value & "," & Me.FNMinimumStock.Value & "," & Me.FNMaximumStock.Value & "," & _State1 & ",'" & Me.FTRemark.Text & "'," & _State & "," & FNHSysUnitAssetId.Properties.Tag & ",'" & FTSerialNo.Text & "'  "
                    If HI.Conn.SQLConn.Execute_Tran(Qry, HI.Conn.SQLConn.Cmd, HI.Conn.SQLConn.Tran) > 0 Then
                        If Me.opnDialog.Text <> "" Then
                            Dim br As New BinaryReader(New FileStream(Me.opnDialog.Text, FileMode.Open, FileAccess.Read))
                            ...
                            If Not (_dataBinary Is Nothing) Then
                                ...
                                _cmd &= " WHERE FNHSysAssetPartId=@FNHSysAssetPartId"
                                Dim cmd As New SqlCommand(_cmd, HI.Conn.SQLConn.Cnn, HI.Conn.SQLConn.Tran)
                                cmd.Parameters.AddWithValue("@FNHSysAssetPartId", _SystemKey)
                                Dim _pdf As New SqlParameter("@FPImage", SqlDbType.VarBinary)
                    ...
                    Try
                        Me.FNHSysAssetPartId.Properties.Tag = Integer.Parse(Val(_SystemKey.ToString))
                        QryAfterAdd = "SELECT MAX(FNSeq) AS FNSeq FROM  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MASTER) & "].dbo.TASMAssetPartSparePart AS MO  WITH(NOLOCK)  WHERE  FNHSysAssetPartId=" & _SystemKey & " "
            ...
            Else
                ...
                If VerifyDataSpare() Then
                    ...
                    Qry &= vbCrLf & "SELECT '" & HI.ST.UserInfo.UserName & "'," & HI.UL.ULDate.FormatDateDB & "," & HI.UL.ULDate.FormatTimeDB & ""
                    Qry &= vbCrLf & ",'" & Me.MainKeyID & "','" & Me.FNHSysAssetSparePartId.Properties.Tag & "','" & Me.FNSeq.Value & "','" & Me.FNQuantity.Value & "'"
                    If HI.Conn.SQLConn.Execute_Tran(Qry, HI.Conn.SQLConn.Cmd, HI.Conn.SQLConn.Tran) > 0 Then
                        HI.Conn.SQLConn.Tran.Commit()
                        HI.Conn.SQLConn.DisposeSqlTransaction(HI.Conn.SQLConn.Tran)
                        HI.Conn.SQLConn.DisposeSqlConnection(HI.Conn.SQLConn.Cmd)
                        ...
                        Try
                            QryAfterAdd = "SELECT MAX(FNSeq) AS FNSeq  FROM [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MASTER) & "].dbo.TASMAssetPartSparePart AS MO WITH(NOLOCK) WHERE FNHSysAssetPartId=" & Me.MainKeyID & ""
                            _MaxFNSeq = HI.Conn.SQLConn.GetField(QryAfterAdd, Conn.DB.DataBaseName.DB_MASTER, "0")
                            Me.FNSeq.Value = Integer.Parse(Val(_MaxFNSeq.ToString) + 1)
    ...
    Private Sub ocmclear_Click(sender As Object, e As EventArgs) Handles ocmclear.Click
        If oTab.SelectedTabPage.Name = AssetPart.Name Then
            Me.FTAssetPartCode.Text = "" : Me.FTAssetPartNameTH.Text = "" : Me.FTAssetPartNameEN.Text = "" : Me.FTRemark.Text = "" : Me.opnDialog.Text = "" : Me.FTStateActive.Checked = False
    ...
    Private Sub ocmdelete_Click(sender As Object, e As EventArgs) Handles ocmdelete.Click
        ...
        If Me.oTab.SelectedTabPage.Name = AssetPart.Name Then
            ...
            If HI.MG.ShowMsg.mConfirmProcess(HI.MG.ShowMsg.ProcessType.mDelete, Me.FTAssetPartCode.Text, Me.Text) = True Then
                ...
                _Str = " Delete From " & Me.TableName & " " & "  WHERE  FTAssetPartCode ='" & Me.FTAssetPartCode.Text & "' "
                _Str &= vbCrLf & "Delete from [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MASTER) & "].dbo.TASMAssetPartSparePart WHERE FNHSysAssetPartId=" & Me.MainKeyID & ""
        ...
        Else
            ...
            If HI.MG.ShowMsg.mConfirmProcess(HI.MG.ShowMsg.ProcessType.mDelete, Me.FTAssetPartCode.Text, Me.Text) = True Then
                ...
                _Str &= vbCrLf & "WHERE FNHSysAssetPartId=" & Me.MainKeyID & " AND FNSeq=" & FNSeq.Value & " AND FNHSysAssetSparePartId=" & FNHSysAssetSparePartId.Properties.Tag & ""
                If Not (HI.Conn.SQLConn.ExecuteNonQuery(_Str, _DBEnum)) Then
                    HI.MG.ShowMsg.mProcessNotComplete(MG.ShowMsg.ProcessType.mDelete, Me.Text)
                Else
                    HI.MG.ShowMsg.mProcessComplete(MG.ShowMsg.ProcessType.mDelete, Me.Text)
                    ...
                    _Str &= vbCrLf & "SET FNSeq=FNSeq-1 WHER E FNHSysAssetPartId=" & Me.MainKeyID & "AND FNSeq>" & Me.FNSeq.Value & ""
    ...
    Private Function VerifyData() As Boolean
        ...
        If Me.FTAssetPartCode.Text.Trim <> "" Then
            If Me.FTAssetPartNameTH.Text.Trim <> "" Then
                If Me.FTAssetPartNameEN.Text.Trim() <> "" Then
                    If Me.FTProductCode.Text.Trim <> "" Then
                        If Me.FNHSysAssetPartGrpId.Text.Trim <> "" Then
                            If Me.FNHSysAssetPartTyped.Text.Trim <> "" Then
                                If Me.FNHSysAssetBrandId.Text.Trim <> "" Then
                                    If Me.FNHSysSuplId.Text.Trim <> "" Then
                                        ' If Me.opnDialog.Text <> "" Then
                                    ...
                                    End If
                                    Else
                                        HI.MG.ShowMsg.mInvalidData(MG.ShowMsg.InvalidType.InputData, Me.Text, FNHSysAssetBrandId_lbl.Text)
                                        Me.FNHSysAssetBrandId.Focus()
                                    End If
                            Else
                                HI.MG.ShowMsg.mInvalidData(MG.ShowMsg.InvalidType.InputData, Me.Text, FNHSysAssetPartTyped_lbl.Text)
                                Me.FNHSysAssetPartTyped.Focus()
                            End If
                        Else
                            HI.MG.ShowMsg.mInvalidData(MG.ShowMsg.InvalidType.InputData, Me.Text, FNHSysAssetPartGrpId_lbl.Text)
                            Me.FNHSysAssetPartGrpId.Focus()
                        End If
                    Else
                        HI.MG.ShowMsg.mInvalidData(MG.ShowMsg.InvalidType.InputData, Me.Text, FTProductCode_lbl.Text)
                        Me.FTProductCode.Focus()
                    End If
                Else
                    HI.MG.ShowMsg.mInvalidData(MG.ShowMsg.InvalidType.InputData, Me.Text, FTAssetPartNameEN_lbl.Text)
                    Me.FTAssetPartNameEN.Focus()
                End If
            Else
                HI.MG.ShowMsg.mInvalidData(MG.ShowMsg.InvalidType.InputData, Me.Text, FTAssetPartNameTH_lbl.Text)
                Me.FTAssetPartNameTH.Focus()
            End If
        Else
            HI.MG.ShowMsg.mInvalidData(MG.ShowMsg.InvalidType.InputData, Me.Text, FTAssetPartCode_lbl.Text)
            Me.FTAssetPartCode.Focus()
        End If
        Return _Pass
    End Function
    ...
    Private Function CheckNotUsed(ByVal Key As String) As Boolean
        ...
        Return True
    End Function
    Private Sub ButtonEdit1_Properties_Click(sender As Object, e As EventArgs) Handles opnDialog.Properties.Click
    ...
    Private Sub LodaGridPartDetail()
        ...
        Qry &= vbCrLf & " WHERE MP.FNHSysAssetPartId=" & Me.MainKeyID & " order by FNSeq asc"
    ...
    Private Sub oTab_SelectedPageChanged(sender As Object, e As DevExpress.XtraTab.TabPageChangedEventArgs) Handles oTab.SelectedPageChanged
        ...
        End Try
    End Sub
    Private Sub ogvSpare_DoubleClick(sender As Object, e As EventArgs) Handles ogvSpare.DoubleClick
    ...
    Private Sub wAddEditPart_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        FNSeq.Value = 1
