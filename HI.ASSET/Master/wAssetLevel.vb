...
Public Class wAssetLevel
    ...
    Private objForm As wAddItemAssetLevel
    ...
    Sub New()
        ...
        objForm = New wAddItemAssetLevel(FormName, Me.Text, Me.FormObjID, HI.ST.SysInfo.PathFileDLL, "", Me)
...
#Region "Proc"
    ...
    Public Sub LoadData()
        ...
        Try
            _Str = "Select  M.FNHSysConfigLevelId,L.FTNameTH,M.FTUserName,ISNULL(Convert(numeric(18,2),M.FNEndQty),0) as FNEndQty,ISNULL(Convert(numeric(18,2),M.FNStartQty),0) as FNStartQty,C.FTCmpCode as FNHSysCmpId,M.FTStateDirector,M.FTStateFactory"
            ...
            End If
            _Str &= vbCrLf & "FROM [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MASTER) & "].dbo.TASMAssetConfigLevel AS M WITH(NOLOCK) "
            ...
            _Str &= vbCrLf & " order by L.FTNameTH ,M.FNEndQty,M.FNStartQty "
...
#End Region
    ...
    Private Sub ocmedit_Click(sender As Object, e As EventArgs) Handles ocmedit.Click
        ...
        With ogvdetail
            ...
            Dim _Key As Integer = .GetRowCellValue(.FocusedRowHandle, "FNHSysConfigLevelId").ToString.Trim
            ...
            With objForm
                ...
                Try
                    Qry = "Select  Top 1 (D.FTNameTH )as FNFixedAssetType,UC.FTUserName,UC.FNEndQty,UC.FNHSysConfigLevelId,UC.FNStartQty,C.FTCmpCode as FNHSysCmpId,D.FNListIndex,UC.FTStateDirector,UC.FTStateFactory"
                    Qry &= vbCrLf & "From [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MASTER) & "].dbo.TASMAssetConfigLevel AS UC WITH(NOLOCK) "
                    ...
                    Qry &= vbCrLf & "Where UC.FNHSysConfigLevelId ='" & _Key & "'"
                    dt = HI.Conn.SQLConn.GetDataTable(Qry, Conn.DB.DataBaseName.DB_MASTER)



                    For Each R As DataRow In dt.Rows
                        If R!FTStateDirector.ToString = "1" Then
                            .FTStateDirector.Checked = True
                        Else
                            .FTStateDirector.Checked = False
                        End If
                        If R!FTStateFactory.ToString = "1" Then
                            .FTStateFactory.Checked = True
                        Else
                            .FTStateFactory.Checked = False
                        End If
                        '.FNFixedAssetType.Text = R!FNFixedAssetType
                        .FNFixedAssetType.SelectedIndex = R!FNListIndex
                        '.FNFixedAssetType.Properties.Tag = R!FNFixedAssetType
                        .FTUserName.Text = R!FTUserName
                        .FNEndQty.Value = R!FNEndQty
                        .FNStartQty.Value = R!FNStartQty
                        .FNHSysCmpId.Text = R!FNHSysCmpId
                        .MainKeyID = Val(R!FNHSysConfigLevelId)
