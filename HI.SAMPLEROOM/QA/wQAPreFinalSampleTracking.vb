...
Public Class wQAPreFinalSampleTracking
...
#Region "Procedure"
    Private Sub LoadData()
        ...
        Try
            _Qry = "Exec [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_SAMPLE) & "].dbo.SP_GET_QAPreFinal_SAMPLEROOM_Tracking  " & HI.ST.SysInfo.CmpID & ",'" & HI.UL.ULDate.ConvertEnDB(Me.FTStartDate.Text) & "','" & HI.UL.ULDate.ConvertEnDB(Me.FTEndDate.Text) & "' "
