...
Public Class wPIDescription
    ...
    Private objForm As wAddEditPIDes
    ...
    Sub New()
        ...
        objForm = New wAddEditPIDes(FormName, Me.Text, Me.FormObjID, HI.ST.SysInfo.PathFileDLL, "", Me)
...
#End Region
            ...
            With ogvdetail
                ...
                If HI.MG.ShowMsg.mConfirmProcess(HI.MG.ShowMsg.ProcessType.mDelete, .GetRowCellValue(.FocusedRowHandle, Me.RequireField).ToString.Trim) = True Then
                    ...
                    Try
                        ...
                        _Str &= vbCrLf & "Delete from [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MASTER) & "].dbo.TINVENMMaterial_PIDescription WHERE FNHSysDescRawMatId=" & _Key & ""
    ...
    Private Sub ocmedit_Click(sender As Object, e As EventArgs) Handles ocmedit.Click
        ...
        'Dim _Pdf As New DevExpress.XtraGrid.GridControl
        ...
        With ogvdetail
            ...
            Dim _Key As String = "" & .GetRowCellValue(.FocusedRowHandle, Me.MainKey).ToString.Trim
            ' Dim _Key As String = "" & .GetRowCellValue(.FocusedRowHandle, "FNHSysFixedAssetId").ToString.Trim
            ...
            With objForm
                ...
                Try
                    Qry = "SELECT top 1 * FROM [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MASTER) & "].dbo.TINVENMMaterial_PIDescription WHERE FNHSysMainMatId='" & _Key & "'"
                    ...
                    For Each R As DataRow In dt.Rows
                        ...
                        'End If
                        .MainKeyID = Val(R!FNHSysDescRawMatId.ToString)
                        .MainKey = Me.RequireField
                        .TableName = Me.TableName
                        .FNHSysMainMatId.Text = R!FNHSysMainMatId.ToString
                        .FTMainMatNameTH.Text = R!FTMainMatNameTH.ToString
                        .FTMainMatNameEN.Text = R!FTMainMatNameEN.ToString
