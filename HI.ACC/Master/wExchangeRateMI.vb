Public Class wExchangeRateMI

    Private _AddItem As wExchangeRateMIAddItem
    Sub New()
        ...
        _AddItem = New wExchangeRateMIAddItem
    ...
    Public Sub Loadata()
        ...
        _Qry &= vbCrLf & " FROM   [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_ACCOUNT) & "].dbo.TACCTExchangeRateMI AS M INNER JOIN"
        ...
        Try
            ...
            With ogvdetail
                ...
                If HI.MG.ShowMsg.mConfirmProcess(HI.MG.ShowMsg.ProcessType.mDelete, FTCurCode & "  Date : " & FDDate) = True Then
                    ...
                    Dim _Qry As String
                    _Qry = " Delete From   [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_ACCOUNT) & "].dbo.TACCTExchangeRateMI "
