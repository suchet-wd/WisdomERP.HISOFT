Public Class wExchangeRateMIAddItem
    ...
    Private Sub ocmadd_Click(sender As Object, e As EventArgs) Handles ocmadd.Click
        ...
        If ValidateData() Then
            ...
            While _SDate <= _EDate
                ...
                _Qry &= vbCrLf & "  FROM  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_ACCOUNT) & "].dbo.TACCTExchangeRateMI AS A WITH(NOLOCK)"
                ...
                If HI.Conn.SQLConn.GetField(_Qry, Conn.DB.DataBaseName.DB_ACCOUNT, "") = "" Then
                    _Qry = "  INSERT INTO  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_ACCOUNT) & "].dbo.TACCTExchangeRateMI "
                ...
                Else
                    _Qry = "  UPDATE  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_ACCOUNT) & "].dbo.TACCTExchangeRateMI "
