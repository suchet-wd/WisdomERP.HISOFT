...
Public Class wCMInvoiceExportTracking
...
#Region "MAIN PROC"
    ...
    Private Sub RefreshGrid()
        ...
        Try
            ...
            Try
                Call LoadListingDataInfo(FNHSysCmpId.Properties.Tag.ToString, FNHSysPOID.Text.Trim, FNHSysStyleId.Properties.Tag.ToString, FNHSysCustId.Properties.Tag.ToString, FNHSysBuyId.Properties.Tag.ToString, FNHSysSeasonId.Properties.Tag.ToString)
            Catch ex As Exception
            End Try
