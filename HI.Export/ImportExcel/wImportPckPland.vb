...
#Region "Procedure"
    ...
    Private Function _SaveData(_Tab As DevExpress.XtraTab.XtraTabPage) As Boolean
        Try
            ...
            Dim _PKeyvalues As String = "" : Dim _FKeyvalues As String = "" : Dim _FKey2values As String = ""
            Dim _Value As String = "" : Dim _ValueUpd As String = ""
            Dim _Collaction As String = ""
            Dim _StrFileH As String = "FTPckPlanNo|FTPORef|FNQuantity|FNPackcount|FNNet|FNTotalNet|FNGrossWeight|FNHSysUnitId|FNVol|FTVolUnit|FDShipDate|FNHSysProvinceId|FNHSysMainMatSpecId|FTPORefNo|FTDiamondMarkCode|FTPORefNo2|FTCustPORef"

            _CmdIns = "Insert into   [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_ACCOUNT) & "].dbo.TEXPTPackPlan  "
            _CmdIns &= "( FTInsUser, FDInsDate, FTInsTime,FTPckPlanNo, FTPORef, FNQuantity, FNPackcount, FNNet, FNTotalNet, FNGrossWeight, FNHSysUnitId, FNVol, FTVolUnit,FDShipDate,FNHSysProvinceId,FNHSysMainMatSpecId,FTPORefNo,FTDiamondMarkCode ,FTPORefNo2 ,FTCustPORef)"
            ...
            Dim _DFKey5 As String = "FTSizeBreakDown" : Dim _DFKey6 As String = "FTPOLineNo"
                    ...
                    For Each R As DataRow In _oDt.Rows
                        ...
                        For Each _Str As String In _StrFileH.Split("|")
                            ...
                            Else
                                ...
                                ElseIf _Str.ToString = "FTProvinceName" Then
                            ...
                            If _PKey = _Str Then
                                ...
                                If R.Item(_Str.ToString) = "Totals" Then
                                    GoTo 1
                                End If
                                _PKeyvalues = R.Item(_Str.ToString)
                            ...
                            Else
                                ...
                                If _Str.ToString = "FNHSysProvinceId" Then
                                    ...
                                    If R.Item("FTProvinceName").ToString <> "" Then
                                        _StrProvince = "Update   [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MASTER) & "].dbo.TCMMProvince  "
                                        'If HI.ST.Lang.Language = ST.Lang.eLang.TH Then
                                        _StrProvince &= vbCrLf & " Set FTProvinceNameTH='" & HI.UL.ULF.rpQuoted(R.Item("FTProvinceName").ToString) & "'"
                                        'Else
                                        _StrProvince &= vbCrLf & " , FTProvinceNameEN='" & HI.UL.ULF.rpQuoted(R.Item("FTProvinceName").ToString) & "'"
                                        'End If
                                        _StrProvince &= vbCrLf & " where  FNHSysProvinceId=" & Integer.Parse("0" & R.Item(_Str.ToString & "_Hide"))
                                        If HI.Conn.SQLConn.Execute_Tran(_StrProvince, HI.Conn.SQLConn.Cmd, HI.Conn.SQLConn.Tran) <= 0 Then
                                        End If
                                    End If
...
1:
                With DirectCast(DirectCast((_Tab.Controls.Find("ogcPlandD" & _Tab.Text, True)(0)), DevExpress.XtraGrid.GridControl).DataSource, System.Data.DataTable)
                    ...
                    For Each R As DataRow In _oDt.Rows
                        ...
                        For Each _Str As String In _DStrFileD.Split("|")
                            ...
                            ElseIf _DFKey5 = _Str Then
                                _Where &= vbCrLf & "  AND " & _DFKey5 & " = '" & R.Item(_Str.ToString) & "'"
                            ElseIf _DFKey6 = _Str Then
                                _Where &= vbCrLf & "  AND " & _DFKey6 & " = '" & R.Item(_Str.ToString) & "'"
                            Else
                                If _ValueUpd <> "" Then _ValueUpd &= ","
                                _ValueUpd &= _Str & " ='" & R.Item(_Str.ToString) & "'"
                            End If
            ...
            _Cmd = "update A"
            _Cmd &= vbCrLf & " set A.FTNikePOLineItem = T.FTNikePOLineItem"
            _Cmd &= vbCrLf & " FRom  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_ACCOUNT) & "].dbo.TEXPTPackPlan AS A "
            _Cmd &= vbCrLf & " LEFT OUTER JOIN "
            _Cmd &= vbCrLf & " ( Select  FTPckPlanNo, FTPORef, FTPORefNo "
            _Cmd &= vbCrLf & "  ,      (SELECT TOP 1 STUFF    ((SELECT ', ' + t2.FTPOLineNo "
            _Cmd &= vbCrLf & "       FROM      (SELECT FTPckPlanNo, FTPORef, FTPORefNo, convert(nvarchar(50), convert(int ,  FTPOLineNo)) as FTPOLineNo "
            _Cmd &= vbCrLf & "       FROM      TEXPTPackPlan_D AS Z with(nolock)"
            _Cmd &= vbCrLf & "       GROUP BY FTPckPlanNo, FTPORef, FTPORefNo,FTPOLineNo) t2"
            _Cmd &= vbCrLf & "  WHERE   t2.FTPckPlanNo = V.FTPckPlanNo AND t2.FTPORef = V.FTPORef AND t2.FTPORefNo = V.FTPORefNo FOR XML PATH('')), 1, 2, '') AS FTOrderNo) AS FTNikePOLineItem "
            _Cmd &= vbCrLf & " From TEXPTPackPlan_D  as V"
            _Cmd &= vbCrLf & " group by FTPckPlanNo, FTPORef, FTPORefNo"
            _Cmd &= vbCrLf & " ) AS T ON A.FTPckPlanNo = T.FTPckPlanNo"
            _Cmd &= vbCrLf & "and A.FTPORef = T.FTPORef "
            _Cmd &= vbCrLf & " and A.FTPORefNo = T.FTPORefNo"
            _Cmd &= vbCrLf & " where A.FTPckPlanNo='" & _PKeyvalues & "'"
            _Cmd &= vbCrLf & " and A.FTPORef ='" & _FKeyvalues & "'"
            _Cmd &= vbCrLf & " and A.FTPORefNo ='" & _FKey2values & "'"
            _Cmd &= vbCrLf & " "
    ...
    Private Function DeleteData(_Tab As DevExpress.XtraTab.XtraTabPage) As Boolean
        Try
            ...
            With DirectCast(DirectCast((_Tab.Controls.Find("ogcPlandM" & _Tab.Text, True)(0)), DevExpress.XtraGrid.GridControl).DataSource, System.Data.DataTable)
                For Each R As DataRow In .Rows
                    ...
                    If Not (ChkUsePORefNo(R!FTPORefNo.ToString)) Then
                        HI.Conn.SQLConn.Tran.Rollback()
                        HI.Conn.SQLConn.DisposeSqlTransaction(HI.Conn.SQLConn.Tran)
                        HI.Conn.SQLConn.DisposeSqlConnection(HI.Conn.SQLConn.Cmd)
                        Return False
                    ...
                    _Str = "Delete From  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_ACCOUNT) & "].dbo.TEXPTPackPlan WHERE FTPORefNo='" & HI.UL.ULF.rpQuoted(R!FTPORefNo.ToString) & "'"
                    ...
                    _Str = "Delete From  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_ACCOUNT) & "].dbo.TEXPTPackPlan_D WHERE FTPORefNo='" & HI.UL.ULF.rpQuoted(R!FTPORefNo.ToString) & "'"
                    If HI.Conn.SQLConn.Execute_Tran(_Str, HI.Conn.SQLConn.Cmd, HI.Conn.SQLConn.Tran) <= 0 Then
...
#Region "MAIN PROC"
    ...
    Private Function GenBarcodeEN13(_Tab As DevExpress.XtraTab.XtraTabPage) As Boolean
        Try
            ...
            Dim _oDt As System.Data.DataTable : Dim _dtN As System.Data.DataTable
            With DirectCast(DirectCast((_Tab.Controls.Find("ogcPlandM" & _Tab.Text, True)(0)), DevExpress.XtraGrid.GridControl).DataSource, System.Data.DataTable)
                _dtN = .Copy
            End With
            Dim _PORefNo As String = ""
            _PORefNo = _dtN.Rows(0)!FTPORefNo.ToString



            _Cmd = "SELECT  D.FTPONo ,  C.FTColorway, C.FTSizeBreakDown, C.FTOrderNo, C.FTPackNo,  C.FTPOLine  , C.FTSubOrderNo, PK.FTCustomerPO, C.FNCartonNo, D.FTSerialFrom , D.FTSerialTo  , D.FNFrom , D.FNTo ,C.FNQuantity"
            ...
            '_Cmd &= vbCrLf & " left outer join    [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "]..TPACKOrderPack_Carton_Barcode bb on c.FTPackNo = bb.FTPackNo  and c.FNCartonNo = bb.FNCartonNo "
            _Cmd &= vbCrLf & "WHERE  (PK.FTCustomerPO = N'" & _Tab.Text & "') ---and isnull( bb.FTBarCodeEAN13,'') = ''  " 'ISNULL(T.FTState,'0') = '0' and 
            _Cmd &= vbCrLf & " and D.FTPORefNo  = '" & _PORefNo & "'"
            _oDt = HI.Conn.SQLConn.GetDataTable(_Cmd, Conn.DB.DataBaseName.DB_ACCOUNT)




            _Cmd = " SELECT  top 1   V.FTPlantCode "
            ...
            _Cmd &= vbCrLf & "   LEFT OUTER JOIN [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MASTER) & "].dbo.TCMMProvince AS N with(nolock) oN  P.FNHSysProvinceId = N.FNHSysProvinceId "
            _Cmd &= vbCrLf & " where   P.FTPORef='" & HI.UL.ULF.rpQuoted(_Tab.Text) & "'"

            Dim _PlanNo As String = HI.Conn.SQLConn.GetField(_Cmd, Conn.DB.DataBaseName.DB_FG, "")

            For Each R As DataRow In _oDt.Rows
                _EN13 = HI.UL.ULF.rpQuoted(GenerateBarcodeSSCC(R!FNCartonSeq.ToString, R!FNCartonSeq.ToString, R!FNCartonNo.ToString, _PlanNo, R!FTPONo.ToString()))
                ...
                If HI.Conn.SQLConn.GetDataTable(_Cmd, Conn.DB.DataBaseName.DB_ACCOUNT).Rows.Count <= 0 Then
                    ...
                    End If
                End If
                '_Cmd = "exec  dbo.sp_updatebarcodeucc '" & R!FTPackNo.ToString & "'"
                'HI.Conn.SQLConn.ExecuteOnly(_Cmd, Conn.DB.DataBaseName.DB_PROD)

            Next


            Dim names = From row In _oDt.AsEnumerable()
                        Select row.Field(Of String)("FTPackNo") Distinct
            For Each s As String In names.ToList()
                Dim x As String = s
                If x <> "" Then
                    _Cmd = "exec  dbo.sp_updatebarcodeucc '" & x & "'"
                    HI.Conn.SQLConn.ExecuteOnly(_Cmd, Conn.DB.DataBaseName.DB_PROD)
                End If
            Next
    ...
    Private Function GenerateBarcodeSSCC(_SBarcodeNo As Integer, _EBarcodeNo As Integer, _BeginCarton As Integer, _PlanNo As String, _Prefix As String) As String
        Try
            ...
            'Select Case _PlanNo
            '    Case "1060", "1064", "1065"
            '        _FacNo = Replace(_FacNo, "000885", "009885")

            'End Select
            If _Prefix <> "" Then
                _FacNo = Replace(_FacNo, "000885", "00" & Str(_Prefix) & "885")
            End If
    ...
    Private Function ChkUsePORefNo(PORef As String) As Boolean
        Try
            Dim _Cmd As String = ""
            _Cmd = "SELECT TOP (1)   FTPORefNo  "
            _Cmd &= vbCrLf & "From  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_ACCOUNT) & "]..TEXPTCMBookigInvoice_D WITH(NOLOCK) "
            _Cmd &= vbCrLf & "WHERE  (FTPORefNo = N'" & HI.UL.ULF.rpQuoted(PORef) & "') "

            If HI.Conn.SQLConn.GetDataTable(_Cmd, Conn.DB.DataBaseName.DB_ACCOUNT).Rows.Count = 1 Then
                HI.MG.ShowMsg.mProcessError(1812180938, "คุณไม่สามารถทำการลบเอกสารนี้ได้ เนื่องจากมีการนำไปใช้แล้ว กรุณาตรวจสอบ.. ", Me.Text, System.Windows.Forms.MessageBoxIcon.Warning)
                Return False
            Else
    ...
    Private Sub Proc_Delete(sender As System.Object, e As System.EventArgs) Handles ocmdelete.Click
        Dim state As Boolean = False
        If HI.MG.ShowMsg.mConfirmProcess(MG.ShowMsg.ProcessType.mDelete, "ต้องการลบทั้งหมด หรือ เฉพาะแทป กรุณากดปุ่ม  Yes ทั้งหมด  , No เฉพาะแทป ") = True Then
            For Each xtab As DevExpress.XtraTab.XtraTabPage In Me.oTabPlanGen.TabPages
                If xtab.Name <> "oTabmasterInden" And xtab.Name <> "oTabmaster" Then
                    If Me.DeleteData(xtab) Then
                        ' HI.MG.ShowMsg.mProcessComplete(MG.ShowMsg.ProcessType.mSave, Me.Text)
                        state = True
                    Else
            ...
            Next
        Else
            If Me.DeleteData(Me.oTabPlanGen.SelectedTabPage) Then
...
#End Region
    ...
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        HI.TL.HandlerControl.AddHandlerGridColumnEdit(ogvPlandM)
        _FormLoad = False
    End Sub
    ...
    Private Function GetDescription(_PORef As String, _POline As String) As System.Data.DataTable
        Try
            ...
            _Cmd &= vbCrLf & " ,  V.FTProvinceCode  , PP.FTPlantCode ,V.FTProvinceNameEN AS FTProvinceName  " ', isnull( O.FTStateOrderApp,'') as FTStateOrderApp
            ...
            _Cmd &= vbCrLf & " and SB.FTNikePOLineItem = '" & HI.UL.ULF.rpQuoted(Integer.Parse("0" & _POline)) & "'"
    ...
    Private Function GetDescription_Drivert(_PORef As String, _POline As String) As System.Data.DataTable
        Try
            Dim _Cmd As String = ""
            _Cmd = "  Select distinct case when ISNULL(S.FTPORef,'') = '' then O.FTPORef else S.FTPORef end as FTPORef ,   convert(varchar(10), convert(date, s.FDShipDate),103) as FDShipDate  , S.FNHSysProvinceId ,  O.FNHSysStyleId , O.FNHSysSeasonId  ,isnull(P.FTMainMatSpecEN , '') as FTMainMatSpec , isnull(  P.FNHSysMainMatSpecId ,0 )  as FNHSysMainMatSpecId  "
            _Cmd &= vbCrLf & " ,  V.FTProvinceCode  , PP.FTPlantCode ,V.FTProvinceNameEN AS FTProvinceName"
            _Cmd &= vbCrLf & "From [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MERCHAN) & "].dbo.TMERTOrder AS O WITH(NOLOCK)  "
            _Cmd &= vbCrLf & " LEFT OUTER JOIN  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MERCHAN) & "].dbo.TMERTOrderSub_Divert AS S WITH(NOLOCK)  ON O.FTOrderNo = S.FTOrderNo "
            _Cmd &= vbCrLf & " LEFT OUTER JOIN  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MERCHAN) & "].dbo.TMERTOrderSub_Divert_BreakDown AS SB WITH(NOLOCK)  ON O.FTOrderNo = SB.FTOrderNo and S.FTSubOrderNo = SB.FTSubOrderNo "
            _Cmd &= vbCrLf & " LEFT OUTER JOIN  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MASTER) & "].dbo.TMERMMainMatSpec AS P WITH(NOLOCK) ON O.FNHSysStyleId  = P.FNHSysStyleId and  O.FNHSysSeasonId = P.FNHSysSeasonId  "
            _Cmd &= vbCrLf & "  LEFT OUTER JOIN [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MASTER) & "].dbo.TCMMProvince AS V WITH(NOLOCK)  ON  S.FNHSysProvinceId  = V.FNHSysProvinceId"
            _Cmd &= vbCrLf & "  LEFT OUTER JOIN [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MASTER) & "].dbo.TMERMPlant AS PP WITH(NOLOCK) ON S.FNHSysPlantId = PP.FNHSysPlantId"
            _Cmd &= vbCrLf & " where  case when ISNULL(S.FTPORef,'') = '' then O.FTPORef else S.FTPORef end = '" & HI.UL.ULF.rpQuoted(_PORef) & "'   "
            _Cmd &= vbCrLf & " and   (ISNULL(O.FTStateOrderApp, N'0') = '1')"
            '   _Cmd &= vbCrLf & " and SB.FTNikePOLineItem = '" & HI.UL.ULF.rpQuoted(Integer.Parse("0" & _POline)) & "'"
            Return HI.Conn.SQLConn.GetDataTable(_Cmd, Conn.DB.DataBaseName.DB_ACCOUNT)
        Catch ex As Exception
            Return Nothing
    ...
    Private Function ChangeTypeFile(_Path As String) As Boolean
        Try
            Dim _FileOrg As String = ""
            Dim _Result As String = ""
            Dim _d As DirectoryInfo = New DirectoryInfo(_Path)
            For Each f As FileInfo In _d.GetFiles("*.xls")
                _Result = Path.ChangeExtension(f.FullName, ".xlsx")
                System.IO.File.Copy(f.FullName, _Result, True)
    ...
    Private Function MoveFileSuccess(_Path As String) As Boolean
        Try
            Dim _PathDestinations As String = "D:\FileExcelFromMercury\ImportSuccess\"
            If Not (Directory.Exists(_PathDestinations)) Then
                My.Computer.FileSystem.CreateDirectory(_PathDestinations)
            End If


            Dim _d As DirectoryInfo = New DirectoryInfo(_Path)
            'For Each f As FileInfo In _d.GetFiles("*.xlsx")
            Dim sourceFile = _Path
            Dim destFile = System.IO.Path.Combine(_PathDestinations, _d.Name)
    ...
    Private Sub ReadXlsfile_Multiple(_fileName As String, ByVal _Spls As HI.TL.SplashScreen)
        Try
            ...
            Dim _CustPORef As String = ""
            Dim _DiamondmarkCode As String = ""
            Try
                _DiamondmarkCode = _oDtIn.Rows(11).Item(26).ToString
            Catch ex As Exception
                _DiamondmarkCode = ""
            End Try
            Try
                If _DiamondmarkCode = "" Then
            ...
            End Try
            Try
                _CustPORef = _oDtIn.Rows(12).Item(11).ToString
            Catch ex As Exception
                _CustPORef = ""
            End Try
            ...
            If Not (_oDt Is Nothing) Then
                ...
                With _dt
                    ...
                    .Columns.Add("FTPORefNo2", GetType(String))
                    .Columns.Add("FTCustPORef", GetType(String))
                    .Columns.Add("FNHSysShipModeId", GetType(String))
                    .Columns.Add("FNHSysShipModeId_Hide", GetType(Integer))

                    '.Columns.Add("FTStateOrderApp", GetType(String))
                End With
                ...
                For Each R As DataRow In _oDt.Rows
                    If _oDt.Rows(5).Item(0 + _RecodeCheck).ToString = "PO SUMMARY" And (IsNumeric(R.Item(1 + _RecodeCheck).ToString) Or R.Item(1 + _RecodeCheck).ToString = "Totals") And IsNumeric(R.Item(3 + _RecodeCheck).ToString) Then
                        ...
                        End If
                        If _dtt.Rows.Count <= 0 Then
                            _dtt = GetDescription_Drivert(_POrefNo, _POLineNo)
                        End If
                        ...
                        _dr("FTCustPORef") = _CustPORef
                        Try
                            _dr("FTProvinceName") = _dtt.Rows(0).Item("FTProvinceName").ToString
                        ...
                        Catch ex As Exception
                            ...
                            _dr("FTMainMatSpec") = ""
                            _dr("FDShipDate") = ""
                            _dr("FNHSysProvinceId") = ""
                            _dr("FNHSysMainMatSpecId") = "0"
                            _dr("FNHSysProvinceId_Hide") = "0"

                        End Try

                        _dr("FTPORefNo2") = ""
                        '_dr("FTStateOrderApp") = _dtt.Rows(0).Item("FTStateOrderApp").ToString
                        _dr("FNHSysShipModeId") = ""
                        _dr("FNHSysShipModeId_Hide") = "0"
                        _dt.Rows.Add(_dr)
                ...
                For Each R As DataRow In _oDt.Rows
                    ...
                    If _oDt.Rows(12).Item(0 + _RecodeCheck).ToString = "PACKAGE DETAIL" Then
                        ...
                        If R.Item(12 + _RecodeCheck).ToString <> "" And R.Item(3 + _RecodeCheck).ToString = "" And R.Item(4 + _RecodeCheck).ToString = "" And R.Item(5 + _RecodeCheck).ToString = "" And R.Item(7 + _RecodeCheck).ToString = "" And R.Item(9 + _RecodeCheck).ToString = "" And _DPckPlandNo <> "" And _DRangeNo <> "" Then
                            ...
                            _dr("FTSizeBreakDown") = MapSize(R.Item(20 + _RecodeCheck).ToString)
                        ...
                        ElseIf IsNumeric(R.Item(3 + _RecodeCheck).ToString) And IsNumeric(R.Item(4 + _RecodeCheck).ToString) And IsNumeric(R.Item(5 + _RecodeCheck).ToString) And R.Item(1 + _RecodeCheck).ToString = "" Then
                            ...
                            _dr("FNFrom") = Microsoft.VisualBasic.Replace(R.Item(4 + _RecodeCheck).ToString, ",", "")
                            _DFromNo = Microsoft.VisualBasic.Replace(R.Item(4 + _RecodeCheck).ToString, ",", "")

                            _dr("FNTo") = Microsoft.VisualBasic.Replace(R.Item(5 + _RecodeCheck).ToString, ",", "")
                            _DToNo = Microsoft.VisualBasic.Replace(R.Item(5 + _RecodeCheck).ToString, ",", "")
                            ...
                            _dr("FNPackCount") = Microsoft.VisualBasic.Replace(R.Item(26 + _RecodeCheck).ToString, ",", "")
                ...
                Dim _ship As String = "" : Dim _ShipCode As String = ""
                Dim _ShipID As Integer = 0
                For Each R As DataRow In _dtd.Rows
                    _ship = ((R!FTShipmentMethod))
                    Select Case _ship.ToUpper
                        Case "Air".ToUpper
                            _ShipID = 1405060002
                        Case "Truck".ToUpper
                            _ShipID = 1406250001
                ...
                Next
                Dim _Cmd As String = ""
                _Cmd = "Select TOP 1  FTShipModeCode  From [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MASTER) & "].dbo.TCNMShipMode WITH(NOLOCK) "
                _Cmd &= vbCrLf & " Where FNHSysShipModeId=" & _ShipID
                _ShipCode = HI.Conn.SQLConn.GetField(_Cmd, Conn.DB.DataBaseName.DB_MASTER, "")

                For Each R As DataRow In _dt.Rows
                    R!FNHSysShipModeId = _ShipCode
                    R!FNHSysShipModeId_Hide = _ShipID
                    Exit For
                Next
                If _dt IsNot Nothing Then
                    _GridDM.DataSource = _dt
    ...
    Private Function MapSize(size As String) As String
        Try
            Dim _Cmd As String = ""
            _Cmd = "SELECT  Top 1 FTMapSizeExtension "
            _Cmd &= vbCrLf & " From [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MERCHAN) & "]..TMERMMapSize   WITH(NOLOCK)"
            _Cmd &= vbCrLf & " where FTMapSize='" & size & "'"
            Dim value As String = HI.Conn.SQLConn.GetField(_Cmd, Conn.DB.DataBaseName.DB_MASTER, "")
            If value = "" Then
                Return size
            Else
                Return value
    ...
    Private Function ApproveData(_Tab As DevExpress.XtraTab.XtraTabPage, Optional ByVal _state As Boolean = True) As Boolean
        Try
            ...
            End If
            Dim _GControl As DevExpress.XtraGrid.GridControl
            Dim _PORefNo As String = ""
            _GControl = DirectCast(_Tab.Controls.Find("ogcPlandM" & _Tab.Text, True)(0), DevExpress.XtraGrid.GridControl)

            For Each R As DataRow In DirectCast(_GControl.DataSource, System.Data.DataTable).Rows
            ...
            '_Cmd = "  select top 1  "
            '_Cmd &= vbCrLf & " isnull(FDShipDate,'') as  FDShipDate "
            '_Cmd &= vbCrLf & " , Isnull(FTPlantCode,'') AS FTPlantCode "
            '_Cmd &= vbCrLf & "  From   [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_ACCOUNT) & "].dbo.TEXPTPackPlan  WITH(NOLOCK) "
            ...
            '    If R!FDShipDate.ToString = "" And R!FTPlantCode.ToString = "" Then
            '        HI.MG.ShowMsg.mInfo("ข้อมูลโรงงานลูกค้า และ วันที่ที่ส่งมอบ ไม่สมบูรณ์    กรุณาตรวจสอบข้อมูลสั่งโรงงานผลิต !!!!!!", 1810221405, Me.Text, "", MessageBoxIcon.Information)
            '        Return False
            '    End If
            'Next
            Dim _StateOrderApp As Boolean = False

            _Cmd = " Select  Top 1  isnull(A.FTStateOrderApp,'') as FTStateOrderApp  From [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MERCHAN) & "].dbo.TMERTOrder As A With(NOLOCK) "
            _Cmd &= vbCrLf & " Left OUTER JOIN [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MERCHAN) & "].dbo.TMERTOrderSub AS B WITH(NOLOCK) ON A.FTOrderNo = B.FTOrderNo"
            _Cmd &= vbCrLf & " Left OUTER JOIN  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MERCHAN) & "].dbo.TMERTOrderSub_BreakDown AS C WITH(NOLOCK) ON A.FTOrderNo = C.FTOrderNo And B.FTSubOrderNo = C.FTSubOrderNo"
            _Cmd &= vbCrLf & " LEFT OUTER JOIN  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MERCHAN) & "].dbo.V_OrderSub_BreakDown_ShipDestination  AS V ON A.FTOrderNo = V.FTOrderNo"
            _Cmd &= vbCrLf & " INNER JOIN (select P.FTPckPlanNo , P.FTPORef , P.FTPORefNo , convert(nvarchar(5), convert(int, D.FTPOLineNo)) as FTPOLineNo"
            _Cmd &= vbCrLf & " From [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_ACCOUNT) & "].dbo.TEXPTPackPlan AS P WITH(NOLOCK)  "
            _Cmd &= vbCrLf & "  LEFT OUTER JOIN [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_ACCOUNT) & "].dbo.TEXPTPackPlan_D AS D WITH(NOLOCK)  ON P.FTPckPlanNo = D.FTPckPlanNo and P.FTPORef = D.FTPORef and P.FTPORefNo = P.FTPORefNo"
            _Cmd &= vbCrLf & " And P.FTPORefNo =D.FTPORefNo ) AS Z  ON V.FTPORef = Z.FTPORef --And C.FTNikePOLineItem = Z.FTPOLineNo"
            _Cmd &= vbCrLf & " where V.FTPORef = '" & HI.UL.ULF.rpQuoted(_PORef) & "'   "
            _Cmd &= vbCrLf & " ORder by  isnull(A.FTStateOrderApp,'') desc"
            _StateOrderApp = HI.Conn.SQLConn.GetField(_Cmd, Conn.DB.DataBaseName.DB_MERCHAN, "0") = "1"

            If Not (_StateOrderApp) Then
                HI.MG.ShowMsg.mInfo("ข้อมูลใบสั่งผลิตยังไม่มีการอนุมัติ ", 1902191449, Me.Text, _PORef)
                Return False
            End If
            ...
            _Cmd &= vbCrLf & " Where  FTPORef='" & _PORef & "'"
            _Cmd &= vbCrLf & " and FTPORefNo='" & _PORefNo & "'"
            HI.Conn.SQLConn.ExecuteOnly(_Cmd, Conn.DB.DataBaseName.DB_ACCOUNT)
    ...
    Private Sub LoadTabData(Optional FTPORefNo As String = "")
        Try
            Try
                For Each xtab As DevExpress.XtraTab.XtraTabPage In Me.oTabPlanGen.TabPages
                    oTabPlanGen.TabPages.Clear()
            ...
            '_ReferNoInport = "'3502737663-233','3502710983-231','3502730697-232'"
            ...
            If _ReferNoInport <> "" Then
                _Cmd &= vbCrLf & " where  FTPORefNo in (" & _ReferNoInport & ")"
            Else
                If FTPORefNo = "" Then
                    _Cmd &= vbCrLf & " where  FTPORef ='" & HI.UL.ULF.rpQuoted(Me.FTCustomerPO.Text) & "'"
                Else
                    _Cmd &= vbCrLf & " where  FTPORefNo ='" & HI.UL.ULF.rpQuoted(FTPORefNo) & "'"
                End If
    ...
    Private Sub Load_Multiple(_FtPONo As String, _FTPORefNo As String, ByVal _Spls As HI.TL.SplashScreen)
        Try
            ...
            Dim _lbl1 As New DevExpress.XtraEditors.LabelControl
            Dim _appby As New DevExpress.XtraEditors.TextEdit
            Dim _apptime As New DevExpress.XtraEditors.TextEdit
            ...
            With _apptime
                .Name = "FTApproveTime" & _POrefNo
                .Properties.ReadOnly = True
                .TabIndex = 7
                .Location = New System.Drawing.Point(991, 34)
                .Properties.DisplayFormat.FormatString = "HH:mm:ss"
                .Properties.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Custom
                .Properties.EditFormat.FormatString = "HH:mm:ss"
                .Properties.EditFormat.FormatType = DevExpress.Utils.FormatType.Custom
            ...
            If _FtPONo <> "" Then
                ...
                Dim _Cmd As String = ""
                _Cmd = " SELECT  distinct FTPckPlanNo, P.FTPORef  , P.FTPORefNo, FNQuantity, FNPackcount, FNNet, FNTotalNet, FNGrossWeight,P.FNHSysUnitId, FNVol, FTVolUnit, isnull( FTApproveState ,'0') as FTApproveState , FTApproveBy,  FDApproveDate ,FTApproveTime "
                _Cmd &= vbCrLf & " ,convert(nvarchar(10),convert(date, isnull(P.FDShipDate,  V.FDShipDate)),103) as  FDShipDate  ,  isnull(FNHSysMainMatSpecId,0) as  FNHSysMainMatSpecId   , P.FNHSysProvinceId as  FNHSysProvinceId_Hide  "
                ...
                _Cmd &= vbCrLf & " ,    isnull(N.FTProvinceCode,'') as   FNHSysProvinceId  "
                _Cmd &= vbCrLf & " ,  V.FTPlantCode , P.FTDiamondMarkCode , N.FTProvinceNameEN  as FTProvinceName ,isnull( P.FTPORefNo2 ,'') as FTPORefNo2 , isnull( P.FTCustPORef , '') as FTCustPORef , '' as FNHSysShipModeId , 0 as FNHSysShipModeId_Hide"
                _Cmd &= vbCrLf & " From  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_ACCOUNT) & "]..TEXPTPackPlan AS P WITH(NOLOCK)  "
                _Cmd &= vbCrLf & "  LEFT OUTER JOIN   [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_ACCOUNT) & "].. V_ExportInvoice_H AS V ON   P.FNHSysProvinceId = V.FNHSysProvinceId AND P.FDShipDate = V.FDShipDate AND P.FTPORef = V.FTPORef "
                _Cmd &= vbCrLf & "   LEFT OUTER JOIN [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MASTER) & "].dbo.TCMMProvince AS N with(nolock) oN  P.FNHSysProvinceId = N.FNHSysProvinceId "
                ...
                _Cmd &= vbCrLf & "      FTR, FTPackCode, FNNetWeight, FNTotalNetWeight, FNGrossNetWeight, FTUnitCode,  FNL, FNW, FNH, FTItemUnitCode,isnull(FTScanID,'') as  FTScanID"
                ...
                For Each R As DataRow In _dt.Rows
                    ...
                    DirectCast((_TabPageSubHead.Controls.Find("FTApproveTime" & _FtPONo, True)(0)), DevExpress.XtraEditors.TextEdit).Text = R!FTApproveTime.ToString
                Next
    ...
    Private Sub RepositoryItemFNHSysProvinceId_EditValueChanged(sender As Object, e As EventArgs) Handles RepositoryItemFNHSysProvinceId.EditValueChanged
        Try
            'Dim gridview As GridView = CType(sender, GridView)
            Dim _cmd As String = ""
            _cmd = "Select Top 1  FTProvinceNameEN  From [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MASTER) & "].dbo.TCMMProvince with(nolock)"
            _cmd &= vbCrLf & " where FTProvinceCode ='" & DirectCast(sender, DevExpress.XtraEditors.BaseEdit).EditValue & "'"
            Dim ProvinceDesc As String = HI.Conn.SQLConn.GetField(_cmd, Conn.DB.DataBaseName.DB_MASTER, "")
            ...
            view.SetRowCellValue(view.FocusedRowHandle, "FTProvinceName", ProvinceDesc)
    ...
    Private Sub RepositoryItemFNHSysShipModeId_EditValueChanging(sender As Object, e As ChangingEventArgs) Handles RepositoryItemFNHSysShipModeId.EditValueChanging
        Try
            If e.NewValue = "" Then
            ...
            Dim xtab As DevExpress.XtraTab.XtraTabPage
            xtab = Me.oTabPlanGen.SelectedTabPage
            ...
            _Gcontrol2 = DirectCast(xtab.Controls.Find("ogcPlandD" & xtab.Text, True)(0), DevExpress.XtraGrid.GridControl)
            Dim _oDt As System.Data.DataTable
            _oDt = DirectCast(_Gcontrol2.DataSource, System.Data.DataTable)


            Dim _ShipCode As String = ""

            Select Case e.NewValue.ToString.ToUpper
                Case "AF".ToUpper
                    _ShipCode = "Air"
                Case "TR".ToUpper
                    _ShipCode = "Ocean"
            ...
            End Select
            For Each R As DataRow In _oDt.Rows
                R!FTShipmentMethod = _ShipCode

            Next
            _Gcontrol2.DataSource = _oDt
            _Gcontrol2.Refresh()
    ...
    Private _ReferNoInport As String = ""
    Private Sub ocmReadExcelMerCury_Click(sender As Object, e As EventArgs) Handles ocmReadExcelMerCury.Click
        Try
            Dim _Cmd As String = ""
            Dim _FileName As String = ""
            Dim folderDlg As New OpenFileDialog
            Call ChangeTypeFile("C:\Program Files\MercuryFFS\OutBox\Reports")
            _ReferNoInport = ""
            With folderDlg
                .Filter = "Excel Worksheets(2010-2013)" & "|*.xlsx|Excel Worksheets(97-2000)|*.xls"
                .FilterIndex = 1
                .RestoreDirectory = False
                .Multiselect = True
                .InitialDirectory = "C:\Program Files\MercuryFFS\OutBox\Reports"
                Dim dr As DialogResult = .ShowDialog()
                If (dr = System.Windows.Forms.DialogResult.OK) Then
                    ...
                    For Each file In .FileNames
                        ...
                        Call ReadXlsfile_MultipleMercury(file, _Spls, filenew)
                        Call MoveFileSuccess(filenew)
                    Next
        ...
        End Try
    End Sub
    Private Sub ReadXlsfile_MultipleMercury(_fileName As String, ByVal _Spls As HI.TL.SplashScreen, ByRef filenew As String)
        Try
            Dim _TabPageSubHead As New DevExpress.XtraTab.XtraTabPage
            Dim _GridDM As New DevExpress.XtraGrid.GridControl
            Dim _GridVDM As New DevExpress.XtraGrid.Views.Grid.GridView
            ...
            'Dim excelBook As Microsoft.Office.Interop.Excel.Workbook = xlApp.Workbooks.Open(_fileName)
            ...
            'Dim _SheetName As String = excelSheets(0)
            ...
            End Try
            _oDt = HI.UL.ReadExcel.Read(_fileName, "", 0)
            '   _oDtIn = HI.UL.ReadExcel.Read(_fileName, "Identification", -1)

            Dim _Cmd As String = ""
            _Cmd &= vbCrLf & "delete form TmpDataFromMecury "
            _Cmd &= vbCrLf & "where FTUserLogIn ='" & HI.ST.UserInfo.UserName & "'"
            HI.Conn.SQLConn.ExecuteOnly(_Cmd, Conn.DB.DataBaseName.DB_ACCOUNT)
            ...
            For Each rx As DataRow In _oDt.Rows
                If Not (rx.Item(0) = _oDt.Rows(0).Item(0)) Then
                    Try
                        If _PORefNo = "" Then
                            If rx.Item(4).ToString = "" Then
                                _PORefNo = HI.Conn.SQLConn.GetField("Select Top 1 FTPORef from TMERTOrder where FTPOTradingCo = '" & rx.Item(2) & "'", Conn.DB.DataBaseName.DB_MERCHAN)
                                If _PORefNo = "" Then
                                    _PORefNo = HI.Conn.SQLConn.GetField("Select Top 1 FTPORef from TMERTOrderSub where FTPOTrading  = '" & rx.Item(2) & "'", Conn.DB.DataBaseName.DB_MERCHAN)
                                End If
                                If _PORefNo = "" Then
                                    _PORefNo = HI.Conn.SQLConn.GetField("Select Top 1 FTPORef from TMERTOrder where FTPORef = '" & rx.Item(2) & "'", Conn.DB.DataBaseName.DB_MERCHAN)
                                End If


                            Else
                                _PORefNo = rx.Item(4).ToString
                            End If
                            If _PORefNo = "" Then
                                _PORefNo = rx.Item(2).ToString
                            End If
                        End If
                    ...
                    '_Cmd &= vbCrLf & "delete form TmpDataFromMecury "
                    '_Cmd &= vbCrLf & "where FTUserLogIn ='" & HI.ST.UserInfo.UserName & "'"
                    '_Cmd &= vbCrLf & "and PONumber='" & rx.Item(2) & "'"
                    '_Cmd &= vbCrLf & "and POItem='" & rx.Item(3) & "'"
                    '_Cmd &= vbCrLf & " and Carton#= '" & rx.Item(15) & "'"
                    '_Cmd &= vbCrLf & "and CartonBarcode ='" & rx.Item(16) & "'"
                    '_Cmd &= vbCrLf & " and Material= '" & rx.Item(14) & "'"
                    '_Cmd &= vbCrLf & "and SizeDescription ='" & rx.Item(17) & "'"
                    _ShipId = rx.Item(1)


                    _Cmd = "Insert into  TmpDataFromMecury "
                    _Cmd &= vbCrLf & " (FTUserLogIn, FactoryCode, Shipment#, PONumber, POItem, RefPO, BuyGroup, AFSCategory, MSR, Buyer, Plant, CustomerShipTo"
                    _Cmd &= vbCrLf & ", StencilDest, Invoice#, InvoiceDate, Material, Carton#, CartonBarcode, SizeDescription, "
                    _Cmd &= vbCrLf & "  ItemQuantity, UPCCode, CartonCode, PLPOItemTotalNetWeightkgs, PLPOItemTotalGrosskgs, PLPOItemTotalCBM, PLPOItemTotalCartons )"
                    _Cmd &= vbCrLf & "Select '" & HI.ST.UserInfo.UserName & "'"
                    _Cmd &= vbCrLf & ",'" & rx.Item(0) & "'"
                    _Cmd &= vbCrLf & ",'" & rx.Item(1) & "'"
                    _Cmd &= vbCrLf & ",'" & rx.Item(2) & "'"
                    _Cmd &= vbCrLf & ",'" & rx.Item(3) & "'"

                    _Cmd &= vbCrLf & ",'" & _PORefNo & "'"
                    _Cmd &= vbCrLf & ",'" & rx.Item(5) & "'"
                    _Cmd &= vbCrLf & ",'" & rx.Item(6) & "'"
                    _Cmd &= vbCrLf & ",'" & rx.Item(7) & "'"
                    _Cmd &= vbCrLf & ",'" & rx.Item(8) & "'"
                    _Cmd &= vbCrLf & ",'" & rx.Item(9) & "'"
                    _Cmd &= vbCrLf & ",'" & rx.Item(10) & "'"
                    _Cmd &= vbCrLf & ",'" & rx.Item(11) & "'"
                    _Cmd &= vbCrLf & ",'" & rx.Item(12) & "'"
                    _Cmd &= vbCrLf & ",'" & rx.Item(13) & "'"
                    _Cmd &= vbCrLf & ",'" & rx.Item(14) & "'"
                    _Cmd &= vbCrLf & ",'" & rx.Item(15) & "'"
                    _Cmd &= vbCrLf & ",'" & rx.Item(16) & "'"
                    _Cmd &= vbCrLf & ",'" & MapSize(rx.Item(17)) & "'"
                    _Cmd &= vbCrLf & ",'" & rx.Item(18) & "'"
                    _Cmd &= vbCrLf & ",'" & rx.Item(19) & "'"
                    _Cmd &= vbCrLf & ",'" & rx.Item(20) & "'"
                    _Cmd &= vbCrLf & ",'" & rx.Item(21) & "'"
                    _Cmd &= vbCrLf & ",'" & rx.Item(22) & "'"
                    _Cmd &= vbCrLf & ",'" & rx.Item(23) & "'"
                    _Cmd &= vbCrLf & ",'" & rx.Item(24) & "'"
            ...
            HI.Conn.SQLConn.ExecuteOnly("Exec  dbo.importpackingfrommercury '" & HI.ST.UserInfo.UserName & "','" & _PORefNo & "' ,'" & _ShipId & "'", Conn.DB.DataBaseName.DB_ACCOUNT)
            If _ReferNoInport <> "" Then _ReferNoInport &= ","
            _ReferNoInport &= "'" & _PORefNo & "-" & _ShipId & "'"

            'Me.FTCustomerPO.Text = _PORefNo
