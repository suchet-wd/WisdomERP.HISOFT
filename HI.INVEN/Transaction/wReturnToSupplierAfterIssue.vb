...
Public Class wReturnToSupplierAfterIssue
...
#Region "Procedure"
    ...
    Private Sub LoadDucumentDetail(Key As String)
        ...
        ogcdetail.DataSource = HI.INVEN.Barcode.LoadDocumentBarcode(Key, Barcode.DocType.ReturnToSupplierAfterIssue)  '   HI.Conn.SQLConn.GetDataTable(_Str, Conn.DB.DataBaseName.DB_INVEN)
    ...
    Private Function DeleteData() As Boolean
        Try
            ...
            Dim _Str As String
            _Str = "Delete From  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_INVEN) & "].dbo.TINVENReturnToSupplierAfterIssue WHERE FTReturnSuplNo='" & HI.UL.ULF.rpQuoted(Me.FTReturnSuplNo.Text) & "'"
            If HI.Conn.SQLConn.Execute_Tran(_Str, HI.Conn.SQLConn.Cmd, HI.Conn.SQLConn.Tran) <= 0 Then
                HI.Conn.SQLConn.Tran.Rollback()
                HI.Conn.SQLConn.DisposeSqlTransaction(HI.Conn.SQLConn.Tran)
                HI.Conn.SQLConn.DisposeSqlConnection(HI.Conn.SQLConn.Cmd)
            ...
            _Str = "Delete From  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_INVEN) & "].dbo.TINVENBarcode_OUT_RTS_AfterIssue WHERE FTDocumentNo='" & HI.UL.ULF.rpQuoted(Me.FTReturnSuplNo.Text) & "'"
            ...
            HI.Auditor.CreateLog.CreateLogDelete(HI.ST.SysInfo.MenuName, Me.Name, "Delete From  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_INVEN) & "].dbo.TINVENReturnToSupplierAfterIssue WHERE FTReturnSuplNo='" & HI.UL.ULF.rpQuoted(Me.FTReturnSuplNo.Text) & "'")
...
#Region "MAIN PROC"
    ...
    Private Function ChkCloseStock() As Boolean
        ...
        Dim _dt As DataTable
        _Qry = "  SELECT A.FTReturnSuplNo, B.FNHSysWHId"
        ...
        _Qry &= vbCrLf & "          [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_INVEN) & "].dbo.TINVENBarcode_OUT_RTS_AfterIssue AS B WITH(NOLOCK)  ON A.FTReturnSuplNo = B.FTDocumentNo"
        _Qry &= vbCrLf & " WHERE A.FTReturnSuplNo='" & HI.UL.ULF.rpQuoted(Me.FTReturnSuplNo.Text) & "' "
        _Qry &= vbCrLf & "  GROUP BY A.FTReturnSuplNo, B.FNHSysWHId"

        _dt = HI.Conn.SQLConn.GetDataTable(_Qry, Conn.DB.DataBaseName.DB_INVEN)

        For Each R As DataRow In _dt.Rows
            If StockValidate.CheckCloseStock(Integer.Parse(Val(R!FNHSysWHId.ToString)), Me.FDReturnSuplDate.Text) = True Then
                Return True
            End If
        Next
    ...
    Private Function CheckOwner() As Boolean
        If (HI.ST.UserInfo.UserName.ToUpper = FTReturnSuplBy.Text.ToUpper) Or (HI.ST.SysInfo.Admin) Then
            Return True
        Else
            Dim _Qry As String = ""
            Dim _Qry2 As String = ""
            ...
            _Qry &= vbCrLf & "   WHERE  FTUserName = '" & HI.UL.ULF.rpQuoted(FTReturnSuplBy.Text) & "' "
    ...
    Private Sub Proc_Save(sender As System.Object, e As System.EventArgs) Handles ocmsave.Click
        ...
        If HI.ST.ValidateData.CloseJobDocOutAfIssue(FTReturnSuplNo.Text) Then
    ...
    Private Sub Proc_Delete(sender As System.Object, e As System.EventArgs) Handles ocmdelete.Click
        ...
        If HI.MG.ShowMsg.mConfirmProcessDefaultNo(MG.ShowMsg.ProcessType.mDelete, Me.FTReturnSuplNo.Text, Me.Text) = False Then
            Exit Sub
        End If
    ...
    Private Sub Proc_Preview(sender As System.Object, e As System.EventArgs) Handles ocmpreview.Click
        If Me.FTReturnSuplNo.Text <> "" Then

            With New HI.RP.Report
                .FormTitle = Me.Text
                .ReportFolderName = "Inventrory\"
                .ReportName = "ReturnToSupplierAfterIssueSlip.rpt"
                .Formular = "{TINVENReturnToSupplierAfterIssue.FTReturnSuplNo}='" & HI.UL.ULF.rpQuoted(FTReturnSuplNo.Text) & "' "
                .Preview()
            End With
            ...
            With New HI.RP.Report
                .FormTitle = Me.Text
                .ReportFolderName = "Inventrory\"
                .ReportName = "ReturnToSupplierAfterIssueSlip_Barcode.rpt"
                .Formular = "{TINVENReturnToSupplierAfterIssue.FTReturnSuplNo}='" & HI.UL.ULF.rpQuoted(FTReturnSuplNo.Text) & "' "
                .Preview()
            End With

        Else
            HI.MG.ShowMsg.mInvalidData(MG.ShowMsg.InvalidType.SelectData, Me.Text, Me.FTReturnSuplNo_lbl.Text)
            FTReturnSuplNo.Focus()
        End If
    End Sub
...
#Region "Proc Barcode"
    Private Function SaveBarcode() As Boolean
        ...
        Try
            ...
            _Str = " SELECT TOP 1 FTBarcodeNo  FROM  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_INVEN) & "].dbo.TINVENBarcode_OUT_RTS_AfterIssue WITH(NOLOCK) WHERE FTDocumentNo='" & HI.UL.ULF.rpQuoted(FTReturnSuplNo.Text) & "' AND FTBarcodeNo='" & HI.UL.ULF.rpQuoted(_BarCode) & "' AND  FTDocumentRefNo='" & HI.UL.ULF.rpQuoted(Me.DocRefNo) & "' "
            ...
            If _StateNew Then
                _Str = " INSERT INTO [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_INVEN) & "].dbo.TINVENBarcode_OUT_RTS_AfterIssue(FTInsUser, FDInsDate, FTInsTime, FTBarcodeNo, FTDocumentNo, FNHSysWHId, FTOrderNo, FNQuantity,  FTStateReserve,FTDocumentRefNo,FNHSysCmpId,FNPriceTrans)  "
                _Str &= vbCrLf & " SELECT '" & HI.UL.ULF.rpQuoted(HI.ST.UserInfo.UserName) & "' "
                _Str &= vbCrLf & "," & HI.UL.ULDate.FormatDateDB & " "
                _Str &= vbCrLf & "," & HI.UL.ULDate.FormatTimeDB & " "
                _Str &= vbCrLf & ",'" & HI.UL.ULF.rpQuoted(_BarCode) & "' "
                _Str &= vbCrLf & ",'" & HI.UL.ULF.rpQuoted(FTReturnSuplNo.Text) & "' "
            ...
            Else
                _Str = " UPDATE [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_INVEN) & "].dbo.TINVENBarcode_OUT_RTS_AfterIssue "
                ...
                _Str &= vbCrLf & "  WHERE FTDocumentNo='" & HI.UL.ULF.rpQuoted(FTReturnSuplNo.Text) & "' "
    ...
    Private Function DeleteBarcode(BarcodeKey As String, FTOrderNoKey As String) As Boolean
        ...
        Try
            ...
            _Str = " DELETE  FROM  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_INVEN) & "].dbo.TINVENBarcode_OUT_RTS_AfterIssue  WHERE FTDocumentNo='" & HI.UL.ULF.rpQuoted(FTReturnSuplNo.Text) & "' AND FTBarcodeNo='" & HI.UL.ULF.rpQuoted(_BarCode) & "' AND FTOrderNo='" & HI.UL.ULF.rpQuoted(_FTOrderNo) & "' "
            ...
            HI.Auditor.CreateLog.CreateLogDelete(HI.ST.SysInfo.MenuName, Me.Name, " DELETE  FROM  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_INVEN) & "].dbo.TINVENBarcode_OUT_RTS_AfterIssue  WHERE FTDocumentNo='" & HI.UL.ULF.rpQuoted(FTReturnSuplNo.Text) & "' AND FTBarcodeNo='" & HI.UL.ULF.rpQuoted(_BarCode) & "' AND FTOrderNo='" & HI.UL.ULF.rpQuoted(_FTOrderNo) & "' ")
...
#End Region
        ...
        Select Case e.KeyCode
            Case Keys.Enter
                ...
                If FTBarcodeNo.Text <> "" Then
                    ...
                    If FTReturnSuplNo.Properties.Tag.ToString = "" Then
                        If Me.VerrifyData() Then
                            If Me.SaveData Then
                            Else
                                Exit Sub
                        ...
                        End If
                    Else
                        If Me.FTReturnSuplNo.Text = "" Then Exit Sub
                        LoadDataInfo(Me.FTReturnSuplNo.Text)
                    End If
    ...
    Private Sub AddBarCode(BarcodeNo As String, StateAdd As Boolean, Optional Qty As Double = 0)
        ...
        Dim _Dt As DataTable = Barcode.BarCodeOutForRet(FTBarcodeNo.Text, 0.ToString, "", Me.FTReturnSuplNo.Text)
        If _Dt.Rows.Count > 0 Then
            If _Dt.Select("FNQuantityBal >=" & Qty & " AND FNQuantityBal >0 ").Length > 0 Then

                If _Dt.Select("FTPurchaseNo='" & HI.UL.ULF.rpQuoted(FTPurchaseNo.Text) & "' AND FNQuantityBal >0").Length > 0 Then

                    'If _Dt.Select("FNQuantityBal >=" & Qty & " AND FNQuantityBal >0 AND FNHSysCmpId=" & Integer.Parse(Val(HI.ST.SysInfo.CmpID)) & "").Length <= 0 Then
                    ...
                    If Me.FTOrderNo.Text = "" Then
                        ...
                        For Each R As DataRow In _Dt.Select("FTPurchaseNo='" & HI.UL.ULF.rpQuoted(FTPurchaseNo.Text) & "' AND FNQuantityBal >=" & Qty & " AND FNQuantityBal > 0  AND FNHSysCmpId=" & Integer.Parse(Val(HI.ST.SysInfo.CmpID)) & "")
                    ...
                    If _Dt.Select("FTPurchaseNo='" & HI.UL.ULF.rpQuoted(FTPurchaseNo.Text) & "' AND FNQuantityBal >=" & Qty & " AND FNQuantityBal >0 AND FTOrderNo='" & HI.UL.ULF.rpQuoted(FTOrderNo.Text) & "' ").Length > 0 Then
                        For Each R As DataRow In _Dt.Select("FTPurchaseNo='" & HI.UL.ULF.rpQuoted(FTPurchaseNo.Text) & "' AND FNQuantityBal >=" & Qty & " AND FNQuantityBal >0 AND FTOrderNo='" & HI.UL.ULF.rpQuoted(FTOrderNo.Text) & "'  ")
                            If Qty <> 0 Then
                        ...
                        If (StateAdd) And Me.WH <> 0 And Me.OrderNo <> "" Then
                            ...
                            If StockValidate.CheckCloseStock(Integer.Parse(Val(Me.WH)), Me.FDReturnSuplDate.Text) = True Then
                                Exit Sub
                            End If
                            ...
                            If SaveBarcode() Then
                                ...
                                LoadDucumentDetail(Me.FTReturnSuplNo.Text)
                            End If
                ...
                Else
                    HI.MG.ShowMsg.mInvalidData("Barcode ไม่ใช่ของ PO นี้  !!!", 1312010001, Me.Text)
                End If
            Else
    ...
    Private Sub DeleteBarcode()
        ...
        With ogvdetail
            ...
            For Each i As Integer In .GetSelectedRows()
                ...
                If StockValidate.CheckCloseStock(Integer.Parse(Val("" & .GetRowCellValue(i, "FNHSysWHId").ToString)), Me.FDReturnSuplDate.Text) = True Then
                Else
                    If DeleteBarcode(_Barcode, _FTOrderNo) Then
                        _StateDelete = True
                    End If
    ...
    Private Sub wReturnToSupplierAfterIssue_Load(sender As Object, e As EventArgs) Handles Me.Load
        FNHSysCmpId.Text = HI.ST.SysInfo.CmpID.ToString
