Public Class wReceiveUnitMaterial
    ...
    Private Function ValidateData() As Boolean
        ...
        With CType(Me.ogcrcv.DataSource, DataTable)
            .AcceptChanges()
            If .Select("FNHSysUnitId_Hide=0").Length <= 0 Then
                _Pass = True
            End If
        End With
        ...
        If ValidateData() Then
            ...
            With CType(Me.ogcrcv.DataSource, DataTable)
                ...
                For Each R As DataRow In .Rows
                    _Qry = " UPDATE [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MASTER) & "].dbo.TINVENMMaterial"
                    _Qry &= vbCrLf & " SET FNHSysUnitId=" & Integer.Parse(Val(R!FNHSysUnitId_Hide.ToString)) & " "
                    _Qry &= vbCrLf & " WHERE FTRawMatCode='" & HI.UL.ULF.rpQuoted(R!FTRawMatCode.ToString) & "' "
