...
Public Class wTransferWHToStockCenter
    ...
    Private _AutoReserve As wTransferCenterAutoReserve
    ...
    Sub New()
        ...
        _AutoReserve = New wTransferCenterAutoReserve
        HI.TL.HandlerControl.AddHandlerObj(_AutoReserve)
        Try

            Call oSysLang.LoadObjectLanguage(HI.ST.SysInfo.ModuleName, _AutoReserve.Name.ToString.Trim, _AutoReserve)
...
#Region "Procedure"
    ...
    Private Sub LoadDucumentDetail(Key As String)
        ...
        ogcdetail.DataSource = HI.INVEN.Barcode.LoadDocumentBarcode(Key, Barcode.DocType.TransferCenter)
    ...
    Private Function DeleteData() As Boolean
        Try
            ...
            Dim _Str As String
            _Str = "Delete From  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_INVEN) & "].dbo.TINVENTransferCenter WHERE FTTransferCenterNo='" & HI.UL.ULF.rpQuoted(Me.FTTransferCenterNo.Text) & "'"
            If HI.Conn.SQLConn.Execute_Tran(_Str, HI.Conn.SQLConn.Cmd, HI.Conn.SQLConn.Tran) <= 0 Then
                HI.Conn.SQLConn.Tran.Rollback()
                HI.Conn.SQLConn.DisposeSqlTransaction(HI.Conn.SQLConn.Tran)
                HI.Conn.SQLConn.DisposeSqlConnection(HI.Conn.SQLConn.Cmd)
            ...
            _Str = "Delete From  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_INVEN) & "].dbo.TINVENBarcode_OUT WHERE FTDocumentNo='" & HI.UL.ULF.rpQuoted(Me.FTTransferCenterNo.Text) & "'"

            HI.Conn.SQLConn.Execute_Tran(_Str, HI.Conn.SQLConn.Cmd, HI.Conn.SQLConn.Tran)

            _Str = "Delete From  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_INVEN) & "].dbo.TINVENBarcode_IN WHERE FTDocumentNo='" & HI.UL.ULF.rpQuoted(Me.FTTransferCenterNo.Text) & "'"
            ...
            HI.Auditor.CreateLog.CreateLogDelete(HI.ST.SysInfo.MenuName, Me.Name, "Delete From  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_INVEN) & "].dbo.TINVENTransferCenter WHERE FTTransferCenterNo='" & HI.UL.ULF.rpQuoted(Me.FTTransferCenterNo.Text) & "'")
...
#Region "MAIN PROC"
    ...
    Private Function CheckOwner() As Boolean
        If (HI.ST.UserInfo.UserName.ToUpper = FTTransferCenterBy.Text.ToUpper) Or (HI.ST.SysInfo.Admin) Then
            Return True
        Else
            Dim _Qry As String = ""
            Dim _Qry2 As String = ""
            ...
            _Qry &= vbCrLf & "   WHERE  FTUserName = '" & HI.UL.ULF.rpQuoted(FTTransferCenterBy.Text) & "' "
    ...
    Private Sub Proc_Save(sender As System.Object, e As System.EventArgs) Handles ocmsave.Click
        ...
        If StockValidate.CheckCloseStock(Integer.Parse(Val(FNHSysWHId.Properties.Tag.ToString)), Me.FDTransferCenterDate.Text) = True Then
            Exit Sub
        End If

        If StockValidate.CheckCloseStock(Integer.Parse(Val(FNHSysWHIdTo.Properties.Tag.ToString)), Me.FDTransferCenterDate.Text) = True Then
            Exit Sub
        End If
    ...
    Private Sub Proc_Delete(sender As System.Object, e As System.EventArgs) Handles ocmdelete.Click
        ...
        If StockValidate.CheckCloseStock(Integer.Parse(Val(FNHSysWHIdTo.Properties.Tag.ToString)), Me.FDTransferCenterDate.Text) = True Then
            Exit Sub
        End If
        If Barcode.CheckDocumentRefOut(Me.FTTransferCenterNo.Text) Then
            HI.MG.ShowMsg.mInvalidData("เอกสาร มีการเดิน Transaction  ลบ หรือแก้ไขได้ !!!", 1312220001, Me.Text)
            Exit Sub
        End If

        If HI.MG.ShowMsg.mConfirmProcessDefaultNo(MG.ShowMsg.ProcessType.mDelete, Me.FTTransferCenterNo.Text, Me.Text) = False Then
            Exit Sub
        End If
    ...
    Private Sub Proc_Preview(sender As System.Object, e As System.EventArgs) Handles ocmpreview.Click
        If Me.FTTransferCenterNo.Text <> "" Then
            With New HI.RP.Report
                .FormTitle = Me.Text
                .ReportFolderName = "Inventrory\"
                .ReportName = "TransferToStockCenterSlip.rpt"
                .Formular = "{TINVENTransferCenter.FTTransferCenterNo}='" & HI.UL.ULF.rpQuoted(FTTransferCenterNo.Text) & "' "
                .Preview()
            End With
            ...
            With New HI.RP.Report
                .FormTitle = Me.Text
                .ReportFolderName = "Inventrory\"
                .ReportName = "TransferToStockCenterSlip_Barcode.rpt"
                .Formular = "{TINVENTransferCenter.FTTransferCenterNo}='" & HI.UL.ULF.rpQuoted(FTTransferCenterNo.Text) & "' "
                .Preview()
            End With

        Else
            HI.MG.ShowMsg.mInvalidData(MG.ShowMsg.InvalidType.SelectData, Me.Text, Me.FTTransferCenterNo_lbl.Text)
            FTTransferCenterNo.Focus()
        End If
    End Sub
...
#Region " Proc "
    ...
    Private Function SaveBarcode() As Boolean
        ...
        Try
            ...
            _Str = " SELECT TOP 1 FTBarcodeNo  FROM  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_INVEN) & "].dbo.TINVENBarcode_OUT WITH(NOLOCK) WHERE FTDocumentNo='" & HI.UL.ULF.rpQuoted(FTTransferCenterNo.Text) & "' AND FTBarcodeNo='" & HI.UL.ULF.rpQuoted(_BarCode) & "'  AND FTDocumentRefNo='" & HI.UL.ULF.rpQuoted(Me.DocRefNo) & "' "
            ...
            If _StateNew Then
                ...
                _Str &= vbCrLf & ",'" & HI.UL.ULF.rpQuoted(FTTransferCenterNo.Text) & "' "
            ...
            Else
                ...
                _Str &= vbCrLf & "  WHERE FTDocumentNo='" & HI.UL.ULF.rpQuoted(FTTransferCenterNo.Text) & "' "
    ...
    Private Function DeleteBarcode(BarcodeKey As String, FTOrderNoKey As String) As Boolean
        ...
        Try
            ...
            _Str = " DELETE  FROM  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_INVEN) & "].dbo.TINVENBarcode_OUT  WHERE FTDocumentNo='" & HI.UL.ULF.rpQuoted(FTTransferCenterNo.Text) & "' AND FTBarcodeNo='" & HI.UL.ULF.rpQuoted(_BarCode) & "'  AND FTOrderNo='" & HI.UL.ULF.rpQuoted(_FTOrderNo) & "' "
            ...
            _Str = " DELETE  FROM  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_INVEN) & "].dbo.TINVENBarcode_IN  WHERE FTDocumentNo='" & HI.UL.ULF.rpQuoted(FTTransferCenterNo.Text) & "' AND FTBarcodeNo='" & HI.UL.ULF.rpQuoted(_BarCode) & "'  AND FTOrderNo='" & HI.UL.ULF.rpQuoted(_FTOrderNo) & "'  "
            ...
            HI.Auditor.CreateLog.CreateLogDelete(HI.ST.SysInfo.MenuName, Me.Name, " DELETE  FROM  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_INVEN) & "].dbo.TINVENBarcode_OUT  WHERE FTDocumentNo='" & HI.UL.ULF.rpQuoted(FTTransferCenterNo.Text) & "' AND FTBarcodeNo='" & HI.UL.ULF.rpQuoted(_BarCode) & "'  AND FTOrderNo='" & HI.UL.ULF.rpQuoted(_FTOrderNo) & "' ")
...
#End Region
    ...
    Private Sub FNIssueBarType_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles FNIssueBarType.SelectedIndexChanged
        ...
        If FTTransferCenterNo.Text <> "" Then
            FTBarcodeNo.Focus()
        ...
        Select Case e.KeyCode
            Case Keys.Enter
                ...
                If FTBarcodeNo.Text <> "" Then
                    ...
                    If FTTransferCenterNo.Properties.Tag.ToString = "" Then
                        If Me.VerrifyData() Then
                            If Me.SaveData Then
                            Else
                                Exit Sub
                        ...
                        End If
                    Else
                        If Me.FTTransferCenterNo.Text = "" Then Exit Sub
                        LoadDataInfo(Me.FTTransferCenterNo.Text)
                    End If
    ...
    Private Sub AddBarCode(BarcodeNo As String, StateAdd As Boolean, Optional Qty As Double = 0)
        ...
        Dim _Dt As DataTable = Barcode.BarCodeBalance(FTBarcodeNo.Text, 0.ToString, "", Me.FTTransferCenterNo.Text, True)
        If _Dt.Rows.Count > 0 Then
            If _Dt.Select("FNQuantityBal >=" & Qty & "").Length > 0 Then
                If _Dt.Select("FNHSysWHId=" & Val(FNHSysWHId.Properties.Tag.ToString) & " AND FNQuantityBal >=" & Qty & "").Length > 0 Then
                    ...
                    If Me.FTOrderNo.Text = "" Then
                        For Each R As DataRow In _Dt.Select("FNQuantityBal >=" & Qty & " AND FNHSysWHId=" & Val(FNHSysWHId.Properties.Tag.ToString) & " ")
                    ...
                    If _Dt.Select("FNQuantityBal >=" & Qty & " AND FNHSysWHId=" & Val(FNHSysWHId.Properties.Tag.ToString) & " AND FTOrderNo='" & HI.UL.ULF.rpQuoted(FTOrderNo.Text) & "'").Length > 0 Then

                        For Each R As DataRow In _Dt.Select("FNQuantityBal >=" & Qty & " AND FNHSysWHId=" & Val(FNHSysWHId.Properties.Tag.ToString) & " AND FTOrderNo='" & HI.UL.ULF.rpQuoted(FTOrderNo.Text) & "'")
                            If Qty <> 0 Then
                        ...
                        If (StateAdd) And Me.WH <> 0 And Me.OrderNo <> "" Then
                            If SaveBarcode() Then
                                ...
                                LoadDucumentDetail(Me.FTTransferCenterNo.Text)
                            End If
    ...
    Private Sub ogvdetail_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles ogvdetail.KeyDown
        ...
        Select Case e.KeyCode
            Case Keys.Delete
                ...
                '    If Barcode.CheckTransactionOUT(_Barcode, FTBarcodeNo.Text, FNHSysWHId.Properties.Tag.ToString, "") Then
    ...
    Private Sub ogvdetail_RowCountChanged(sender As Object, e As System.EventArgs) Handles ogvdetail.RowCountChanged
        ...
        Try
            ...
            FNHSysWHIdTo.Properties.ReadOnly = (dt.Rows.Count > 0)
            FNHSysWHIdTo.Properties.Buttons.Item(0).Enabled = Not ((dt.Rows.Count > 0))
    ...
    Private Sub DeleteBarcode()
        ...
        With ogvdetail
            ...
            For Each i As Integer In .GetSelectedRows()
                ...
                If Barcode.CheckTransactionOUT(_Barcode, FTTransferCenterNo.Text, FNHSysWHIdTo.Properties.Tag.ToString, "") Then
    ...
    Private Sub wTransferWHToStockCenter_Load(sender As Object, e As EventArgs) Handles Me.Load
        FNHSysCmpId.Text = HI.ST.SysInfo.CmpID.ToString
    ...
    Private Sub ocmautoreserved_Click(sender As Object, e As EventArgs) Handles ocmautoreserved.Click
        If CheckOwner() = False Then Exit Sub
        ...
        If Me.FTTransferCenterNo.Text <> "" Then
            ...
            If dt.Rows.Count > 0 Then
                ...
                dtauto = HI.INVEN.Barcode.GetListBarcodeInForCreateTransaction(Me.FTTransferCenterNo.Text.Trim)

                If dtauto.Rows.Count > 0 Then
                    HI.TL.HandlerControl.ClearControl(_AutoReserve)
                    With _AutoReserve

                        Call HI.ST.Lang.SP_SETxLanguage(_AutoReserve)
                        .WHID = Integer.Parse(Val(FNHSysWHIdTo.Properties.Tag.ToString))
                        .ReceiveNo = Me.FTTransferCenterNo.Text
            ...
            Else
                HI.MG.ShowMsg.mInfo("ไม่พบข้อมูลรายละเอียดรายการ กรุณาทำการตรวจสอบ !!!", 1508130642, Me.Text, , MessageBoxIcon.Warning)
                FTTransferCenterNo.Focus()
            End If
        Else
            HI.MG.ShowMsg.mInvalidData(MG.ShowMsg.InvalidType.SelectData, Me.Text, Me.FTTransferCenterNo_lbl.Text)
