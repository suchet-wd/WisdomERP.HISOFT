...
#Region "Procedure"
    ...
    Public Sub LoadDataInfo(Key As Object)
        ...
        Call LoadScrapDetail(Key.ToString)
    ...
    Private Sub LoadScrapDetail(Key As String)


        ogcdetail.DataSource = HI.INVEN.Barcode.LoadDocumentBarcode(Key, Barcode.DocType.ScrapBarcode)
    ...
    Private Function DeleteData() As Boolean
        Try
            ...
            Dim _Str As String
            _Str = "Delete From  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_INVEN) & "].dbo.TINVENScrapBarcode WHERE FTScrapNo='" & HI.UL.ULF.rpQuoted(Me.FTScrapNo.Text) & "'"
            If HI.Conn.SQLConn.Execute_Tran(_Str, HI.Conn.SQLConn.Cmd, HI.Conn.SQLConn.Tran) <= 0 Then
                HI.Conn.SQLConn.Tran.Rollback()
                HI.Conn.SQLConn.DisposeSqlTransaction(HI.Conn.SQLConn.Tran)
                HI.Conn.SQLConn.DisposeSqlConnection(HI.Conn.SQLConn.Cmd)
            ...
            _Str = "Delete From  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_INVEN) & "].dbo.TINVENBarcode_OUT WHERE FTDocumentNo='" & HI.UL.ULF.rpQuoted(Me.FTScrapNo.Text) & "'"
            ...
            HI.Auditor.CreateLog.CreateLogDelete(HI.ST.SysInfo.MenuName, Me.Name, "Delete From  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_INVEN) & "].dbo.TINVENScrapBarcode WHERE FTScrapNo='" & HI.UL.ULF.rpQuoted(Me.FTScrapNo.Text) & "'")
...
#Region "MAIN PROC"
    ...
    Private Function CheckOwner() As Boolean
        If (HI.ST.UserInfo.UserName.ToUpper = FTScrapBy.Text.ToUpper) Or (HI.ST.SysInfo.Admin) Then
            Return True
        Else
            Dim _Qry As String = ""
            Dim _Qry2 As String = ""
            ...
            _Qry &= vbCrLf & "   WHERE  FTUserName = '" & HI.UL.ULF.rpQuoted(FTScrapBy.Text) & "' "
    ...
    Private Sub Proc_Save(sender As System.Object, e As System.EventArgs) Handles ocmsave.Click
        ...
        If StockValidate.CheckCloseStock(Integer.Parse(Val(FNHSysWHId.Properties.Tag.ToString)), Me.FDScrapDate.Text) = True Then
            Exit Sub
        End If
        If Barcode.CheckDucumentCreateBar(FTScrapNo.Text) Then
    ...
    Private Sub Proc_Delete(sender As System.Object, e As System.EventArgs) Handles ocmdelete.Click
        ...
        If HI.MG.ShowMsg.mConfirmProcessDefaultNo(MG.ShowMsg.ProcessType.mDelete, Me.FTScrapNo.Text, Me.Text) = False Then
            Exit Sub
        End If
    ...
    Private Sub Proc_Preview(sender As System.Object, e As System.EventArgs) Handles ocmpreview.Click
        If Me.FTScrapNo.Text <> "" Then
            With New HI.RP.Report
                .FormTitle = Me.Text
                .ReportFolderName = "Inventrory\"
                .ReportName = "BarCodeScrapSlip.rpt"
                .Formular = "{TINVENScrapBarcode.FTScrapNo}='" & HI.UL.ULF.rpQuoted(FTScrapNo.Text) & "' "
                .Preview()
            End With
            ...
            With New HI.RP.Report
                .FormTitle = Me.Text
                .ReportFolderName = "Inventrory\"
                .ReportName = "BarCodeScrapSlip_Barcode.rpt"
                .Formular = "{TINVENScrapBarcode.FTScrapNo}='" & HI.UL.ULF.rpQuoted(FTScrapNo.Text) & "' "
                .Preview()
            End With

        Else
            HI.MG.ShowMsg.mInvalidData(MG.ShowMsg.InvalidType.SelectData, Me.Text, Me.FTScrapNo_lbl.Text)
            FTScrapNo.Focus()
        End If
    End Sub
...
#Region " Proc "
    ...
    Private Function SaveBarcode() As Boolean
        ...
        Try
            ...
            _Str = " SELECT TOP 1 FTBarcodeNo  FROM  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_INVEN) & "].dbo.TINVENBarcode_OUT WITH(NOLOCK) WHERE FTDocumentNo='" & HI.UL.ULF.rpQuoted(FTScrapNo.Text) & "' AND FTBarcodeNo='" & HI.UL.ULF.rpQuoted(_BarCode) & "' AND FTDocumentRefNo='" & HI.UL.ULF.rpQuoted(Me.DocRefNo) & "' "
            ...
            If _StateNew Then
                ...
                _Str &= vbCrLf & ",'" & HI.UL.ULF.rpQuoted(FTScrapNo.Text) & "' "
            ...
            Else
                ...
                _Str &= vbCrLf & " WHERE FTDocumentNo='" & HI.UL.ULF.rpQuoted(FTScrapNo.Text) & "' "
    ...
    Private Function DeleteBarcode(BarcodeKey As String, FTOrderNoKey As String) As Boolean
        ...
        Try
            ...
            _Str = " DELETE  FROM  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_INVEN) & "].dbo.TINVENBarcode_OUT  WHERE FTDocumentNo='" & HI.UL.ULF.rpQuoted(FTScrapNo.Text) & "' AND FTBarcodeNo='" & HI.UL.ULF.rpQuoted(_BarCode) & "' AND FTOrderNo='" & HI.UL.ULF.rpQuoted(_FTOrderNo) & "' "
            ...
            HI.Auditor.CreateLog.CreateLogDelete(HI.ST.SysInfo.MenuName, Me.Name, " DELETE  FROM  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_INVEN) & "].dbo.TINVENBarcode_OUT  WHERE FTDocumentNo='" & HI.UL.ULF.rpQuoted(FTScrapNo.Text) & "' AND FTBarcodeNo='" & HI.UL.ULF.rpQuoted(_BarCode) & "' AND FTOrderNo='" & HI.UL.ULF.rpQuoted(_FTOrderNo) & "' ")
...
#End Region
        ...
        Select Case e.KeyCode
            Case Keys.Enter
                ...
                If FTBarcodeNo.Text <> "" Then
                    ...
                    If FTScrapNo.Properties.Tag.ToString = "" Then
                        If Me.VerrifyData() Then
                            If Me.SaveData Then
                            Else
                                Exit Sub
                        ...
                        End If
                    Else
                        If Me.FTScrapNo.Text = "" Then Exit Sub
                        LoadDataInfo(Me.FTScrapNo.Text)
                    End If
    ...
    Private Sub AddBarCode(BarcodeNo As String, StateAdd As Boolean, Optional Qty As Double = 0)
        ...
        Dim _Dt As DataTable = Barcode.BarCodeBalance(FTBarcodeNo.Text, 0.ToString, "", Me.FTScrapNo.Text, True)
        If _Dt.Rows.Count > 0 Then
                    ...
                    If _Dt.Select("FNQuantityBal >=" & Qty & " AND  FNHSysWHId=" & Val(FNHSysWHId.Properties.Tag.ToString) & " AND FNQuantityBal >0 AND  FTOrderNo='" & HI.UL.ULF.rpQuoted(FTOrderNo.Text) & "' ").Length > 0 Then
                        ...
                        If (StateAdd) Then
                            ...
                            If SaveBarcode() Then
                                ...
                                LoadScrapDetail(Me.FTScrapNo.Text)
                                FTBarcodeNo.Focus()
                                FTBarcodeNo.SelectAll()
                                FNQuantityBal.Value = 0
    ...
    Private Sub ocmgenbarcode_Click(sender As System.Object, e As System.EventArgs) Handles ocmgenbarcode.Click
        ...
        If FTScrapNo.Text.Trim <> "" Then
            If FTScrapNo.Properties.Tag.ToString <> "" Then
                ...
                With _GenBarcode
                    Call HI.ST.Lang.SP_SETxLanguage(_GenBarcode)
                    .BarType = wGenerateBarcodeInven.BarCodeType.Scrap
                    .ProcGen = False
                    .DocumentNo = FTScrapNo.Text
                    .LoadGenbarcode()
                    .MainObject = Me
                    .ShowDialog()

                    If (.ProcGen) Then
                        LoadBarcode(FTScrapNo.Text)
                    End If
    ...
    Private Sub DeleteBarcodeGen()
        ...
        With ogvbarcode
            ...
            For Each i As Integer In .GetSelectedRows()
                ...
                If Barcode.CheckTransactionOUT(_BarCode, FTScrapNo.Text, FNHSysWHId.Properties.Tag.ToString, _OrderNo) Then
            ...
            If (_StateDelete) Then
                Me.LoadBarcode(Me.FTScrapNo.Text)
            End If
    ...
    Private Sub wScrapBarcode_Load(sender As Object, e As EventArgs) Handles Me.Load
        FNHSysCmpId.Text = HI.ST.SysInfo.CmpID.ToString
    End Sub
