...
Public Class wINVENReportIssueTransaction
    ...
    Private Sub _Preview()
        Try
            ...
            If Me.FTIssueNo.Text <> "" Then
                ...
                _FN &= "  {TINVENIssue.FTIssueNo} >= '" & HI.UL.ULF.rpQuoted(Me.FTIssueNo.Text) & "'"
            End If

            If Me.FTIssueNo.Text <> "" Then
                _FN &= IIf(_FN.Trim <> "", " AND ", "")
                _FN &= " {TINVENIssue.FTIssueNo} <= '" & HI.UL.ULF.rpQuoted(Me.FTIssueNoTo.Text) & "'"
            End If


            '************Date Issue
            If Me.FDSSIssueDate.Text <> "" Then
                _FN &= IIf(_FN.Trim <> "", " AND ", "")
                _FN &= " {TINVENIssue.FDIssueDate} >= '" & HI.UL.ULDate.ConvertEnDB(Me.FDSSIssueDate.Text) & "'"
            End If

            If Me.FDEIssueDateTo.Text <> "" Then
                _FN &= IIf(_FN.Trim <> "", " AND ", "")
                _FN &= " {TINVENIssue.FDIssueDate} <= '" & HI.UL.ULDate.ConvertEnDB(Me.FDEIssueDateTo.Text) & "'"
            End If
            ...
            If Me.IcCondition.otpUser.PageVisible Then
                If Me.IcCondition.FTUser.Text <> "" Then
                    _FN &= IIf(_FN.Trim <> "", " AND ", "")
                    _FN &= " {TINVENIssue.FTIssueBy} >= '" & HI.UL.ULF.rpQuoted(Me.IcCondition.FTUser.Text) & "'"
                End If

                If Me.IcCondition.FTUserTo.Text <> "" Then
                    _FN &= IIf(_FN.Trim <> "", " AND ", "")
                    _FN &= " {TINVENIssue.FTIssueBy} <= '" & HI.UL.ULF.rpQuoted(Me.IcCondition.FTUserTo.Text) & "'"
                End If
            End If
            ...
            If _AllReportName <> "" Then
                For Each _ReportName As String In _AllReportName.Split(",")
                    With New HI.RP.Report
                        ...
                        .Formular = _FN
                        .AddParameter("RcvDate", Me.FDSSIssueDate.Text)
                        .AddParameter("RcvDateTo", Me.FDEIssueDateTo.Text)
