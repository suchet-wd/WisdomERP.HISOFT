...
#Region "Property"
    ...
    Public _AccidentId As Integer
    Private Property AccidentId As Integer
        Get
            Return _AccidentId
        End Get
...
#End Region
    ...
    Private Sub LoadDataDrug()
        Try
            ...
            _Cmd &= vbCrLf & "WHERE  P.FNHSysMECGenId=" & Integer.Parse(AccidentId)
    ...
    Private Function AddDrug(ByVal _DrugId As Integer, ByVal _IssQty As Double) As Boolean
        Try
            ...
            For Each R As DataRow In _oDt.Rows
                If _IssBal > Double.Parse(R!FNQuantity.ToString) Then
                    _IssCut = Double.Parse(R!FNQuantity.ToString)
                Else
                    _IssCut = _IssBal
                End If
                _Cmd = "Delete From [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MEDC) & "].dbo.TMECTDrugPay WHERE FNHSysMECGenId=" & Integer.Parse(AccidentId)
                ...
                _Cmd &= vbCrLf & "," & Integer.Parse(AccidentId)
    ...
    Private Sub wAddAccident_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            Me.LoadDataDrug()
        Catch ex As Exception
