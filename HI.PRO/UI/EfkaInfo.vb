...
Public Class EfkaInfo
    ...
    Public Sub New(MachineNo As Integer, EfkaSerialNo As String, ByVal EfkaIP As String, Machine As String)
    ...
    Private Sub FTDate_TextChanged(sender As Object, e As EventArgs) Handles FTDate.TextChanged
        If FTDate.Text <> "" Then
            ...
            FTDate.Appearance.ForeColor = Drawing.Color.Green
            FTTime.Appearance.ForeColor = Drawing.Color.Green
            FTTimeSewing.Appearance.ForeColor = Drawing.Color.Green
            FTTotalStitch.Appearance.ForeColor = Drawing.Color.Green
            FTAvgSpeed.Appearance.ForeColor = Drawing.Color.Green
            FTRuntime.Appearance.ForeColor = Drawing.Color.Green
            FTStop.Appearance.ForeColor = Drawing.Color.Green
        ...
        Else
            ...
            FTDate.Appearance.ForeColor = Drawing.Color.FromArgb(192, 0, 0)
            FTTime.Appearance.ForeColor = Drawing.Color.FromArgb(192, 0, 0)
            FTTimeSewing.Appearance.ForeColor = Drawing.Color.FromArgb(192, 0, 0)
            FTTotalStitch.Appearance.ForeColor = Drawing.Color.FromArgb(192, 0, 0)
            FTAvgSpeed.Appearance.ForeColor = Drawing.Color.FromArgb(192, 0, 0)
            FTRuntime.Appearance.ForeColor = Drawing.Color.FromArgb(192, 0, 0)
            FTStop.Appearance.ForeColor = Drawing.Color.FromArgb(192, 0, 0)
