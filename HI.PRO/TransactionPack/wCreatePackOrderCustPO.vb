...
Public Class wCreatePackOrderCustPO
    ...
    Private _GenPackOrder As wGeneratePackOrderCustPO
    ...
    Sub New()
        ...
        _GenPackOrder = New wGeneratePackOrderCustPO
    ...
    Private Sub LoadrderPackBreakDownCartonBefore(Key As Object, CartonNo As Integer)
        ...
        _Qry = "Exec [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.SP_Get_OrderPackBreakDown_Carton_Before '" & HI.UL.ULF.rpQuoted(Key.ToString) & "'," & CartonNo & " "
        _dt = HI.Conn.SQLConn.GetDataTable(_Qry, Conn.DB.DataBaseName.DB_PROD)
        'With _dt
        '    .Columns.Add("FTNikePOLineItem", GetType(String))
        'End With
    ...
    Private Sub LoadrderPackBreakDownCartonWeight(Key As Object, CartonNo As Integer)
        ...
        _Qry = "Exec [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.SP_Get_OrderPackBreakDown_Carton_Weight '" & HI.UL.ULF.rpQuoted(Key.ToString) & "'," & CartonNo & " "
        _dt = HI.Conn.SQLConn.GetDataTable(_Qry, Conn.DB.DataBaseName.DB_PROD)
    ...
    Private Sub LoadrderPackBreakDownCartonTotalWeight(Key As Object, CartonNo As Integer)
        ...
        _Qry = "Exec [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.SP_Get_OrderPackBreakDown_Carton_TotalWeight '" & HI.UL.ULF.rpQuoted(Key.ToString) & "'," & CartonNo & " "
        _dt = HI.Conn.SQLConn.GetDataTable(_Qry, Conn.DB.DataBaseName.DB_PROD)
        _dtpack = _dt.Copy
        'With _dt
        '    .Columns.Add("FTNikePOLineItem", GetType(String))
...
#Region "Procedure"
    ...
    Private Sub LoadOrderPackBreakDown(Key As Object)
        ...
        _Qry = "Exec [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.SP_Get_OrderPackBreakDown_CustPO '" & HI.UL.ULF.rpQuoted(Key.ToString) & "' "
        _dt = HI.Conn.SQLConn.GetDataTable(_Qry, Conn.DB.DataBaseName.DB_PROD)
        'With _dt
        '    .Columns.Add("FTNikePOLineItem", GetType(String))
        'End With
    ...
    Private Sub LoadOrderPackBreakDownWeight(Key As Object)
        ...
        _Qry = "Exec [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.SP_Get_OrderPackBreakDownWeight_CustPO '" & HI.UL.ULF.rpQuoted(Key.ToString) & "' "
        _dt = HI.Conn.SQLConn.GetDataTable(_Qry, Conn.DB.DataBaseName.DB_PROD)
        'With _dt
        '    .Columns.Add("FTNikePOLineItem", GetType(String))
        'End With
...
#Region " Proc "
    ...
    Private Sub LoadOrderPackSubBreakDown(SubOrderNo As Object)
        ...
        _Qry = "Exec [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.SP_Get_OrderPackSubBreakDown_CustPO '" & HI.UL.ULF.rpQuoted(Me.FTPackNo.Text) & "','" & HI.UL.ULF.rpQuoted(SubOrderNo.ToString) & "' "
        _dt = HI.Conn.SQLConn.GetDataTable(_Qry, Conn.DB.DataBaseName.DB_PROD)
...
#End Region
    ...
    Private Sub ocmaddsuborder_Click(sender As Object, e As EventArgs) Handles ocmaddsuborder.Click
        ...
        Else
            ...
            'Dim _pack As DataTable
            'With DirectCast(Me.ogcsubpackdetail.DataSource, DataTable)
            '    .AcceptChanges()
            '    _pack = .Copy
                ...
                If (_hifo.Node IsNot Nothing) Then
                    With _hifo.Node
                        ...
                        If Convert.ToBoolean(.Tag) = False Then
                            ...
                            _Qry = "  SELECT SUM(A.FNQuantity * B.FNWeight) AS FNNeteight"
                            ...
                            FNNW.Value = Val(HI.Conn.SQLConn.GetField(_Qry, Conn.DB.DataBaseName.DB_PROD, "0"))
                            FNNNW.Value = FNNW.Value
    ...
    Private Sub otlpack_FocusedNodeChanged(sender As Object, e As FocusedNodeChangedEventArgs) Handles otlpack.FocusedNodeChanged
    End Sub
