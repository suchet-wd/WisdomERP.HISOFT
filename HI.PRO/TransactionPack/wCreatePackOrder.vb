...
#Region "Procedure"
    ...
    Private Sub LoadOrderPackBreakDown(Key As Object)
        ...
        '_dt.BeginInit()
        'For Each R As DataRow In _dt.Rows
        '    R!FTNikePOLineItem = GetFTNikePOLineItem(_SubOrderNo, R!FTColorway.ToString)
        'Next
        '_dt.EndInit()
    ...
    Private Sub LoadOrderPackBreakDownWeight(Key As Object)
        ...
        _Qry = "Exec [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.SP_Get_OrderPackBreakDownWeight '" & HI.UL.ULF.rpQuoted(Key.ToString) & "' "
        _dt = HI.Conn.SQLConn.GetDataTable(_Qry, Conn.DB.DataBaseName.DB_PROD)
        'With _dt
        '    .Columns.Add("FTNikePOLineItem", GetType(String))
        'End With
...
#End Region
    ...
    Private Sub FTBarcodeSetNo_EditValueChanged(sender As Object, e As EventArgs) Handles FTBarcodeSetNo.EditValueChanged
