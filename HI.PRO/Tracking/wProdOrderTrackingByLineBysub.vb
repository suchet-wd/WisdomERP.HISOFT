...
Public Class wProdOrderTrackingByLineBysub
...
#Region "Procedure"
    ...
    Private Sub LoaddataDetailColorSizeByLine()
        ...
        Try
            ...
            _Qry &= vbCrLf & "   [FNScanQuantity] [Int] NULL,               "
            _Qry &= vbCrLf & "  [FTPOLineItemNo] [nvarchar](30) NULL,"
            _Qry &= vbCrLf & " [FTBarcodeNo] [nvarchar](30) NULL, [FTSubOrderNo]  [nvarchar](30) NULL,"
            _Qry &= vbCrLf & "   ) CREATE INDEX [IDX_TmpSewOut] ON #TabDataSewOut([FTOrderNo],[FTSubOrderNo],[FTUnitSectCode],[FTColorway],[FTSizeBreakDown],[FTPOLineItemNo])"
            ...
            '----------Start Sew Out
            _Qry &= vbCrLf & "   INSERT INTO #TabDataSewOut (FTOrderNo, FTUnitSectCode, FTColorway, FTSizeBreakDown, FNScanQuantity, FTPOLineItemNo, FTBarcodeNo , FTSubOrderNo )"
            _Qry &= vbCrLf & "  Select   FTOrderNo,FTUnitSectCode, FTColorway, FTSizeBreakDown ,sum( FNScanQuantity) As FNScanQuantity ,FTPOLineItemNo ,FTBarcodeNo  ,FTSubOrderNo   From ( "

            _Qry &= vbCrLf & "   SELECT P.FTOrderNo,US.FTUnitSectCode,B.FTColorway,B.FTSizeBreakDown, SUM(SC.FNQuantity) AS FNScanQuantity , B.FTPOLineItemNo  , SC.FTBarcodeNo , sc.FTSubOrderNo"
            ...
            _Qry &= vbCrLf & "   GROUP BY P.FTOrderNo,US.FTUnitSectCode,B.FTColorway,B.FTSizeBreakDown , B.FTPOLineItemNo , SC.FTBarcodeNo, sc.FTSubOrderNo) AS T "
            _Qry &= vbCrLf & "  GROUP BY FTOrderNo,FTUnitSectCode,FTColorway,FTSizeBreakDown , FTPOLineItemNo ,FTBarcodeNo,FTSubOrderNo  "
            ...
            _Qry &= vbCrLf & ",(ISNULL(BM.FNQuantityScan,0)-ISNULL(BM.FNQuantityPack,0) ) AS FNBalPackQuantity , bm.FTSubOrderNo"
            ...
            _Qry &= vbCrLf & "   ,ISNULL(PAC.FNQuantity,0) AS FNQuantityPack  ,Cut.FTPOLineItemNo , SewOut.FTSubOrderNo "
            _Qry &= vbCrLf & "      FROM"
            _Qry &= vbCrLf & "   ("
            ...
            _Qry &= vbCrLf & "    LEFT OUTER JOIN ("
            _Qry &= vbCrLf & "  SELECT sc.FTSubOrderNo, SC.FTOrderNo,SC.FTColorway,SC.FTSizeBreakDown, SUM(SC.FNScanQuantity) AS FNQuantity , B.FTPOLineItemNo , SC.FTBarcodeNo"
            ...
            _Qry &= vbCrLf & "   GROUP BY sc.FTSubOrderNo, SC.FTOrderNo,SC.FTColorway,SC.FTSizeBreakDown , B.FTPOLineItemNo , SC.FTBarcodeNo  "
    ...
    Private Sub InitialGridMergCell()
        For Each c As GridColumn In ogvdetailcolorsizelineg.Columns
            Select Case c.FieldName.ToString
                Case "FTStyleCode", "FTPORef", "FTOrderNo", "FTSubOrderNo", "FTCmpCode", "FTCmpName", "FDShipDate", "FTColorway", "FTSizeBreakDown",
