...
Public Class wCMScanBarcodeOperationRcv
...
#Region "Procedure"
    ...
    Private Sub LoadDucumentDetail(Key As String)
        ...
        Try
            ...
            _Qry &= vbCrLf & " 	INNER JOIN  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTCMBarcodeScanRcv_Detail  AS B  WITH(NOLOCK) "
    ...
    Private Function DeleteData() As Boolean
        Try
            ...
            Dim _Str As String
            _Str = "Delete From  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTCMBarcodeScanRcv WHERE FTCMDocScanNo='" & HI.UL.ULF.rpQuoted(Me.FTCMDocScanNo.Text) & "'"
            ...
            _Str = "Delete From  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTCMBarcodeScanRcv_Detail WHERE FTCMDocScanNo='" & HI.UL.ULF.rpQuoted(Me.FTCMDocScanNo.Text) & "'"
            ...
            HI.Auditor.CreateLog.CreateLogDelete(HI.ST.SysInfo.MenuName, Me.Name, "Delete From  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTCMBarcodeScanRcv WHERE FTCMDocScanNo='" & HI.UL.ULF.rpQuoted(Me.FTCMDocScanNo.Text) & "'")
...
#Region " Proc "
    ...
    Private Function SaveBarcode(Key As String) As Boolean
        ...
        Try
            ...
            _Str &= vbCrLf & " FROM  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTCMBarcodeScanRcv_Detail WITH(NOLOCK)"
            ...
            If _StateNew Then
                ...
                _Str = " INSERT INTO [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTCMBarcodeScanRcv_Detail("
            ...
            Else
                ...
                _Str = " UPDATE [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTCMBarcodeScanRcv_Detail "
    ...
    Private Function DeleteBarcode(BarcodeKey As String, _Operation As Integer) As Boolean
        ...
        Try
            ...
            _Str = " DELETE  FROM  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTCMBarcodeScanRcv_Detail"
            _Str &= vbCrLf & "   WHERE FTCMDocScanNo='" & HI.UL.ULF.rpQuoted(FTCMDocScanNo.Text) & "' "
            _Str &= vbCrLf & "  AND FTBarcodeNo='" & HI.UL.ULF.rpQuoted(_BarCode) & "' "
    ...
    Private Sub LoadBarcodeInfo(Key As String)
        ...
        Try
            ...
            _Qry &= vbCrLf & "  FROM [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTCMBarcodeScanRcv_Detail WITH (NOLOCK)  "
