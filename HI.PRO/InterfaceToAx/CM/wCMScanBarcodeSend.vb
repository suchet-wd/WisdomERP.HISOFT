...
Public Class wCMScanBarcodeSend
    ...
    Private Sub LoadDucumentDetail()
        Try
            ...
            If Me.FNHSysCmpIdTo.Text <> "" Then
                ...
                _Qry &= vbCrLf & "And B.FNHSysUnitSectId=" & Val(Me.FNHSysCmpIdTo.Properties.Tag.ToString()) & ""
            End If
...
#End Region
    ...
    Private Function VerrifyData() As Boolean
        Try
            ...
            End If
            If Me.FNHSysCmpIdTo.Text = "" Then
                HI.MG.ShowMsg.mInvalidData(MG.ShowMsg.InvalidType.SelectData, Me.FNHSysCmpIdTo_lbl.Text)
    ...
    Private Function ChkBreakTime() As Boolean
        Try
            ...
            _Cmd = "  EXEC  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.SP_GET_CHECKTIME_SCANOUTLINE " & Integer.Parse(Me.FNHSysCmpIdTo.Properties.Tag.ToString) & ""
    ...
    Private Function ChkBarCode() As Boolean
        Try
            ...
            If Not (Me.FTStateDeleteBarcode.Checked) Then
                ...
                _Cmd &= vbCrLf & "          AND (A.FNHSysUnitSectId=" & Integer.Parse(Val(FNHSysCmpIdTo.Properties.Tag.ToString)) & ")"
            ...
            Else
                ...
                _Cmd &= vbCrLf & "And O.FNHSysUnitSectId=" & Integer.Parse(Me.FNHSysCmpIdTo.Properties.Tag)
    ...
    Private Function ScansBarcode(BarcodeKey As String) As Boolean
        Try
            ...
            If Not (Me.FTStateDeleteBarcode.Checked) Then
                ...
                If Not (ChkBarcodeInlineBal(BarcodeKey, Me.FTOrderNo.Text, FNHSysCmpIdTo.Properties.Tag)) Then
            ...
            If Not (Me.FTStateDeleteBarcode.Checked) Then
                ...
                _Cmd &= vbCrLf & "And FNHSysUnitSectId=" & Integer.Parse(Me.FNHSysCmpIdTo.Properties.Tag)
                ...
                If HI.Conn.SQLConn.Execute_Tran(_Cmd, HI.Conn.SQLConn.Cmd, HI.Conn.SQLConn.Tran) <= 0 Then
                    ...
                    _Cmd &= vbCrLf & "," & Integer.Parse(Me.FNHSysCmpIdTo.Properties.Tag)
                    _Cmd &= vbCrLf & "," & HI.UL.ULDate.FormatDateDB
    ...
    Private Function checkcalsinc(BarcodeKey As String, sqlcmd As System.Data.SqlClient.SqlCommand, Tr As System.Data.SqlClient.SqlTransaction) As Boolean
        Try
            ...
            _Cmd &= vbCrLf & " where  FNHSysUnitSectId=" & Integer.Parse(Me.FNHSysCmpIdTo.Properties.Tag)
