...
#End Region
    ...
    Private Sub LoadData()
        Try
            Dim _Cmd As String = ""
            _Cmd = "Exec  dbo.getloadSizeBreakDownSetWeight '" & HI.UL.ULF.rpQuoted(Me.FNHSysStyleId.Text) & "' , '" & HI.UL.ULF.rpQuoted(Me.FNHSysStyleIdTo.Text) & "'"
