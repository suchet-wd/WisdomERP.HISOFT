...
Public Class wEditScanQuantity_LA

    Private _AddNewData As wEditScanQuantityAddOrder_LA
    ...
    Sub New()
        ...
        _AddNewData = New wEditScanQuantityAddOrder_LA
...
#Region " Procedure "
    ...
    Private Function ImportData() As Boolean
        ...
        Try
            ...
            For Each R As DataRow In _dt.Select("FTSelect='1' and FTUnitSectCode<>''", "FDScanDate,FTUnitSectCode")
            ...
            For Each R As DataRow In _dt.Select("FTSelect='1' and FTEmpCode<>''", "FDScanDate,FTEmpCode")


                _Cmd = " INSERT INTO [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTOrderAddEditScanQuantity_Single "
                _Cmd &= vbCrLf & "  ("
                _Cmd &= vbCrLf & " FTInsUser, FDInsDate, FTInsTime, FNHSysEmpId, FTDate, FTOrderNo, FTSubOrderNo, FNHSysCmpId,FNStateSewPack,FNHSysPartId,FTSemiPart "
                _Cmd &= vbCrLf & " ) "
                _Cmd &= vbCrLf & " SELECT '" & HI.UL.ULF.rpQuoted(HI.ST.UserInfo.UserName) & "'"
                _Cmd &= vbCrLf & ", " & HI.UL.ULDate.FormatDateDB & ""
                _Cmd &= vbCrLf & "," & HI.UL.ULDate.FormatTimeDB & ""
                _Cmd &= vbCrLf & "," & Val(R!FNHSysEmpId.ToString) & " "
                _Cmd &= vbCrLf & ",'" & HI.UL.ULDate.ConvertEnDB(R!FDScanDateOrg.ToString) & "'"
                _Cmd &= vbCrLf & ",'" & HI.UL.ULF.rpQuoted(R!FTOrderNo.ToString) & "'"
                _Cmd &= vbCrLf & ",'" & HI.UL.ULF.rpQuoted(R!FTSubOrderNo.ToString) & "'"
                _Cmd &= vbCrLf & "," & Val(HI.ST.SysInfo.CmpID) & " "
                ...
                If HI.Conn.SQLConn.ExecuteNonQuery(_Cmd, Conn.DB.DataBaseName.DB_PROD) = False Then
                    ...
                    _Cmd = " UPDATE [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTOrderAddEditScanQuantity_Single "
                    _Cmd &= vbCrLf & " SET FTUpdUser='" & HI.UL.ULF.rpQuoted(HI.ST.UserInfo.UserName) & "', FDUpdDate=" & HI.UL.ULDate.FormatDateDB & ", FTUpdTime=" & HI.UL.ULDate.FormatTimeDB & ",FNHSysCmpId=" & Val(HI.ST.SysInfo.CmpID) & " "
                ...
                _Cmd = "Update [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTEditScanQuantity_Single"
                _Cmd &= vbCrLf & " SET FTUpdUser='" & HI.UL.ULF.rpQuoted(HI.ST.UserInfo.UserName) & "'"
                _Cmd &= vbCrLf & ", FDUpdDate=" & HI.UL.ULDate.FormatDateDB & ""
                _Cmd &= vbCrLf & ", FTUpdTime=" & HI.UL.ULDate.FormatTimeDB & ""
                _Cmd &= vbCrLf & ", FNHour01Qty=" & Integer.Parse(Val(R!H01.ToString)) & ""
                ...
                _Cmd &= vbCrLf & ", FNTotalQty=" & Integer.Parse(Val(R!Total.ToString)) & ""
                _Cmd &= vbCrLf & " WHERE  FTDate='" & HI.UL.ULDate.ConvertEnDB(R!FDScanDateOrg.ToString) & "'"
                _Cmd &= vbCrLf & "        AND FNHSysEmpId=" & Integer.Parse(Val(R!FNHSysEmpId.ToString)) & ""
                _Cmd &= vbCrLf & "        AND FTOrderNo='" & HI.UL.ULF.rpQuoted(R!FTOrderNo.ToString) & "' "
                _Cmd &= vbCrLf & "        AND FTSubOrderNo='" & HI.UL.ULF.rpQuoted(R!FTSubOrderNo.ToString) & "'"
                _Cmd &= vbCrLf & "        AND FNStateSewPack=" & Val(R!FNStateSewPack.ToString) & ""
                _Cmd &= vbCrLf & " AND FNHSysPartId=" & Integer.Parse(Val(R!FNHSysPartId.ToString))
                ...
                If HI.Conn.SQLConn.ExecuteNonQuery(_Cmd, Conn.DB.DataBaseName.DB_PROD) = False Then
                    ...
                    _Cmd = "INSERT INTO [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTEditScanQuantity_Single("
                    _Cmd &= vbCrLf & " FTInsUser, FDInsDate, FTInsTime"
                    _Cmd &= vbCrLf & ", FTDate, FNHSysEmpId, FTOrderNo, FTSubOrderNo"
                    _Cmd &= vbCrLf & ", FNHour01Qty, FNHour02Qty, FNHour03Qty, FNHour04Qty, FNHour05Qty "
                    _Cmd &= vbCrLf & ", FNHour06Qty, FNHour07Qty, FNHour08Qty, FNHour09Qty, FNHour10Qty"
                    _Cmd &= vbCrLf & ", FNHour11Qty, FNHour12Qty, FNHour13Qty, FNTotalQty,FNStateSewPack,FNHSysPartId,FTSemiPart "
                    _Cmd &= vbCrLf & " ) "
                    ...
                    _Cmd &= vbCrLf & ", " & HI.UL.ULDate.FormatTimeDB & ""
                    _Cmd &= vbCrLf & ",'" & HI.UL.ULDate.ConvertEnDB(R!FDScanDateOrg.ToString) & "'"
                    _Cmd &= vbCrLf & "," & Integer.Parse(Val(R!FNHSysEmpId.ToString)) & ""
                    _Cmd &= vbCrLf & ",'" & HI.UL.ULF.rpQuoted(R!FTOrderNo.ToString) & "' "
                    _Cmd &= vbCrLf & ",'" & HI.UL.ULF.rpQuoted(R!FTSubOrderNo.ToString) & "'"
                    _Cmd &= vbCrLf & ", " & Integer.Parse(Val(R!H01.ToString)) & ""
                    _Cmd &= vbCrLf & ", " & Integer.Parse(Val(R!H02.ToString)) & ""
    ...
    Private Function SaveData(Spls As HI.TL.SplashScreen) As Boolean
        ...
        Try
            ...
            For Each R As DataRow In _dt.Select("FTSelect='1' and FTEmpCode=''", "FDScanDate,FTUnitSectCode")
    ...
    Private Function DeleteData(Spls As HI.TL.SplashScreen) As Boolean
        ...
        Try
            ...
            For Each R As DataRow In _dt.Select("FTSelect='1' and FTEmpCode<>'' ", "FDScanDate,FTUnitSectCode")
                ...
                _Cmd = "DELETE FROM  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTEditScanQuantity_Single"
                _Cmd &= vbCrLf & " WHERE  FTDate='" & HI.UL.ULDate.ConvertEnDB(R!FDScanDateOrg.ToString) & "'"
                _Cmd &= vbCrLf & "        AND FNHSysEmpId=" & Integer.Parse(Val(R!FNHSysEmpId.ToString)) & ""
                _Cmd &= vbCrLf & "        AND FTOrderNo='" & HI.UL.ULF.rpQuoted(R!FTOrderNo.ToString) & "' "
                _Cmd &= vbCrLf & "        AND FTSubOrderNo='" & HI.UL.ULF.rpQuoted(R!FTSubOrderNo.ToString) & "'"
                ...
                _Cmd = "DELETE FROM  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTOrderAddEditScanQuantity_Single"
                _Cmd &= vbCrLf & " WHERE  FTDate='" & HI.UL.ULDate.ConvertEnDB(R!FDScanDateOrg.ToString) & "'"
                _Cmd &= vbCrLf & "        AND FNHSysEmpId=" & Integer.Parse(Val(R!FNHSysEmpId.ToString)) & ""
                _Cmd &= vbCrLf & "        AND FTOrderNo='" & HI.UL.ULF.rpQuoted(R!FTOrderNo.ToString) & "' "
                _Cmd &= vbCrLf & "        AND FTSubOrderNo='" & HI.UL.ULF.rpQuoted(R!FTSubOrderNo.ToString) & "'"
    ...
    End Function
    Private Sub LoadDataInfo(ByVal _FDDateStart As String, Optional _RouteState As Integer = 99)
        Me.ogc.DataSource = Nothing
        ochkselectall.Checked = False
        ...
        If Val(Me.FNHSysCmpId.Properties.Tag) = 1410220001 Then

            ''  MsgBox("b")

            Dim _n As Integer = 99
            If _RouteState = 99 Then
                _n = FNStateSewPackIron.SelectedIndex
            Else
                _n = _RouteState
            End If
            ...
            Select Case _n
                Case 0, 1, 3
                    ...
                    For Each Rx As DataRow In dtline.Rows
                        ...
                        _Qry = "Exec [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.SP_GET_SCANOUTLINE_EDIT_SCANQUANTITY_LOAD " & Val(Rx!FNHSysUnitSectId.ToString) & ",'" & HI.UL.ULDate.ConvertEnDB(_FDDateStart) & "','" & HI.UL.ULDate.ConvertEnDB(_FDDateStart) & "' "
                ...
                Case 2
                    ...
                    '' MsgBox("e")
                    ''SELECT BY   Employeee   Pack
                    Dim _TotalEmp As Integer = 0
                    Dim _ListEmp As Integer = 0

                    Dim dtEmp As New DataTable

                    _Qry = "SELECT  X.FNHSysEmpId, FTEmpCode, ET.FTEmpTypeNameTH, ET.FTEmpTypeNameEN "
                    _Qry &= vbCrLf & " FROM  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_HR) & "].dbo.THRMEmployee AS X WITH(NOLOCK)"
                    _Qry &= vbCrLf & " LEFT JOIN   [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MASTER) & "].dbo.THRMEmpType ET ON X.FNHSysEmpTypeId = ET.FNHSysEmpTypeId "
                    _Qry &= vbCrLf & "  WHERE (ET.FTEmpTypeCode in ('sp')) AND (ET.FTStateActive = '1') AND  (ISNULL(FDDateEnd,'') ='' OR ISNULL(FDDateEnd,'') >= Convert(varchar(10),DateAdd(day,-800,Getdate()),111 ) ) "

                    If FNHSysEmpId.Text <> "" Then
                        _Qry &= vbCrLf & "  AND FTEmpCode >='" & HI.UL.ULF.rpQuoted(FNHSysEmpId.Text) & "'"
                    End If

                    If FNHSysEmpIdTo.Text <> "" Then
                        _Qry &= vbCrLf & "  AND FTEmpCode <='" & HI.UL.ULF.rpQuoted(FNHSysEmpIdTo.Text) & "'"
                    End If

                    If FNHSysCmpId.Text <> "" Then
                        _Qry &= vbCrLf & "  AND X.FNHSysCmpId =" & Val("" & Me.FNHSysCmpId.Properties.Tag.ToString)
                    End If
                    _Qry &= vbCrLf & "  OR X.FNHSysEmpID in ( "
                    _Qry &= vbCrLf & "  SELECT FNHSysEmpID "
                    _Qry &= vbCrLf & "    FROM HITECH_PRODUCTION.dbo.TPRODTMoveTeamMoveType  MV "
                    _Qry &= vbCrLf & "  WHERE   FNHSysEmpTypeIdTo=2012610367  "
                    _Qry &= vbCrLf & "  AND (ISNULL(FDDate,'') ='' OR ISNULL(FDDate,'') >= Convert(varchar(10),DateAdd(day,-800,Getdate()),111 ) ) ) "

                    _Qry &= vbCrLf & "  ORDER BY FTEmpCode "
                    dtEmp = HI.Conn.SQLConn.GetDataTable(_Qry, Conn.DB.DataBaseName.DB_MASTER)
                    _TotalEmp = dtEmp.Rows.Count

                    '' MsgBox("f")
                    For Each Rx As DataRow In dtEmp.Rows
                        _ListEmp = _ListEmp + 1

                        _Spls.UpdateInformation("Loading Data of Line " & Rx!FTEmpCode.ToString & "  ( " & _ListEmp.ToString & " of  " & _TotalEmp.ToString & " )")

                        _Qry = "Exec [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.SP_GET_SCANOUTLINE_EDIT_SCANQUANTITY_LOAD_EMP " & Val(Rx!FNHSysEmpId.ToString) & ",'" & HI.UL.ULDate.ConvertEnDB(_FDDateStart) & "','" & HI.UL.ULDate.ConvertEnDB(_FDDateStart) & "' ,'TH'," & _n
                        dt = HI.Conn.SQLConn.GetDataTable(_Qry, Conn.DB.DataBaseName.DB_HR)
                ...
                Case 4
                    ...
                    _Qry &= vbCrLf & " FROM  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_HR) & "].dbo.THRMEmployee AS X WITH(NOLOCK)"
                    _Qry &= vbCrLf & " LEFT JOIN   [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MASTER) & "].dbo.THRMEmpType ET ON X.FNHSysEmpTypeId = ET.FNHSysEmpTypeId "
                    _Qry &= vbCrLf & "  WHERE (ET.FTEmpTypeCode in ('si')) AND (ET.FTStateActive = '1') AND  (ISNULL(FDDateEnd,'') ='' OR ISNULL(FDDateEnd,'') >= Convert(varchar(10),DateAdd(day,-800,Getdate()),111 ) )"
                    ...
                    _Qry &= vbCrLf & "  SELECT FNHSysEmpID "
                    _Qry &= vbCrLf & "    FROM HITECH_PRODUCTION.dbo.TPRODTMoveTeamMoveType  MV "
                    _Qry &= vbCrLf & "  WHERE   FNHSysEmpTypeIdTo=2012610366  "
                    _Qry &= vbCrLf & "  AND (ISNULL(FDDate,'') ='' OR ISNULL(FDDate,'') >= Convert(varchar(10),DateAdd(day,-800,Getdate()),111 ) ) ) "
        ...
        Else
            ...
            For Each Rx As DataRow In dtline.Rows
                ...
                _Qry = "Exec [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.SP_GET_SCANOUTLINE_EDIT_SCANQUANTITY " & Val(Rx!FNHSysUnitSectId.ToString) & ",'" & HI.UL.ULDate.ConvertEnDB(_FDDateStart) & "','" & HI.UL.ULDate.ConvertEnDB(_FDDateStart) & "' "
                dt = HI.Conn.SQLConn.GetDataTable(_Qry, Conn.DB.DataBaseName.DB_HR)
...
#Region "General"
    ...
    Private Sub ocmload_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ocmload.Click
        If HI.UL.ULDate.CheckDate(FTStartDate.Text) <> "" Then
            ...
            Call LoadDataInfo(FTStartDate.Text)
...
#End Region
    ...
    Private Sub ocmadd_Click(sender As Object, e As EventArgs) Handles ocmadd.Click
        If FTStartDate.Text <> "" Then
            With _AddNewData
                ...
                .FNStateSewPackIron.SelectedIndex = 0
                .ShowDialog()
    ...
    Private Sub ocmimport_Click(sender As Object, e As EventArgs) Handles ocmimportexcel.Click
            ...
            With folderDlg
                ...
                If (dr = System.Windows.Forms.DialogResult.OK) Then
                    ...
                    For Each file In .FileNames
                        ' _FileName = .FileName
                        ''  MsgBox("a")
                        Call ReadXlsfile_Multiple(file)
                        ''  MsgBox("z")
                    Next
                    '_Spls.Close()
                End If
        ...
        End Try
    End Sub
    Private Sub ReadXlsfile_Multiple(_fileName As String)
        Try
            ...
            If (_dt.Rows.Count > 1) Then
                ...
                Dim _ST_Route As String = ""
                'checkType = "Team"
                'checkType = "Employee"

                For Each dr As DataRow In _dt.Rows
                    If dr!F2.ToString() Like "##/##/####" Then
                        'seems to be in "dd.mm.yyyy" format (but could be "mm.dd.yyyy" format, or be "99.99.9999")
                        checkType = "Team"
                        _FTStartDate = dr!F2.ToString()
                        _ST_Route = dr!F6.ToString()
                    Else

                        _FTStartDate = dr!F4.ToString()
                        _ST_Route = dr!F8.ToString()
                    End If
                    Exit For
                Next


                If checkType = "Team" Then
                    ...
                    Using con As New SqlConnection(HI.Conn.DB.ConnectionString(Conn.DB.DataBaseName.DB_PROD))
                        Using sqlBulkCopy As New SqlBulkCopy(con)
                            ...
                            ''sqlBulkCopy.ColumnMappings.Add("F3", "FTStyle")
                            sqlBulkCopy.ColumnMappings.Add("F4", "FTOrderNo")
                            sqlBulkCopy.ColumnMappings.Add("F5", "FTSubOrderNo")
                            sqlBulkCopy.ColumnMappings.Add("F6", "FTStateSewPack_txt")

                            sqlBulkCopy.ColumnMappings.Add("F7", "FTSemiPart")



                            sqlBulkCopy.ColumnMappings.Add("F8", "H01")
                            sqlBulkCopy.ColumnMappings.Add("F9", "H02")
                            sqlBulkCopy.ColumnMappings.Add("F10", "H03")
                            sqlBulkCopy.ColumnMappings.Add("F11", "H04")
                            sqlBulkCopy.ColumnMappings.Add("F12", "H05")
                            sqlBulkCopy.ColumnMappings.Add("F13", "H06")
                            sqlBulkCopy.ColumnMappings.Add("F14", "H07")
                            sqlBulkCopy.ColumnMappings.Add("F15", "H08")
                            sqlBulkCopy.ColumnMappings.Add("F16", "H09")
                            sqlBulkCopy.ColumnMappings.Add("F17", "H10")
                            sqlBulkCopy.ColumnMappings.Add("F18", "H11")
                            sqlBulkCopy.ColumnMappings.Add("F19", "H12")
                            sqlBulkCopy.ColumnMappings.Add("F20", "H13")
                            sqlBulkCopy.ColumnMappings.Add("F21", "Total")
                            ...
                            'sqlBulkCopy.ColumnMappings.Add("F7", "H01")
                            'sqlBulkCopy.ColumnMappings.Add("F8", "H02")
                            'sqlBulkCopy.ColumnMappings.Add("F9", "H03")
                            'sqlBulkCopy.ColumnMappings.Add("F10", "H04")
                            'sqlBulkCopy.ColumnMappings.Add("F11", "H05")
                            'sqlBulkCopy.ColumnMappings.Add("F12", "H06")
                            'sqlBulkCopy.ColumnMappings.Add("F13", "H07")
                            'sqlBulkCopy.ColumnMappings.Add("F14", "H08")
                            'sqlBulkCopy.ColumnMappings.Add("F15", "H09")
                            'sqlBulkCopy.ColumnMappings.Add("F16", "H10")
                            'sqlBulkCopy.ColumnMappings.Add("F17", "H11")
                            'sqlBulkCopy.ColumnMappings.Add("F18", "H12")
                            'sqlBulkCopy.ColumnMappings.Add("F19", "H13")
                            'sqlBulkCopy.ColumnMappings.Add("F20", "Total")
                            'sqlBulkCopy.ColumnMappings.Add("FTUser", "FTUser")
                ...
                Else
                    Using con As New SqlConnection(HI.Conn.DB.ConnectionString(Conn.DB.DataBaseName.DB_PROD))
                        Using sqlBulkCopy As New SqlBulkCopy(con)
                            ...
                            sqlBulkCopy.ColumnMappings.Add("F1", "FTEmpCode")
                            'sqlBulkCopy.ColumnMappings.Add("F2", "ชื่อพนักงาน")
                            'sqlBulkCopy.ColumnMappings.Add("F3", "นามสกุล")
                            sqlBulkCopy.ColumnMappings.Add("F4", "FDScanDate")
                            'sqlBulkCopy.ColumnMappings.Add("F5", "Style")
                            sqlBulkCopy.ColumnMappings.Add("F6", "FTOrderNo")
                            sqlBulkCopy.ColumnMappings.Add("F7", "FTSubOrderNo")
                            sqlBulkCopy.ColumnMappings.Add("F8", "FTStateSewPack_txt")
                            sqlBulkCopy.ColumnMappings.Add("F9", "H01")
                            sqlBulkCopy.ColumnMappings.Add("F10", "H02")
                            sqlBulkCopy.ColumnMappings.Add("F11", "H03")
                            sqlBulkCopy.ColumnMappings.Add("F12", "H04")
                            sqlBulkCopy.ColumnMappings.Add("F13", "H05")
                            sqlBulkCopy.ColumnMappings.Add("F14", "H06")
                            sqlBulkCopy.ColumnMappings.Add("F15", "H07")
                            sqlBulkCopy.ColumnMappings.Add("F16", "H08")
                            sqlBulkCopy.ColumnMappings.Add("F17", "H09")
                            sqlBulkCopy.ColumnMappings.Add("F18", "H10")
                            sqlBulkCopy.ColumnMappings.Add("F19", "H11")
                            sqlBulkCopy.ColumnMappings.Add("F20", "H12")
                            sqlBulkCopy.ColumnMappings.Add("F21", "H13")
                            sqlBulkCopy.ColumnMappings.Add("F22", "Total")
                            sqlBulkCopy.ColumnMappings.Add("FTUser", "FTUser")
                ...
                Dim _route As Integer = 0
                Select Case _ST_Route.ToUpper()
                    Case "SEW & PACK"
                        _route = 0
                    Case "SEW"
                        _route = 1
                ...
                If _FTStartDate <> "" Then
                    ...
                    Call LoadDataInfo(_FTStartDate, _route)
                    ''  MsgBox("4")
                End If
    ...
    Private Sub FNStateSewPackIron_SelectedIndexChanged(sender As Object, e As EventArgs) Handles FNStateSewPackIron.SelectedIndexChanged
        Try
            If Val(Me.FNHSysCmpId.Properties.Tag) = 1410220001 Then
                Dim _BrwID As Integer = 0
                Dim _BrwIDTo As Integer = 0

                Select Case FNStateSewPackIron.SelectedIndex
                    Case 0, 1, 3

                        FNHSysUnitSectId.Text = ""
                        FNHSysUnitSectIdTo.Text = ""

                        FNHSysUnitSectId_lbl.Visible = True
                        FNHSysUnitSectId.Visible = True
                        FNHSysUnitSectId_None.Visible = True
                        FNHSysUnitSectIdTo_lbl.Visible = True
                        FNHSysUnitSectIdTo.Visible = True
                        FNHSysUnitSectIdTo_None.Visible = True


                        FNHSysEmpId.Text = ""
                        FNHSysEmpIdTo.Text = ""

                        FNHSysEmpId_lbl.Visible = False
                        FNHSysEmpId.Visible = False
                        FNHSysEmpId_None.Visible = False
                        FNHSysEmpIdTo_lbl.Visible = False
                        FNHSysEmpIdTo.Visible = False
                        FNHSysEmpIdTo_None.Visible = False
                    Case 2
                        _BrwID = 1058
                        _BrwIDTo = 1063
                        Me.FNHSysEmpId.Properties.Buttons(0).Tag = _BrwID.ToString
                        Me.FNHSysEmpIdTo.Properties.Buttons(0).Tag = _BrwIDTo.ToString
                        FNHSysUnitSectId_lbl.Text = ""
                        FNHSysEmpIdTo.Text = ""

                        FNHSysUnitSectId_lbl.Visible = False
                        FNHSysUnitSectId.Visible = False
                        FNHSysUnitSectId_None.Visible = False
                        FNHSysUnitSectIdTo_lbl.Visible = False
                        FNHSysUnitSectIdTo.Visible = False
                        FNHSysUnitSectIdTo_None.Visible = False


                        FNHSysEmpId.Text = ""
                        FNHSysEmpIdTo.Text = ""

                        FNHSysEmpId_lbl.Visible = True
                        FNHSysEmpId.Visible = True
                        FNHSysEmpId_None.Visible = True
                        FNHSysEmpIdTo_lbl.Visible = True
                        FNHSysEmpIdTo.Visible = True
                        FNHSysEmpIdTo_None.Visible = True
                    Case 4
                        _BrwID = 1058
                        _BrwIDTo = 1063
