...
Public Class wProdIssueRequest
    ...
    Private _AddProdRequestItem As wProdIssueRequestAddItem
    ...
    Sub New()
        ...
        _AddProdRequestItem = New wProdIssueRequestAddItem
...
#Region "Procedure"
    ...
    Private Function AutoIssueAccessory() As Boolean
        ...
        Try
            ...
            _Qry = "SELECT TOP 1 FNHSysCmpId FROM [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MERCHAN) & "].dbo.TMERTOrder AS X WITH(NOLOCK) WHERE  FTOrderNo='" & HI.UL.ULF.rpQuoted(FTOrderNo.Text) & "' "
                ...
                Try
                    ...
                    For Each R As DataRow In _dtwh.Rows
                        ...
                        For Each Rx As DataRow In _dt.Select("FNReqQuantity>0")
                            ...
                            _Qry &= vbCrLf & "    AND BI.FTOrderNo = N'" & HI.UL.ULF.rpQuoted(Me.FTOrderNo.Text) & "'"
