Public Class wEditScanQuantityAddOrder_LA
    ...
    Private Function AddOrder() As Boolean
        ...
        Try
            ...
            _Cmd &= vbCrLf & "        AND FNStateSewPack='" & FNStateSewPackIron.SelectedIndex & "'"
            ...
            If HI.Conn.SQLConn.Execute_Tran(_Cmd, HI.Conn.SQLConn.Cmd, HI.Conn.SQLConn.Tran) <= 0 Then
                ...
                _Cmd &= vbCrLf & "," & Val(FNStateSewPackIron.SelectedIndex) & " "
                Try
    ...
    Private Sub FNStateSewPack_EditValueChanged(sender As Object, e As EventArgs) Handles FNStateSewPackIron.EditValueChanged
        Try

            Me.FNHSysPartId.Enabled = Me.FNStateSewPackIron.SelectedIndex = 3
            Me.FTSemiPart.Enabled = Me.FNStateSewPackIron.SelectedIndex = 3
        Catch ex As Exception
