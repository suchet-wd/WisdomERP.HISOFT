Public Class wProdIssueRequestAddItem
...
#Region "Procudure"
    Private Sub LoadTable()
        ...
        _Qry &= vbCrLf & " FROM  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTOrderProd_TableCut AS B WITH(NOLOCK) INNER JOIN"
...
#End Region
    ...
    Private Sub ocmload_Click(sender As Object, e As EventArgs) Handles ocmload.Click
        ...
        With CType(Me.ogctablebound.DataSource, DataTable)
            ...
            Try
                ...
                _Qry = " EXEC [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "]..SP_GETPROD_REQ_ISSUE " & HI.ST.SysInfo.CmpID & "," & Integer.Parse(HI.ST.Lang.Language) & ",'" & HI.UL.ULF.rpQuoted(HI.ST.UserInfo.UserName) & "','" & HI.UL.ULF.rpQuoted(Me.DocumentNo) & "'," & Me.Mattype & ""
                _dt = HI.Conn.SQLConn.GetDataTable(_Qry, Conn.DB.DataBaseName.DB_PROD)
    ...
    Private Sub CalculateFabric(Spls As HI.TL.SplashScreen)
        Try
            ...
            _Qry &= vbCrLf & "        [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTOrderProd_TableCut AS B WITH(NOLOCK) ON A.FTOrderProdNo = B.FTOrderProdNo "
            ...
            For Each Ritem As DataRow In _dtitem.Rows
                ...
                _Qry = " EXEC [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.SP_GETPROD_REQ_RAWMAT_FABRIC " & HI.ST.SysInfo.CmpID & ",'" & HI.UL.ULF.rpQuoted(Me.OrderNo) & "'," & Val(Ritem!FNHSysRawMatId) & ""
