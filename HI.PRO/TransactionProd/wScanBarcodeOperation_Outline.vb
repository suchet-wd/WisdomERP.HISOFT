...
Public Class wScanBarcodeOperation_Outline
...
#Region "Procedure"
    ...
    Private Sub LoadDucumentDetail(Key As String)
        ...
        Try
            ...
            _Qry &= vbCrLf & " 	INNER JOIN  [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODBarcodeScan_Outline_Detail  AS B  WITH(NOLOCK) "
    ...
    Private Function DeleteData() As Boolean
        Try
            ...
            Dim _Str As String
            _Str = "Delete From  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODBarcodeScan WHERE FTDocScanNo='" & HI.UL.ULF.rpQuoted(Me.FTDocScanNo.Text) & "'"
            If HI.Conn.SQLConn.Execute_Tran(_Str, HI.Conn.SQLConn.Cmd, HI.Conn.SQLConn.Tran) <= 0 Then
                HI.Conn.SQLConn.Tran.Rollback()
                HI.Conn.SQLConn.DisposeSqlTransaction(HI.Conn.SQLConn.Tran)
                HI.Conn.SQLConn.DisposeSqlConnection(HI.Conn.SQLConn.Cmd)
            ...
            _Str = "Delete From  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODBarcodeScan_Detail WHERE FTDocScanNo='" & HI.UL.ULF.rpQuoted(Me.FTDocScanNo.Text) & "'"
            ...
            HI.Auditor.CreateLog.CreateLogDelete(HI.ST.SysInfo.MenuName, Me.Name, "Delete From  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODBarcodeScan WHERE FTDocScanNo='" & HI.UL.ULF.rpQuoted(Me.FTDocScanNo.Text) & "'")
    ...
    Private Sub Proc_Preview(sender As System.Object, e As System.EventArgs) Handles ocmpreview.Click
        If Me.FTDocScanNo.Text <> "" Then
            With New HI.RP.Report
                ...
                .Formular = "{TPRODTSendSupl.FTSendSuplNo}='" & HI.UL.ULF.rpQuoted(FTDocScanNo.Text) & "' "
                .Preview()
            End With
        Else
...
#Region " Proc "
    ...
    Private Function SaveBarcode(Key As String) As Boolean
        ...
        Try
            ...
            _Str &= vbCrLf & " FROM  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODBarcodeScan_Outline_Detail WITH(NOLOCK)"
            ...
            If _StateNew Then
                ...
                _Str = " INSERT INTO [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODBarcodeScan_Outline_Detail("
                _Str &= vbCrLf & "FTInsUser, FDInsDate, FTInsTime"
                _Str &= vbCrLf & ", FTDocScanNo, FTBarcodeNo,FNHSysOperationId,FNHSysUnitSectId,FTBarcodeCustRef"
                _Str &= vbCrLf & ")  "
                ...
                _Str &= vbCrLf & ",'" & HI.UL.ULF.rpQuoted(Me.FTBarcodeNo.Text) & "'"

            Else

                _Str = " UPDATE [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODBarcodeScan_Outline_Detail "
                ...
                _Str &= vbCrLf & ",FTBarcodeCustRef='" & HI.UL.ULF.rpQuoted(Me.FTBarcodeNo.Text) & "'"
                _Str &= vbCrLf & "  WHERE FTDocScanNo='" & HI.UL.ULF.rpQuoted(FTDocScanNo.Text) & "'"
                _Str &= vbCrLf & "  AND FTBarcodeNo='" & HI.UL.ULF.rpQuoted(_BarCode) & "' "
                _Str &= vbCrLf & "  AND FNHSysOperationId=" & Integer.Parse(Val(FNHSysOperationId.EditValue.ToString)) & " "
    ...
    Private Function DeleteBarcode(BarcodeKey As String, _Operation As Integer) As Boolean
        ...
        Try
            ...
            _Str = " DELETE  FROM  [" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODBarcodeScan_Outline_Detail"
            _Str &= vbCrLf & "   WHERE FTDocScanNo='" & HI.UL.ULF.rpQuoted(FTDocScanNo.Text) & "' "
            _Str &= vbCrLf & "  AND FTBarcodeNo='" & HI.UL.ULF.rpQuoted(_BarCode) & "' "
    ...
    Private Function ChkBarcode(_Barcode As String) As String
        Try
            Dim _Cmd As String = ""
            Dim BarcodeRef As String = ""
            _Cmd = "Select Top 1  FTBarcodeBundleNo  From [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTBundle AS BB WITH (NOLOCK)  "
            _Cmd &= vbCrLf & "WHERE BB.FTBarcodeBundleNo='" & HI.UL.ULF.rpQuoted(_Barcode) & "'"
            BarcodeRef = HI.Conn.SQLConn.GetField(_Cmd, Conn.DB.DataBaseName.DB_PROD)
            If BarcodeRef = "" Then
                _Cmd = "Select Top 1  B.FTBarcodeBundleNo "
                ...
                _Cmd &= vbCrLf & "WHERE C.FTCustBarcodeNo = '" & HI.UL.ULF.rpQuoted(Me.FTBarcodeNo.Text) & "'  "
                BarcodeRef = HI.Conn.SQLConn.GetField(_Cmd, Conn.DB.DataBaseName.DB_PROD)
            End If
            Return BarcodeRef
        Catch ex As Exception
    ...
    Private Sub LoadBarcodeInfo(Key As String)
        ...
        Try
            ...
            _Qry &= vbCrLf & "  FROM [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODBarcodeScan_Outline_Detail WITH (NOLOCK)  "
            ...
            If (_StatePass) Then
                ...
                If HI.Conn.SQLConn.GetField(_Qry, Conn.DB.DataBaseName.DB_MASTER, "") <> "" Then
                    Try
                        ...
                        _Qry &= vbCrLf & " FROM     [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTBundle AS A INNER JOIN"
                        _Qry &= vbCrLf & "          [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_PROD) & "].dbo.TPRODTOrderProd_Detail AS PD ON A.FTOrderProdNo = PD.FTOrderProdNo"
