...
Public Class wCreatePackOrderCustPONonStyMiniFG
    ...
    Private _GenPackCarton As wGenerateCartonNonStyMiniFG
    ...
    Sub New()
        ...
        _GenPackCarton = New wGenerateCartonNonStyMiniFG
...
#Region "Procedure"
    ...
    Private Sub PrepareForm()
        ...
        _Str &= vbCrLf & " WHERE FTDynamicFormName='" & Me.Name & "' "
