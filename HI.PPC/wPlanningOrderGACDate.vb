...
Public Class wPlanningOrderGACDate
...
#Region "Procedure"
    ...
    Private Sub LoadData()
        ...
        Try
            ...
            _Qry &= vbCrLf & "    FROM [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MERCHAN) & "].dbo.TMERTOrderGACDate WITH(NOLOCK)"
            ...
            _Qry &= vbCrLf & "  ,  OSub.FDShipDate AS FDShipDateTo"
            _Qry &= vbCrLf & "  , OSub.FDShipDateOrginal"
            _Qry &= vbCrLf & "  ,  OSub.FDShipDateOrginal AS FDShipDateOrginalTo"
            ...
            _Qry &= vbCrLf & "  , CASe WHEN ISNULL(Osub.FTPORef,'') ='' THEN   ISNULL(O.FTPORef,'')  ELSE  ISNULL(Osub.FTPORef,'')   END AS FTPORef"
            ...
            _Qry &= vbCrLf & " 	  Select FTOrderNo, FTSubOrderNo, SUM(FNQuantityExtra) As FNQuantityExtra, SUM(FNGrandQuantity) As FNGrandQuantity, SUM(FNGarmentQtyTest) As FNGarmentQtyTest, SUM(FNQuantity) As FNQuantity"
            _Qry &= vbCrLf & " FROM     [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MERCHAN) & "].dbo.TMERTOrderSub_BreakDown With(NOLOCK)"
