...
Public Class wOrderChangeFactory
...
#Region "MAIN PROC"
    ...
    Private Sub LoadOrderListingInfoChangeFactory(ByVal _FNHSysCmpId As String, ByVal _FTPORef As String, ByVal _FNHSysStyleId As String, ByVal _FNHSysCustId As String, ByVal _FNHSysBuyId As String, ByVal _FNHSysSeasonId As String)
        ...
        Try
            ...
            sqlCmd.CommandText = "[" & HI.Conn.DB.GetDataBaseName(HI.Conn.DB.DataBaseName.DB_MERCHAN) & "].[dbo].[SP_ORDER_LISTING_CHANGE_FACTORY]"
    ...
    Private Function Savedata() As Boolean
        ...
        Try
            ...
            For Each R As DataRow In _dt.Select("FTSelect ='1'")
                ...
                _Qry = "INSERT INTO [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MERCHAN) & "].dbo.TMERTOrder_Change_Factory"
                _Qry &= vbCrLf & "("
                ...
                _Qry &= vbCrLf & " FROM [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MERCHAN) & "].dbo.TMERTOrder_Change_Factory"
                ...
                _Qry &= vbCrLf & "  UPDATE A SET FNHSysCmpId=" & Val(FNHSysCmpIdTo.Properties.Tag.ToString()) & ""
                ...
                _Qry &= vbCrLf & " ,FNHSysCmpIdTo= isnull((SELECT TOP 1 Cmp.FNHSysCmpPOId FROM [" & HI.Conn.DB.GetDataBaseName(Conn.DB.DataBaseName.DB_MASTER) & "].dbo.TCNMCmp AS Cmp WITH(NOLOCK) WHERE Cmp.FNHSysCmpId=" & Val(FNHSysCmpIdTo.Properties.Tag.ToString()) & "),0)"
